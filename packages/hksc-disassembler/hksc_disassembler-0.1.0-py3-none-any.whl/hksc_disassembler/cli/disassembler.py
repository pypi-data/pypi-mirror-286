...
def printInstruction(instruction: HSInstruction) -> None:
    ...
    for arg in instruction.args:
        ...
        click.secho(f"({arg.value})", fg="bright_magenta", nl=False)
    click.echo()
...
def printStructures(structures: List[HSStructBlock]) -> None:
    for structure in structures:
        click.secho("- Structure: ", fg="bright_magenta", nl=False)
...
def printFunctions(function: HSFunction) -> None:
    if function.hasDebugInfo and function.debugInfo.functionName != "":
        click.secho(f"- Function: {function.debugInfo.functionName}", fg="bright_magenta")
    else:
        click.secho(f"- Function: {hex(function.functionOffset)}", fg="bright_magenta")
    ...
    click.secho("   Instructions:", fg="bright_magenta")

    for instruction in function.instructions:
        printInstruction(instruction)

    click.secho("   Constants:", fg="bright_magenta")

    for constant in function.constants:
        printConstant(constant)

    if function.hasDebugInfo:
        click.secho("   Debug Info:", fg="bright_magenta")
