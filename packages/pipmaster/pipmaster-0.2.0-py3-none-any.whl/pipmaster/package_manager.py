...
class PackageManager:
    ...
    def install_or_update_multiple(self, packages, index_url=None, force_reinstall=False):
        ...
        results = {}
        for package in packages:
            results[package] = self.install_or_update(package, index_url, force_reinstall)
        return results
...
def install_or_update_multiple(package, index_url=None):
    return _pm.install_or_update_multiple(package,index_url)
