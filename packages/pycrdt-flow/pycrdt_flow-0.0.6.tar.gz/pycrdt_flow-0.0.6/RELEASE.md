# Making a new release of pycrdt_flow
...
Configure the following secrets in the [GitHub repository](https://github.com/wh1isper/pycrdt-flow/settings/secrets/actions/new):
