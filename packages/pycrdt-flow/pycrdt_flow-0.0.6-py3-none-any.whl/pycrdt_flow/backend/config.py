...
from pycrdt_flow.backend.envs import *
...
def get_config() -> Config:
    default = {
        ...
        DB_DATABASE_ENV: "testdb",
        REDIS_HOST_ENV: "localhost",
        REDIS_PORT_ENV: 6379,
        REDIS_DB_ENV: 0,
        REDIS_TLS_ENV: False,
        JWT_SECRET_ENV: Fernet.generate_key().decode(),
    }
...
class Config(BaseModel):
    ...
    def from_env(cls, default: None | dict[str, Any]) -> "Config":
        ...
        return cls(
            ...
            jwt_secret=os.getenv(JWT_SECRET_ENV, default.get(JWT_SECRET_ENV, "")),
        )
