...
class MpHttpServer:
    ...
    def run_server(self):
        ...
        self._httpd = HTTPServer((self.host, self.port),
...
class MpHttpClient:
    ...
    def batch(self, data_list: list[dict] | tuple[dict], compress: bool = None) -> list[Any]:
    ...
    def get(self, data: dict, compress: bool = None) -> Any:
