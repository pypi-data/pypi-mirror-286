...
containers_state_health_v2 = Gauge(
    ...
    "Container healthyness; gauge value for \"healthy\" is 1, 4 for \"unhealthy\" and 2 \"unchecked\" if health-check is not specified",
    [*container_id_name_labels],
    namespace=namespace,
    registry=registry
)
...
def main():
    exporter_version.info({"version": "0.1.0"})
