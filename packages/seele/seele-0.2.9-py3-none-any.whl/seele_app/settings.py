...
PWA_SERVICE_WORKER_PATH = os.path.join(BASE_DIR, 'website','static', 'js', 'serviceworker.js')
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'collected_static')  # or any other directory outside your app directories

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'website', 'static'),  # Your source static files directory
]
