...
class AddRolesToCloudGroupForm(forms.Form):
    ...
    class Media:
        css = {
            "all": (f"https://storage.googleapis.com/{settings.GCP_STATIC_BUCKET_NAME}/admin/css/widgets.css",),
        }
        js = (f"https://storage.googleapis.com/{settings.GCP_STATIC_BUCKET_NAME}/admin/jsi18n",)
