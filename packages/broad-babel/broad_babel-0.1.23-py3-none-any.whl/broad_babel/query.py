...
def run_query(
    ...
    str, t.List[t.Tuple[str]] or t.Dict[str, str]
        ...
        - List of tuples with all fields if output_column is not one column or multiple occurrences are found.
    ...
    placeholder = "?"  # For SQLite. See DB API paramstyle.
...
def get_mapper(
        query: list or tuple, input_column: str, output_columns: str, plate_type:str=None,
) -> dict[str, str]:
    """
    ...
    **kwargs : 
        Additional arguments to pass to broad_babel.query.run_query
