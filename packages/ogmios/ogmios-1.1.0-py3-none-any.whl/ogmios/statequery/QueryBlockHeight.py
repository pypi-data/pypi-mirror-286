...
class QueryBlockHeight:
    ...
    def execute(self, id: Optional[Any] = None) -> (int | Origin, Optional[Any]):
    ...
    def receive(self) -> (int | Origin, Optional[Any]):
    ...
    @staticmethod
    def _parse_QueryBlockHeight_response(response: dict) -> (int | Origin, Optional[Any]):
        ...
        if result := response.get("result"):
            block_height: int | Origin = rh.parse_BlockHeightOrOrigin(result)
