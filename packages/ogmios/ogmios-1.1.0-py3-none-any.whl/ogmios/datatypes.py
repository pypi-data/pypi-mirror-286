...
class ProtocolParameters:
    ...
    def __init__(
        ...
        self._schema_type = om.ProtocolParameters(
            ...
            governanceActionDeposit=self.governance_action_deposit.__dict__() if self.governance_action_deposit else None,
            delegateRepresentativeDeposit=self.delegate_representative_deposit.__dict__() if self.delegate_representative_deposit else None,
