...
from django_keycloak_lma.base.admin import KeycloakAdminBase
...
class Users(KeycloakAdminBase):
    ...
    def create(self, username, **kwargs):
        ...
        for key in USER_KWARGS:
            from django_keycloak_lma.base.admin.clientroles import to_camel_case
            if key in kwargs:
...
class User(KeycloakAdminBase):
    ...
    def role_mappings(self):
        from django_keycloak_lma.base.admin.user.userroles import UserRoleMappings
    ...
    @property
    def groups(self):
        from django_keycloak_lma.base.admin.user.usergroup import UserGroups
