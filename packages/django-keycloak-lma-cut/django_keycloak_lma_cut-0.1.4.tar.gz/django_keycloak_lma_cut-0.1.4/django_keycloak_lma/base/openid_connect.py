from django_keycloak_lma.base.mixins import WellKnownMixin
...
class KeycloakOpenidConnect(WellKnownMixin):
    ...
    def __init__(self, realm, client_id, client_secret):
        """
        :param django_keycloak_lma.base.realm.KeycloakRealm realm:
        :param str client_id:
    ...
    def token_introspect(self, token, **kwargs):
        """
        Do the actual call to the token end-point.
        ...
        return self._realm.client.post(self.get_url('introspection_endpoint'),
                                       data=payload)
