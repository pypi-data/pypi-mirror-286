...
from django_keycloak_lma.factories import RealmFactory
...
class ServicesRealmRefreshWellKnownOIDCTestCase(
    ...
    def setUp(self):
        ...
        self.setup_mock('django_keycloak_lma.base.realm.KeycloakRealm.open_id_connect',
    ...
    def test_refresh_well_known_oidc(self):
        ...
        django_keycloak_lma.services.realm.refresh_well_known_oidc(
            realm=self.realm
        )
