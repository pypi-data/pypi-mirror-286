...
from django_keycloak_lma.services.oidc_profile import get_remote_user_model
...
from django_keycloak_lma.models import Nonce
from django_keycloak_lma.auth import remote_user_login
...
class SessionIframe(TemplateView):
    template_name = 'django_keycloak_lma/session_iframe.html'
