...
from django_keycloak_lma.factories import ClientFactory
from django_keycloak_lma.models import OpenIdConnectProfile
...
class ServicesKeycloakOpenIDProfileUpdateOrCreateTestCase(MockTestCaseMixin,
    ...
    def test_create(self):
        django_keycloak_lma.services.oidc_profile.update_or_create_from_code(
            client=self.client,
            code='some-code',
