...
# - django_keycloak_lma.OpenIdConnectProfile (Default) a local User object get
#   created for the logged in identity.
# - django_keycloak_lma.RemoteUserOpenIdConnectProfile with this model there will
#   be no local user stored for the logged in identity.
KEYCLOAK_OIDC_PROFILE_MODEL = 'django_keycloak_lma.OpenIdConnectProfile'

# Class which will be used as User object in case of the remote user OIDC
# Profile
KEYCLOAK_REMOTE_USER_MODEL = 'django_keycloak_lma.remote_user.KeycloakRemoteUser'
