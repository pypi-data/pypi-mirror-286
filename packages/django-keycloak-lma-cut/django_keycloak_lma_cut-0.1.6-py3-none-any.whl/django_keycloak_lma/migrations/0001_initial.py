    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(
                    ...
                    related_name='roles', to='django_keycloak_lma.Client')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='realms', to='django_keycloak_lma.Server'),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='openid_profiles', to='django_keycloak_lma.Realm'),
        ),
        migrations.AddField(
            model_name='openidconnectprofile',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE,
                related_name='client', to='django_keycloak_lma.Realm'),
        ),
        migrations.AddField(
            model_name='client',
