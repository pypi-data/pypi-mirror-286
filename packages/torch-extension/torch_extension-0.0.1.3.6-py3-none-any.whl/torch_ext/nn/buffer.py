...
class Buffering(metaclass=HiddenMeta):
    ...
    def __getattr__(self, name: str):
        if name == 'grad_fn':
            ...
            first_frame = pyreflex.get_frame_at(i + 1)
            second_frame = pyreflex.get_frame_at(i + 2)
...
def _named_forward_modify(instance, *args, **kwargs):
    return typeattr(instance, _is_buffering_method)[Buffering.modify_generically.__code__.co_name](instance, _content_named_forward_inplace, *args, **kwargs)
