...
from ..model.BalanceParameterValue import BalanceParameterValue


class SetBalanceParameterStatusByUserId(AcquireAction):
    ...
    def __init__(
        ...
        properties["parameterValues"] = parameter_values
