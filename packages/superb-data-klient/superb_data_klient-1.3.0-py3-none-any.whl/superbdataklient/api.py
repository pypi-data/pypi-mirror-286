...
class SDKClient:
    ...
    def __init__(self, **kwargs: Union[str, int]) -> None:
        ...
        if proxy_url:
            proxy_urls['http'] = _insert_proxy_auth(proxy_url, kwargs.get('proxy_user'),
                                                    kwargs.get('proxy_pass'))
        # https-proxy
        proxy_url = kwargs.get('proxy_https', None)
        if proxy_url:
            proxy_urls['https'] = _insert_proxy_auth(proxy_url, kwargs.get('proxy_user'),
                                                        kwargs.get('proxy_pass'))
