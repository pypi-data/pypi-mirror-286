...
class ScaSE:
    def __init__(
        ...
        normalized_laplacian : bool, optional (default=True)
            Specifies whether to use the RW-normalized Laplacian matrix or the unnormalized Laplacian matrix."""
    ...
    def _get_true_se(self, X: torch.Tensor) -> np.ndarray:
        ...
        L = get_laplacian(W, is_normalized=self.normalized_laplacian)
