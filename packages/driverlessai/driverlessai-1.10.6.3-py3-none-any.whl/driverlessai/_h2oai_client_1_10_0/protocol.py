...
# PATCHES
from . import protocol_patches_1_10

# 1.10.0
Client.run_interpretation_with_explainers = protocol_patches_1_10.ignore_unexpected_kwargs(Client.run_interpretation_with_explainers)
