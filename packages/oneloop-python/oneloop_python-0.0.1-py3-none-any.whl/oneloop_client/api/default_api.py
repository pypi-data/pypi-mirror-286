...
class DefaultApi:
    ...
    @validate_arguments
    def update_workspace(self, id : StrictStr, update_workspace_response : Optional[UpdateWorkspaceResponse] = None, **kwargs) -> UpdateWorkspaceResponse:  # noqa: E501
        """Updates a workspace  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_workspace(id, update_workspace_response, async_req=True)
        >>> result = thread.get()

        :param id: (required)
        :type id: str
        :param update_workspace_response:
        :type update_workspace_response: UpdateWorkspaceResponse
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.update_workspace_with_http_info(id, update_workspace_response, **kwargs)  # noqa: E501

    @validate_arguments
    def update_workspace_with_http_info(self, id : StrictStr, update_workspace_response : Optional[UpdateWorkspaceResponse] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Updates a workspace  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_workspace_with_http_info(id, update_workspace_response, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['update_workspace_response'] is not None:
            _body_params = _params['update_workspace_response']
