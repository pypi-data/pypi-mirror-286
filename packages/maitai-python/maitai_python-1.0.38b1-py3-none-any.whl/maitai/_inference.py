...
class Inference(MaitaiClient):
    ...
    def infer(cls, session_id, reference_id, intent, application_ref_name, completion_params: ChatCompletionParams, apply_corrections: bool, evaluation_enabled: bool, evaluate_callback: EvaluateCallback = None,
              timeout=None, context_retrieval_enabled=False, context_query='', return_request=False, fallback_model=None, user_id: str = "", assistant=False) -> Iterable[InferenceStreamResponse]:
        chat_request: ChatCompletionRequest = cls.create_inference_request(application_ref_name, session_id, reference_id, intent, apply_corrections, evaluation_enabled, completion_params, evaluate_callback,
                                                                           context_retrieval_enabled, context_query, return_request, fallback_model, user_id, assistant)
    ...
    @classmethod
    async def infer_async(cls, session_id, reference_id, intent, application_ref_name, completion_params: ChatCompletionParams, apply_corrections: bool,
                          evaluation_enabled: bool, evaluate_callback: EvaluateCallback = None, timeout=None, context_retrieval_enabled=False,
                          context_query='', fallback_model=None, user_id="", assistant=False) -> AsyncIterable[InferenceStreamResponse]:
        chat_request: ChatCompletionRequest = cls.create_inference_request(application_ref_name, session_id, reference_id, intent, apply_corrections, evaluation_enabled, completion_params, evaluate_callback,
                                                                           context_retrieval_enabled, context_query, False, fallback_model, user_id, assistant)
        q = AsyncChunkQueue()
