...
class UpdateSynthesisSpecRequest(object):
    ...
    def concept_of_interest(self, concept_of_interest):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                concept_of_interest is not None and len(concept_of_interest) < 1):
            raise ValueError("Invalid value for `concept_of_interest`, number of items must be greater than or equal to `1`")  # noqa: E501
    ...
    def generation_canvas(self, generation_canvas):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                generation_canvas is not None and len(generation_canvas) < 1):
            raise ValueError("Invalid value for `generation_canvas`, number of items must be greater than or equal to `1`")  # noqa: E501
