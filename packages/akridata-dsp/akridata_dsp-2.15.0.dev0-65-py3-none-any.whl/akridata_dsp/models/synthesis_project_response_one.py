...
class SynthesisProjectResponseOne(object):
    ...
    def __init__(self, synthesis_project_id=None, name=None, description=None, gen_session_count=None, created_at=None, updated_at=None, created_by=None, updated_by=None, active_gen_session=None, active_train_session=None, latest_spec_version=None, dataset_id=None, local_vars_configuration=None):  # noqa: E501
