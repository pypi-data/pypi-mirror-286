...
class FineGrainedParams(object):
    ...
    def ensemble_score_reduction_factor(self, ensemble_score_reduction_factor):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                ensemble_score_reduction_factor is not None and ensemble_score_reduction_factor > 1):  # noqa: E501
            raise ValueError("Invalid value for `ensemble_score_reduction_factor`, must be a value less than or equal to `1`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                ensemble_score_reduction_factor is not None and ensemble_score_reduction_factor < 0):  # noqa: E501
            raise ValueError("Invalid value for `ensemble_score_reduction_factor`, must be a value greater than or equal to `0`")  # noqa: E501
