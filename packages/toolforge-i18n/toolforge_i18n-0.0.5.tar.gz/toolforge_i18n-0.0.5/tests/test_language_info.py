...
import toolforge_i18n.user_agent
from toolforge_i18n.language_info import lang_autonym, lang_dir, lang_fallbacks, lang_mw_to_bcp47

toolforge_i18n.user_agent.set_user_agent(
