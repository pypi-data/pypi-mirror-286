...
class ShyftGUI:
    ...
    def setup_file_menu(self):
        ...
        self.file_menu.add_command(label="Plot Productivity Data", command=self.plot_interactive_trend)
    ...
    def plot_interactive_trend(self):
        try:
            ...
            plot_path = metrics.plot_interactive_trend(
                save_path=f"{app_data_dir}/productivity.html",
                window=7,  # You can adjust this or make it configurable
                auto_open=True,
                figsize=(1280, 720)
            )
