...
class ShyftMetrics:
    ...
    def _load_data(self) -> pd.DataFrame:
        ...
        df['Avg time per task (min)'] = df.apply(lambda row: self._calculate_avg_time_per_task(row), axis=1)
        
        return df.sort_values('Date')

    def _calculate_avg_time_per_task(self, row):
    ...
    def plot_interactive_trend(self, save_path: Optional[Union[str, Path]] = None, 
        ...
        # Determine the actual range of earnings
        ...
        # Adjust colorbar ticks to show full range
        ...
        # Adjust y-axis to fit all data points
