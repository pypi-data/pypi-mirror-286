...
from tecton_utils.realtime_utils import get_secretsmanager_cache, retrieve_secret_value, create_cached_client
...
@patch('tecton_utils.realtime_utils.get_secretsmanager_cache')
