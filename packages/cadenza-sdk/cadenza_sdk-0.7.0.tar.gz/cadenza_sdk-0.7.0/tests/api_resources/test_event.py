...
class TestEvent:
    ...
    def test_method_drop_copy_order(self, client: Cadenza) -> None:
        event = client.event.drop_copy_order(
            event_id="eventId",
            event_type="cadenza.dropCopy.order",
            timestamp=1632933600000,
        )
        assert_matches_type(EventDropCopyOrderResponse, event, path=["response"])
    ...
    def test_method_drop_copy_portfolio(self, client: Cadenza) -> None:
        event = client.event.drop_copy_portfolio(
            event_id="eventId",
            event_type="cadenza.dropCopy.portfolio",
            timestamp=1632933600000,
        )
        assert_matches_type(EventDropCopyPortfolioResponse, event, path=["response"])
    ...
    def test_method_drop_copy_quote(self, client: Cadenza) -> None:
        event = client.event.drop_copy_quote(
            event_id="eventId",
            event_type="cadenza.dropCopy.quote",
            timestamp=1632933600000,
        )
        assert_matches_type(EventDropCopyQuoteResponse, event, path=["response"])
    ...
    def test_method_market_data_kline(self, client: Cadenza) -> None:
        event = client.event.market_data_kline(
            event_id="eventId",
            event_type="cadenza.marketData.kline",
            timestamp=1632933600000,
        )
        assert_matches_type(EventMarketDataKlineResponse, event, path=["response"])
    ...
    def test_method_market_data_order_book(self, client: Cadenza) -> None:
        event = client.event.market_data_order_book(
            event_id="eventId",
            event_type="cadenza.marketData.orderBook",
            timestamp=1632933600000,
        )
        assert_matches_type(EventMarketDataOrderBookResponse, event, path=["response"])
