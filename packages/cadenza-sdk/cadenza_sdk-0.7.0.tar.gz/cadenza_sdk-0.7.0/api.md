...
- <code title="post /api/v2/webhook/pubsub/dropCopy/order">client.event.<a href="./src/cadenza_sdk/resources/event.py">drop_copy_order</a>(\*\*<a href="src/cadenza_sdk/types/event_drop_copy_order_params.py">params</a>) -> <a href="./src/cadenza_sdk/types/event_drop_copy_order_response.py">EventDropCopyOrderResponse</a></code>
- <code title="post /api/v2/webhook/pubsub/dropCopy/portfolio">client.event.<a href="./src/cadenza_sdk/resources/event.py">drop_copy_portfolio</a>(\*\*<a href="src/cadenza_sdk/types/event_drop_copy_portfolio_params.py">params</a>) -> <a href="./src/cadenza_sdk/types/event_drop_copy_portfolio_response.py">EventDropCopyPortfolioResponse</a></code>
- <code title="post /api/v2/webhook/pubsub/dropCopy/quote">client.event.<a href="./src/cadenza_sdk/resources/event.py">drop_copy_quote</a>(\*\*<a href="src/cadenza_sdk/types/event_drop_copy_quote_params.py">params</a>) -> <a href="./src/cadenza_sdk/types/event_drop_copy_quote_response.py">EventDropCopyQuoteResponse</a></code>
- <code title="post /api/v2/webhook/pubsub/marketData/kline">client.event.<a href="./src/cadenza_sdk/resources/event.py">market_data_kline</a>(\*\*<a href="src/cadenza_sdk/types/event_market_data_kline_params.py">params</a>) -> <a href="./src/cadenza_sdk/types/event_market_data_kline_response.py">EventMarketDataKlineResponse</a></code>
- <code title="post /api/v2/webhook/pubsub/marketData/orderBook">client.event.<a href="./src/cadenza_sdk/resources/event.py">market_data_order_book</a>(\*\*<a href="src/cadenza_sdk/types/event_market_data_order_book_params.py">params</a>) -> <a href="./src/cadenza_sdk/types/event_market_data_order_book_response.py">EventMarketDataOrderBookResponse</a></code>
