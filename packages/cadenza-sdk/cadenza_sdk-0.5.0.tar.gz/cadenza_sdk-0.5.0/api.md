...
```python
from cadenza_sdk.types.trading import Quote, QuoteGetResponse
```
...
- <code title="post /api/v2/webhook/pubsub/dropCopy/quote">client.webhook.event.<a href="./src/cadenza_sdk/resources/webhook/event.py">drop_copy_quote</a>(\*\*<a href="src/cadenza_sdk/types/webhook/event_drop_copy_quote_params.py">params</a>) -> <a href="./src/cadenza_sdk/types/webhook/drop_copy_quote.py">DropCopyQuote</a></code>
