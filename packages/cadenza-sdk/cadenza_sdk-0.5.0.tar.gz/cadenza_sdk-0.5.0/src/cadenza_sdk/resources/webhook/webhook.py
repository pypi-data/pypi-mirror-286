...
class WebhookResourceWithRawResponse:
    ...
    def event(self) -> EventResourceWithRawResponse:
        return EventResourceWithRawResponse(self._webhook.event)
...
class AsyncWebhookResourceWithRawResponse:
    ...
    def event(self) -> AsyncEventResourceWithRawResponse:
        return AsyncEventResourceWithRawResponse(self._webhook.event)
...
class WebhookResourceWithStreamingResponse:
    ...
    def event(self) -> EventResourceWithStreamingResponse:
        return EventResourceWithStreamingResponse(self._webhook.event)
...
class AsyncWebhookResourceWithStreamingResponse:
    ...
    def event(self) -> AsyncEventResourceWithStreamingResponse:
        return AsyncEventResourceWithStreamingResponse(self._webhook.event)
