...
class Pagination(BaseModel):
    ...
    next_cursor: Optional[str] = Query(default="")
    previous_cursor: Optional[str] = Query(default="")
    order_by: Optional[str] = Query(default="id")
    direction: Optional[Direction] = Query(default=Direction.ASCENDING)
    include_total: Optional[bool] = Query(default=False)
