...
##################################################################################################
# Functions to run the log normalisation preprocessing steps on the filtered single-cell UMI data
##################################################################################################
...
# 2) the sample_ID - so I know what to save the output as
# 3) Path to the output directory - optional - otherwise created in the working directory
# 4) ENSG gname file (to convert ENSEMBL ids to HGNC symbols)
# 5) Whether or not to output a log matrix
# 6) Whether or not to output an mtx count matrix (Don't think this is actually possible)
