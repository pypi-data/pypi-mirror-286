...
from leo_aws_lambda_powertools.event_handler import content_types
from leo_aws_lambda_powertools.event_handler.exceptions import NotFoundError, ServiceError
from leo_aws_lambda_powertools.event_handler.openapi.constants import DEFAULT_API_VERSION, DEFAULT_OPENAPI_VERSION
from leo_aws_lambda_powertools.event_handler.openapi.exceptions import RequestValidationError
from leo_aws_lambda_powertools.event_handler.openapi.types import (
...
from leo_aws_lambda_powertools.event_handler.util import _FrozenDict, extract_origin_header
from leo_aws_lambda_powertools.shared.cookies import Cookie
from leo_aws_lambda_powertools.shared.functions import powertools_dev_is_set
from leo_aws_lambda_powertools.shared.json_encoder import Encoder
from leo_aws_lambda_powertools.shared.types import Literal
from leo_aws_lambda_powertools.utilities.data_classes import (
    ALBEvent,
...
from leo_aws_lambda_powertools.utilities.data_classes.common import BaseProxyEvent
...
if TYPE_CHECKING:
    from leo_aws_lambda_powertools.event_handler.openapi.compat import (
        JsonSchemaValue,
        ModelField,
    )
    from leo_aws_lambda_powertools.event_handler.openapi.models import (
        Contact,
        License,
        OpenAPI,
        SecurityScheme,
    ...
    from leo_aws_lambda_powertools.event_handler.openapi.params import Dependant
    from leo_aws_lambda_powertools.event_handler.openapi.swagger_ui.oauth2 import (
        OAuth2Config,
    )
    from leo_aws_lambda_powertools.event_handler.openapi.types import (
        TypeModelOrEnum,
...
class Route:
    ...
    def dependant(self) -> "Dependant":
        if self._dependant is None:
            from leo_aws_lambda_powertools.event_handler.openapi.dependant import get_dependant
    ...
    def body_field(self) -> Optional["ModelField"]:
        if self._body_field is None:
            from leo_aws_lambda_powertools.event_handler.openapi.dependant import get_body_field
    ...
    def _get_openapi_path(
        ...
        *,
        ...
        """
        from leo_aws_lambda_powertools.event_handler.openapi.dependant import get_flat_params
    ...
    def _openapi_operation_request_body(
        *,
        ...
        """
        from leo_aws_lambda_powertools.event_handler.openapi.compat import ModelField, get_schema_from_model_field
        from leo_aws_lambda_powertools.event_handler.openapi.params import Body
    ...
    def _openapi_operation_parameters(
        *,
        ...
        from leo_aws_lambda_powertools.event_handler.openapi.params import Param
...
class ApiGatewayResolver(BaseRouter):
    ...
    def __init__(
        ...
        if self._enable_validation:
            from leo_aws_lambda_powertools.event_handler.middlewares.openapi_validation import OpenAPIValidationMiddleware
    ...
    def get_openapi_schema(
        ...
        *,
        ...
        from leo_aws_lambda_powertools.event_handler.openapi.models import OpenAPI, PathItem, Tag
        from leo_aws_lambda_powertools.event_handler.openapi.types import (
    ...
    def _get_openapi_servers(servers: Optional[List["Server"]]) -> List["Server"]:
        from leo_aws_lambda_powertools.event_handler.openapi.models import Server
    ...
    def get_openapi_json_schema(
        ...
        *,
        ...
        """
        from leo_aws_lambda_powertools.event_handler.openapi.compat import model_json
    ...
    def enable_swagger(
        ...
        *,
        ...
        from leo_aws_lambda_powertools.event_handler.openapi.compat import model_json
        from leo_aws_lambda_powertools.event_handler.openapi.models import Server
        from leo_aws_lambda_powertools.event_handler.openapi.swagger_ui import (
    ...
    def _get_fields_from_routes(routes: Sequence[Route]) -> List["ModelField"]:
        ...
        from leo_aws_lambda_powertools.event_handler.openapi.compat import ModelField
        from leo_aws_lambda_powertools.event_handler.openapi.dependant import (
            get_flat_params,
        )
