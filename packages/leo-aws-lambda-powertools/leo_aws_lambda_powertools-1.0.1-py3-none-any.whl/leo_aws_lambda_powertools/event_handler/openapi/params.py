...
from leo_aws_lambda_powertools.event_handler.openapi.types import CacheKey
from leo_aws_lambda_powertools.shared.types import Annotated, Literal, get_args, get_origin
