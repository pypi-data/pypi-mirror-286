...
from leo_aws_lambda_powertools.shared.types import List, TypedDict
...
if has_pydantic:  # pragma: no cover
    from leo_aws_lambda_powertools.utilities.parser.models import DynamoDBStreamRecordModel, SqsRecordModel
    from leo_aws_lambda_powertools.utilities.parser.models import (
