...
from leo_aws_lambda_powertools.event_handler import CORSConfig
from leo_aws_lambda_powertools.event_handler.api_gateway import (
    ApiGatewayResolver,
    ProxyEventType,
)
from leo_aws_lambda_powertools.utilities.data_classes import VPCLatticeEvent, VPCLatticeEventV2
