...
@dataclass
class CommandSendInvoicePackageElectronica:
    nit: int
    cuis: str
    cufd: str
...
@dataclass
class ResponseSendInvoicePackageElectronica:
    reception_code: str
    raw_response: Any


@feature(CommandSendInvoicePackageElectronica)
class SendInvoicePackage(UseCase):
    def wsdl(self) -> str:
        return SIAT_WSDL.SERVICIOS_ELECTRONICA

    def execute(
        self, param_object: CommandSendInvoicePackageElectronica
