...
@dataclass
class CommandMasiveInvoceReception:
    nit: int
    cuis: str
    cufd: str
...
@dataclass
class ResponseMasiveInvoiceReception:
    reception_code: str
    raw_response: Any


@feature(CommandMasiveInvoceReception)
class MasiveInvoceReception(UseCase):
    def wsdl(self) -> str:
        return SIAT_WSDL.FACTURA_COMPRA_VENTA

    def execute(
        self, param_object: CommandMasiveInvoceReception
