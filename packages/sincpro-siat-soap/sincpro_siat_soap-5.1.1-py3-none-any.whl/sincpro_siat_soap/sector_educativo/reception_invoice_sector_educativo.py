...
@dataclass
class CommandInvoiceReceptionRequestSectorEducativo:
    nit: int
    cuis: str
    cufd: str
...
@dataclass
class ResponseInvoiceReceptionSectorEducativo:
    reception_code: str
    raw_response: Any


@feature(CommandInvoiceReceptionRequestSectorEducativo)
class InvoiceReceptionRequestSectorEducativo(UseCase):
    def wsdl(self) -> str:
        return SIAT_WSDL.FACTURA_SECTOR_EDUCATIVO

    def execute(
        self, param_object: CommandInvoiceReceptionRequestSectorEducativo
    ) -> ResponseInvoiceReceptionSectorEducativo:
        ...
        return ResponseInvoiceReceptionSectorEducativo(
