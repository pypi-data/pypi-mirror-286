...
@dataclass
class CommandSendInvoicePackageComputarizada:
    nit: int
    cuis: str
    cufd: str
...
@dataclass
class ResponseSendInvoicePackageComputarizada:
    reception_code: str
    raw_response: Any


@feature(CommandSendInvoicePackageComputarizada)
class SendInvoicePackage(UseCase):
    def wsdl(self) -> str:
        return SIAT_WSDL.SERVICIOS_COMPUTARIZADA

    def execute(
        self, param_object: CommandSendInvoicePackageComputarizada
