...
from .xml_functions import etree, generate_str_xml_from_obj, xml_builder

# Example
# root = etree.Element('facturaElectronicaCompraVenta', nsmap={
# None: 'http://www.w3.org/2001/XMLSchema-instance',
# 'xsi': xsi,
# }, attrib={
#     "{%s}schemaLocaltion" % xsi: 'andres'
# })
