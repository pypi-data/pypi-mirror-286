...
@dataclass
class CommandGenerate_SIAT_XML_SectorEducativo:
    cabecera: Dict
    detalle: List[Dict]
...
@dataclass
class ResponseGenerate_SIAT_XML_SectorEducativo:
    xml: str
    root_element: any


@feature(CommandGenerate_SIAT_XML_SectorEducativo)
class Generate_SIAT_XML_SectorEducativo(UseCase):
    def execute(
        self, param_object: CommandGenerate_SIAT_XML_SectorEducativo
