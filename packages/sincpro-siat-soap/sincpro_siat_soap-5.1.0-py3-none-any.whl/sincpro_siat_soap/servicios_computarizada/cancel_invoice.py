...
@dataclass
class CommandInvoiceCancelComputarizada:
    nit: int
    cuis: str
    cufd: str
    cuf: str
...
@dataclass
class ResponseInvoiceCancelComputarizada:
    transaction: bool
    raw_response: Any


@feature(CommandInvoiceCancelComputarizada)
class InvoiceCancellationRequest(UseCase):
    def wsdl(self) -> str:
        return SIAT_WSDL.SERVICIOS_COMPUTARIZADA

    def execute(
        self, param_object: CommandInvoiceCancelComputarizada
