...
@dataclass
class CommandInvoiceReceptionComputarizada:
    nit: int
    cuis: str
    cufd: str
...
@dataclass
class ResponseInvoiceReceptionComputarizada:
    reception_code: str
    raw_response: Any


@feature(CommandInvoiceReceptionComputarizada)
class InvoiceReceptionRequestSectorEducativo(UseCase):
    def wsdl(self) -> str:
        return SIAT_WSDL.SERVICIOS_COMPUTARIZADA

    def execute(
        self, param_object: CommandInvoiceReceptionComputarizada
