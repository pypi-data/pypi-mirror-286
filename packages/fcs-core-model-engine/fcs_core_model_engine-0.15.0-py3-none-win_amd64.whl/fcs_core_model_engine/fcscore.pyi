...
class MasterMesh:
    ...
    @staticmethod
    def delete_nodes(mesh_component_id: int, node_ids: set[int], removed_associated_elements: set[int]) -> bool:
        """
    ...
    @staticmethod
    def delete_elements(mesh_component_id: int, element_ids: set[int]) -> bool:
        """
    ...
    def reassign_elements_and_nodes(
        ...
        :return: A tuple containing a list of new nodes and a list of new elements.
        """
        ...
