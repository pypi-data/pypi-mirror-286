...
class MasterMesh:
    def place_component_mesh(self, comp_id: int, mesh: Mesh) -> ComponentMesh:
        """
    ...
    def create_node_set(self, comp_id: int, node_ids: set[int]) -> NodeSet:
        """
    ...
    def create_element_set(self, comp_id: int, element_ids: set[int]) -> ElementSet:
        """
    ...
    def insert_mesh_reference(self, mesh_reference: MeshReference) -> bool:
        """
    ...
    def get_mesh_reference(self, comp_id: int) -> MeshReference:
        """
    ...
    def delete_mesh_reference(self, comp_id: int) -> bool:
        """
    ...
    def add_node(self, mesh_component_id: int, x: float, y: float, z: float) -> int:
        """
    ...
    def delete_nodes(self, mesh_component_id: int, node_ids: set[int], removed_associated_elements: set[int]) -> bool:
        """
    ...
    def add_element(self, mesh_component_id: int, spec_elem_type: SpecificElementType, node_ids: list[int]) -> int:
        """
    ...
    def delete_elements(self, mesh_component_id: int, element_ids: set[int]) -> bool:
        """
    ...
    def export_med_file(self, mesh_component_id: int = -1) -> bool:
        """
