...
TreeSAK dating -tree gnm.tree -msa marker.phy -o dating_wd -f
TreeSAK dating -tree gnm.tree -msa marker.phy -o dating_wd -f -srun
...
if __name__ == '__main__':
    ...
    parser.add_argument('-srun',    required=False, action="store_true",    help='wrap commands with BioSAK srun')
