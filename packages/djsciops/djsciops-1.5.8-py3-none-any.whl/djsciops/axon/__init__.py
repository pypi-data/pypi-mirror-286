    ...
    if (
        ...
        object_paths = {
            ...
            if (
                ...
                ## comment this since objects.filter() doesn't return directories, this is redundant
                ## also adding it extremely slows down the process
                # and op.get()["ContentType"] != "application/x-directory"
            )
        }
