...
class ContainerContainerPullThroughDistributionResponse(object):
    ...
    def __init__(self, base_path=None, hidden=False, pulp_labels=None, pulp_last_updated=None, pulp_href=None, content_guard=None, repository=None, name=None, pulp_created=None, remote=None, distributions=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
