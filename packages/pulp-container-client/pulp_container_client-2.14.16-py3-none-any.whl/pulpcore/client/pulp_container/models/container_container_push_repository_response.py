...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, manifest_signing_service=None, retain_repo_versions=None, versions_href=None, pulp_labels=None, name=None, pulp_created=None, description=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
