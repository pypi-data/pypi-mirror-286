...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_last_updated=None, versions_href=None, pulp_href=None, retain_repo_versions=None, latest_version_href=None, manifest_signing_service=None, name=None, pulp_created=None, description=None, local_vars_configuration=None):  # noqa: E501
