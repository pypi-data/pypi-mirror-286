...
def create_logger(propagate: Optional[bool] = None, custom_handler: Optional[Any] = None) -> logging.Logger:
    ...
    console = Console(width=int(os.environ.get("REGSCALE_LOG_WIDTH", 120)))
    rich_handler = RichHandler(rich_tracebacks=False, markup=True, console=console, show_time=False)
