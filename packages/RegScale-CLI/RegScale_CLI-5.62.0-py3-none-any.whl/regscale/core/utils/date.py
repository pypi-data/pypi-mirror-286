...
def datetime_obj(date_str: Union[str, datetime.datetime, datetime.date, None]) -> Optional[datetime.datetime]:
    """
    Convert a string to a datetime object.

    :param Union[str, datetime.datetime, datetime.date, None] date_str: The string to convert.
