...
class YunjiEditor(QMainWindow):
    ...
    def init_ui(self): 
        ...
        # 添加插入/覆盖模式标签
        self.status_label_mode = QLabel("模式: 插入")
        self.status_label_mode.setContentsMargins(10, 0, 10, 0)
        ...
        self.status_bar.addWidget(self.status_label_mode, 1)
...
#region
    ...
    def update_insert_overwrite_mode(self):
        if QApplication.keyboardModifiers() & Qt.KeypadModifier:
            self.status_label_mode.setText("模式: 覆盖")
        else:
            self.status_label_mode.setText("模式: 插入")
