...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.file_name = 'C:/Users/cerde/Desktop/Udacity/DataScience/Course3/BinomialPackage/numbers_binomial.txt'
        self.binomial.replace_stats_with_data(self.file_name)
    ...
    def test_replace_stats_with_data(self):
        p, n = self.binomial.replace_stats_with_data(self.file_name)
