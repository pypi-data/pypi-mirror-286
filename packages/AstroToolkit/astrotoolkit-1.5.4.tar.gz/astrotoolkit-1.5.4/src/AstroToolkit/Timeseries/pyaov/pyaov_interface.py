...
def get_analysis(struct, gui=False, method=None):
    ...
    if gui:
        ...
        if method=='amhw':
            ...
            th, freqs, _ = pyaov.pspw(xd,yd,ed,final_freq,step_size)
        elif method=='atrw':
            th, freqs, _ = pyaov.atrw(xd,yd,ed,final_freq,step_size)
        elif method=='aovw':
            th, freqs, _ = pyaov.aovw(xd,yd,ed,final_freq,step_size)
        elif method=='f_mw':
            th, freqs, _ = pyaov.f_mw(xd,yd,ed,final_freq,step_size)
        elif method=='lomw':
            th, freqs, _ = pyaov.lomw(xd,yd,ed,final_freq,step_size)
        else:
            raise ValueError("Invalid method, accepted methods are: amhw, pspw, atrw, aovw, f_mw and lomw.")
