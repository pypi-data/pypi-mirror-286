...
def ReadLocalData(fname):
    ...
    if "ATKdata" in fname:
        subkind = "data"
    elif "ATKphot" in fname:
        subkind = "phot"
    elif "ATKreddening" in fname:
        subkind = "reddening"
    elif "ATKbulkphot" in fname:
        subkind = "bulkphot"
...
def read_local_file(fname):
    if "ATKlightcurve" in fname:
        ftype = "Lightcurve"
    if "ATKdata" in fname:
        ftype = "Data"
    if "ATKphot" in fname:
        ftype = "Phot"
    if "ATKbulkphot" in fname:
        ftype = "Bulkphot"
    if "ATKreddening" in fname:
        ftype = "Reddening"
    if "ATKimage" in fname:
        ftype = "Image"
    if "ATKsed" in fname:
        ftype = "Sed"
    if "ATKspectrum" in fname:
        ftype = "Spectrum"
    if "ATKhrd" in fname:
        ftype = "Hrd"

    data = globals()[f"ReadLocal{ftype}"](fname)
