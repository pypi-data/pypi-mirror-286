    ...
    def apply_join(self, flow_id, node_key, how, df_iL, df_iR, left_on, right_on):
        try:
            ...
            if how == "outer":
                ...
                df_out = pd.merge(df_iL, df_iR, left_on=left_on, right_on=right_on, how=how)
                self.script.append("df_{} = pd.merge(df_iL, df_iR, left_on={}, right_on={}, how='{}')".format(how, left_on, right_on, how))
        except Exception as e:
            print(e)
