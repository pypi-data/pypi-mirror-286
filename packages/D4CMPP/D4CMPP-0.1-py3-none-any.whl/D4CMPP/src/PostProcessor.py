...
from jyp_package2 import plot_tools
...
class PostProcessor:
    ...
    def plot_prediction(self,target, prediction_df):
        img = plot_tools.plot_prediction(target, prediction_df)
    ...
    def draw_learning_curve(self, learning_curve):
        img = plot_tools.plot_learning_curve(learning_curve['train_loss'],learning_curve['val_loss'])
