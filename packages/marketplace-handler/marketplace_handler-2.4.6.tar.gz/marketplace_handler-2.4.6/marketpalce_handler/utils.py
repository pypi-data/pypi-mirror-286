...
def is_too_small_price(price_from_ms: int | float, price_from_market: int | float, percent: float = 0.15) -> bool:
    return price_from_ms <= price_from_market * percent


def is_too_high_price(price_from_ms: int | float, price_from_market: int | float, percent: float = 1.5) -> bool:
    return price_from_ms >= price_from_market * percent