...
class FolderSelect(Frame):
    def __init__(self,
        ...
        self.entPath.grid(row=0, column=1)
        self.btnFind = Button( self, text=Defaults.BROWSE_FOLDER_BTN_TEXT.value, compound="left", image=browse_icon, relief=RAISED, command=self.setFolderPath, font=Formats.FONT_REGULAR.value)
        self.btnFind.image = browse_icon
        self.btnFind.grid(row=0, column=2)
