...
class SimbaProjectPopUp(ConfigReader, PopUpMixin):
    ...
    def __init__(self, config_path: str):
        ...
        plotlyInterface = CreateLabelFrameWithIcon(parent=tab10, header="PLOTLY / DASH", font=Formats.FONT_REGULAR.value, icon_name=Keys.DOCUMENTATION.value, icon_link=Links.PLOTLY.value)
