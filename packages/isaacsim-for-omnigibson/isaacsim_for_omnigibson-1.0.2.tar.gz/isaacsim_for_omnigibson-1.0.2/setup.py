...
class CustomInstallCommand(install):
    ...
    def is_glibc_older():
        try:
            ...
            return any(version in dist_info for version in ['2.31', '2.32', '2.33'])
...
setup(
    ...
    long_description="This is a package of Isaacsim for Omnigibson, backward compatible with Linux x86_64 Ubuntu 20.04 (GLIBC 2.31) and Python 3.10. For more information on installing Isaac Sim using pip, please visit https://docs.omniverse.nvidia.com/isaacsim/latest/installation/install_python.html",
