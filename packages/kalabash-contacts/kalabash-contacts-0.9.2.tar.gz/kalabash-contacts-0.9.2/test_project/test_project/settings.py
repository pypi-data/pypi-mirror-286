...
try:
    from kalabash_contacts import settings as kalabash_contacts_settings
    kalabash_contacts_settings.apply(globals())
except AttributeError:
    from kalabash_contacts.settings import *  # noqa
