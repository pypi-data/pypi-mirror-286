...
class EpochsByStep(InputOutputProcess):
    def __init__(self,
                 origin_input_processes: [InputOutputProcess] = None,
                 at_each_epoch_block_do: PipePool = None,
    ...
    def transform_data(self):
        ...
        self.pipeline_per_epoch_block(pipe_pool=self.at_each_epoch_block_do,
