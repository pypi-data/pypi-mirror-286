def pixelate_video_file(video_filename: str, output_filename: str):
    """
    ...
    from image.edition.filter.pixelate import pixelate_image_file
    ...
    num_of_frames = round(clip.fps * clip.duration)
    ...
    ImageSequenceClip(processed_frames_array, fps = clip.fps).set_audio(clip.audio).write_videofile(output_filename)
