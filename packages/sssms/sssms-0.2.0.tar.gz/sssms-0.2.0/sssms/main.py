...
@cli.command()
@click.option('--showpass', is_flag=True, help='Show password')
def init(showpass=False):
    ...
    password = getpass.getpass('Please provide the default email password: ') if not showpass else input('Please provide the default email password: ')
