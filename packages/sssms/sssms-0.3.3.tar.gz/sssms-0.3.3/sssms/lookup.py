...
def lookup(cc:int=1, phone:int=None, cookies:Dict=cookies, headers:Dict=headers, proxy="localhost:8899") -> Dict:
    ...
    try:
        r = requests.get('https://freecarrierlookup.com/', proxies=proxies) 
