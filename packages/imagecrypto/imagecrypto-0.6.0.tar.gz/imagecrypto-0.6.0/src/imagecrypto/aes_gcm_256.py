...
def generate_ecc_key():
    return ec.generate_private_key(ec.SECP256R1()) # Using a larger curve for 256-bit security
...
def encrypt_image(image_path):
    ...
    derived_key = HKDF(
        ...
        salt=None,
        info=b'encryption',
    ).derive(private_key.private_numbers().private_value.to_bytes(48, 'big'))
...
def display_images(original_path, encrypted_image):
    ...
    fig.suptitle('ECC-based AES-GCM-256 Encryption', fontsize=16)
