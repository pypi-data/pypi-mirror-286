...
from ptk_lib.controls.addressed_ctrls import AddressedMenu
from ptk_lib.controls import  AutoSizeListCtrl
from ptk_lib.controls import toolpanel

from ptk_lib.core_tools.console import AddressCtrl, EVT_ENGINE_ADDRESS

from . import nsb_icons #icons
...
class NSBrowserList(AutoSizeListCtrl):
    ...
    def FilterList(self):
        ...
        for item in self.dirlist:
            ...
            #check overrides
            if type_string in self.flag_overides:
    ...
    def CreateContextMenu(self,oname,type_string):
        ...
        actions = [a for a in zip(actions.keys(),actions.values())] #sort the addresses
        actions.sort()
