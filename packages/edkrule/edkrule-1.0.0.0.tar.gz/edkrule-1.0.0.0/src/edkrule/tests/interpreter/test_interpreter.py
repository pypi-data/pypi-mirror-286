...
def case18():
    ...
    assert exp.matrix(0, 0, 0, 0, 0, 0, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 0, 0, 0, 0, 2, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 0, 0, 2, 0, 0, 2).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 2, 0, 0, 2).type == TokenType.Var
    ...
    assert exp.matrix(2, 0, 0, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(2, 0, 0, 0, 2).type == TokenType.Var
    assert exp.matrix(2, 0, 0, 1).text == '+'
    assert exp.matrix(2, 0, 0, 1).type == TokenType.Plus
    ...
    assert exp.matrix(2, 0, 1, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(2, 0, 1, 0, 2).type == TokenType.Var
...
def case19():
    ...
    assert exp.matrix(0, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 0, 1, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 0, 1, 0, 2).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 1, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 1, 0, 1, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 1, 0, 1, 0, 2).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 2, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 2, 1, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 2, 1, 0, 2).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 3, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 3, 0, 1, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(0, 0, 3, 0, 1, 0, 2).type == TokenType.Var
...
def case20():
    ...
    assert exp.matrix(0, 0, 0).type == TokenType.Var
    assert exp.matrix(0, 1).text == '&&'
    ...
    assert exp.matrix(0, 2, 0, 0, 0, 0, 0).type == TokenType.Var
    assert exp.matrix(0, 2, 0, 0, 0, 0, 1).text == '$*.Informed Consent.DSSTDAT'
    assert exp.matrix(0, 2, 0, 0, 0, 0, 1).type == TokenType.Var
    assert exp.matrix(0, 2, 0, 0, 0, 0, 2).text == '$*.Informed Consent.VERSION'
    assert exp.matrix(0, 2, 0, 0, 0, 0, 2).type == TokenType.Var
    ...
    assert exp.matrix(0, 2, 0, 0, 2, 0).type == TokenType.Var
    assert exp.matrix(0, 2, 0, 0, 2, 1).text == '$*.Informed Consent.DSSTDAT'
    assert exp.matrix(0, 2, 0, 0, 2, 1).type == TokenType.Var
    assert exp.matrix(0, 2, 0, 0, 2, 2).text == '$*.Informed Consent.VERSION'
    assert exp.matrix(0, 2, 0, 0, 2, 2).type == TokenType.Var
    assert exp.matrix(0, 2, 0, 1).text == '=='
    ...
    assert exp.matrix(2, 0, 0, 0, 0, 0, 0).type == TokenType.Var
    ...
    assert exp.matrix(2, 0, 0, 0, 0, 2).text == '$*.*.*'
    assert exp.matrix(2, 0, 0, 0, 0, 2).type == TokenType.Var
    assert exp.matrix(2, 0, 0, 0, 1).text == '=='
    ...
    assert exp.matrix(2, 0, 0, 2).type == TokenType.Var
    assert exp.matrix(2, 0, 1).text == '=='
...
def case21():
    ...
    assert exp.matrix(0, 0, 0, 0, 0).type == TokenType.Var
    assert exp.matrix(0, 0, 0, 1).text == '!='
    assert exp.matrix(0, 0, 0, 1).type == TokenType.NEq
    assert exp.matrix(0, 0, 0, 2).text == '""'
    assert exp.matrix(0, 0, 0, 2).type == TokenType.Identifier
    ...
    assert exp.matrix(0, 0, 2, 0, 0).type == TokenType.Var
    assert exp.matrix(0, 1).text == '!='
    assert exp.matrix(0, 1).type == TokenType.NEq
    assert exp.matrix(0, 2).text == '""'
    assert exp.matrix(0, 2).type == TokenType.Identifier
    ...
    assert exp.matrix(2, 0, 0, 0).type == TokenType.Var
    assert exp.matrix(2, 0, 1).text == '$*.*.*'
    assert exp.matrix(2, 0, 1).type == TokenType.Var
...
def case22():
    ...
    assert exp.matrix(0).type == TokenType.Var
...
def case23():
    ...
    assert exp.matrix(0, 0, 0, 0, 0, 0, 0).type == TokenType.Var
    assert exp.matrix(0, 0, 0, 0, 0, 1).text == '!='
    assert exp.matrix(0, 0, 0, 0, 0, 1).type == TokenType.NEq
    assert exp.matrix(0, 0, 0, 0, 0, 2).text == '\'\''
    assert exp.matrix(0, 0, 0, 0, 0, 2).type == TokenType.Identifier
    ...
    assert exp.matrix(0, 0, 0, 0, 2, 0).type == TokenType.Var
    assert exp.matrix(0, 0, 0, 1).text == '!='
    assert exp.matrix(0, 0, 0, 1).type == TokenType.NEq
    assert exp.matrix(0, 0, 0, 2).text == '\'\''
    assert exp.matrix(0, 0, 0, 2).type == TokenType.Identifier
    ...
    assert exp.matrix(0, 0, 2, 0, 0, 0).type == TokenType.Var
    assert exp.matrix(0, 0, 2, 0, 1).text == '/'
    ...
    assert exp.matrix(0, 0, 2, 0, 2, 0, 0, 0, 0).type == TokenType.Var
...
def case26():
    ...
    assert exp.matrix(1, 0).type == TokenType.Var
...
def case27():
    ...
    assert exp.matrix(0, 0, 2).type == TokenType.Var
    assert exp.matrix(0, 1).text == '=='
    assert exp.matrix(0, 1).type == TokenType.Eq
    ...
    assert exp.matrix(2, 0).type == TokenType.Var
    assert exp.matrix(2, 1).text == '=='
...
def case30():
    ...
    assert exp.matrix(0, 2, 0).type == TokenType.Var
    assert exp.matrix(1).text == '?'
    assert exp.matrix(1).type == TokenType.Question
    assert exp.matrix(2).name == 'Anonymous'
    assert exp.matrix(2).type == TokenType.Expression
    ...
    assert exp.matrix(2, 0, 0).type == TokenType.Var
    assert exp.matrix(2, 1).text == '>='
