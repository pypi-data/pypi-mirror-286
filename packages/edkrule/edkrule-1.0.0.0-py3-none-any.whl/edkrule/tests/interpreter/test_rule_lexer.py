...
def test_rule_lexer0(rules):
    ...
    assert lexer.token_list[2].type == TokenType.Var
    ...
    assert lexer.token_list[11].type == TokenType.Var
    ...
    assert lexer.token_list[21].type == TokenType.Var
    ...
    assert lexer.token_list[24].type == TokenType.Var
...
def test_rule_lexer2(rules):
    ...
    assert lexer.token_list[5].type == TokenType.Var
    assert lexer.token_list[6].text == ')'
    ...
    assert lexer.token_list[12].type == TokenType.Var
    assert lexer.token_list[13].text == ')'
    assert lexer.token_list[13].type == TokenType.Rp
    assert lexer.token_list[14].text == '!='
    assert lexer.token_list[14].type == TokenType.NEq
    ...
    assert lexer.token_list[29].type == TokenType.Var
...
def test_rule_lexer3(rules):
    ...
    assert lexer.token_list[0].type == TokenType.Var
    assert lexer.token_list[1].text == '=='
...
def test_rule_lexer5(rules):
    ...
    assert lexer.token_list[6].text == '$*.*.*'
    assert lexer.token_list[6].type == TokenType.Var
    assert lexer.token_list[7].text == ')'
    ...
    assert lexer.token_list[13].text == '$*.*.*'
    assert lexer.token_list[13].type == TokenType.Var
    assert lexer.token_list[14].text == ','
...
def test_rule_lexer6(rules):
    ...
    assert lexer.token_list[9].text == '$*.*.*'
    assert lexer.token_list[9].type == TokenType.Var
    assert lexer.token_list[10].text == '=='
...
def test_rule_lexer11(rules):
    ...
    assert lexer.token_list[10].type == TokenType.Var
    assert lexer.token_list[11].text == ')'
    ...
    assert lexer.token_list[20].type == TokenType.Var
    ...
    assert lexer.token_list[32].type == TokenType.Var
    assert lexer.token_list[33].text == '+'
    ...
    assert lexer.token_list[41].type == TokenType.Var
    assert lexer.token_list[42].text == '+'
    ...
    assert lexer.token_list[45].type == TokenType.Var
    assert lexer.token_list[46].text == '+'
    ...
    assert lexer.token_list[49].type == TokenType.Var
    ...
    assert lexer.token_list[53].type == TokenType.Var
...
def test_rule_lexer12(rules):
    ...
    assert lexer.token_list[8].type == TokenType.Var
    assert lexer.token_list[9].text == ','
    assert lexer.token_list[9].type == TokenType.Comma
    assert lexer.token_list[10].text == ' '
    assert lexer.token_list[10].type == TokenType.Blank
    ...
    assert lexer.token_list[18].type == TokenType.Var
    assert lexer.token_list[19].text == '=='
    ...
    assert lexer.token_list[30].type == TokenType.Var
    assert lexer.token_list[31].text == ','
    ...
    assert lexer.token_list[33].type == TokenType.Var
    assert lexer.token_list[34].text == '!='
    ...
    assert lexer.token_list[40].type == TokenType.Var
    assert lexer.token_list[41].text == '=='
    ...
    assert lexer.token_list[55].type == TokenType.Var
    assert lexer.token_list[56].text == ','
    assert lexer.token_list[56].type == TokenType.Comma
    ...
    assert lexer.token_list[58].type == TokenType.Var
    assert lexer.token_list[59].text == '=='
    ...
    assert lexer.token_list[65].type == TokenType.Var
    ...
    assert lexer.token_list[77].type == TokenType.Var
    ...
    assert lexer.token_list[80].type == TokenType.Var
    ...
    assert lexer.token_list[87].type == TokenType.Var
