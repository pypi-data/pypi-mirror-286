...
def case0():
    engine = Engine(definition_path="D:\\aws\\eclinical40_auto_testing\\pybiz\\src\edkrule\\tests\engine\engine.xml")
...
def case1():
    engine = Engine(definition_path="D:\\aws\\eclinical40_auto_testing\\pybiz\\src\\edkrule\\tests\engine\engine0.xml")
...
def load_engine():
    engine = Engine(definition_path="D:\\aws\\eclinical40_auto_testing\\pybiz\\src\\edkrule\\tests\\engine\\engine2.xml")
    return engine
