    ...
    if isinstance(t, Feature):
        ...
        return UpsertFeatureGQL(
            ...
            if t.window_materialization_parsed is None
                ...
                if t.window_materialization_parsed.child_feature is not None
                else None,
                aggregation=t.window_materialization_parsed.aggregation,
                childNamespace=t.window_materialization_parsed.child_namespace,
                parentNamespace=t.window_materialization_parsed.parent_namespace,
