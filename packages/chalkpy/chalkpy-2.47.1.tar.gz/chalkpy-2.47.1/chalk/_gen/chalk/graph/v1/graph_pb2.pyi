...
class WindowAggregation(_message.Message):
    ...
    CHILD_FEATURE_FIELD_NUMBER: _ClassVar[int]
    AGGREGATION_FIELD_NUMBER: _ClassVar[int]
    GROUP_BY_FIELD_NUMBER: _ClassVar[int]
    CHILD_NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    PARENT_NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    bucket_duration: _duration_pb2.Duration
    child_feature: FeatureReference
    aggregation: str
    ...
    def __init__(
        ...
        child_feature: _Optional[_Union[FeatureReference, _Mapping]] = ...,
        aggregation: _Optional[str] = ...,
        group_by: _Optional[_Iterable[_Union[FeatureReference, _Mapping]]] = ...,
        child_namespace: _Optional[str] = ...,
        parent_namespace: _Optional[str] = ...,
    ) -> None: ...
