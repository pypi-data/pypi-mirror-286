            ...
            scalar=pb.ScalarFeatureType(
                ...
                window_info=pb.WindowInfo(
                    ...
                    aggregation=pb.WindowAggregation(
                        ...
                        child_feature=ToProtoConverter.create_feature_reference(
                            feature=f.window_materialization_parsed.child_feature
                        )
                        if f.window_materialization_parsed.child_feature is not None
                        else None,
                        aggregation=f.window_materialization_parsed.aggregation,
                        parent_namespace=f.window_materialization_parsed.parent_namespace,
                        child_namespace=f.window_materialization_parsed.child_namespace,
                        group_by=None,
                    )
