...
class EditorialResConfigSettings(models.TransientModel):
    ...
    stock_picking_type_compra_deposito_id = fields.Many2one(related='company_id.stock_picking_type_compra_deposito_id', readonly=False)

    account_journal_deposito_compra_id = fields.Many2one(related='company_id.account_journal_deposito_compra_id', readonly=False)
