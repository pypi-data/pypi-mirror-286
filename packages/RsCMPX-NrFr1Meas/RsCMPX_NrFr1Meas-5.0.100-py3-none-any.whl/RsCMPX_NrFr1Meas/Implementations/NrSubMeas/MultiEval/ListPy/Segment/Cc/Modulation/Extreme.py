...
class ExtremeCls:
	...
	class FetchStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Carrier_Power_Min: float: No parameter help available
			- Carrier_Power_Max: float: No parameter help available"""
		__meta_args_list = [
	...
	class CalculateStruct(StructBase):
		"""Response structure. Fields: \n
			...
			- Carrier_Power_Min: float or bool: No parameter help available
			- Carrier_Power_Max: float or bool: No parameter help available"""
		__meta_args_list = [
			ArgStruct.scalar_int('Reliability', 'Reliability'),
			ArgStruct.scalar_int('Seg_Reliability'),
			ArgStruct.scalar_int('Statist_Expired'),
		...
		def __init__(self):
			...
			self.Carrier_Power_Min: float or bool = None
			self.Carrier_Power_Max: float or bool = None
