...
class RsCMPX_NrFr1Meas:
	"""1095 total commands, 4 Subgroups, 0 group commands"""
	_driver_options = "SupportedInstrModels = CMX/CMP/CMW/PVT, SupportedIdnPatterns = CMX/CMP/CMW/PVT, SimulationIdnString = 'Rohde&Schwarz,CMP180,100001,5.0.100.0019'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.0.100.0019'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.0.100.0019'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCMPX_NrFr1Meas version failed. Current version: '5.0.100.0019', minimum required version: '{min_version}'")
