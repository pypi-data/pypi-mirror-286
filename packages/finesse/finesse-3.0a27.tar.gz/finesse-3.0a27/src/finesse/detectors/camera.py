...
class CCD(CCDCamera, Image):
    r"""Camera for measuring the intensity of a beam, :math:`I = |E(x,y)|^2`, where
    the unscaled x and y coordinate arrays used are :attr:`.xdata` and :attr:`.ydata`,
...
class CCDScanLine(CCDCamera, ScanLine):
    r"""Camera for measuring the intensity of a beam, :math:`I = |E(x,y)|^2`, along
    a 1D slice. Where the unscaled x and y coordinate arrays used are :attr:`.xdata`
    and :attr:`.ydata`, respectively. Note that this is just the intensity at the
    points (x,y), not an integrated power over some finite pixel size.
...
class CCDPixel(CCDCamera, Pixel):
    """Camera for measuring the intensity of a beam, :math:`I = |E(x,y)|^2`, at a
    single point. Where the unscaled x and y coordinate used is :attr:`.xdata`
    and :attr:`.ydata`, respectively. Note that this is just the intensity at (x,y),
    not an integrated power over some finite pixel dimension.
