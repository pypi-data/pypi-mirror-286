...
from .mvc_model_dic import Model, EnumInteropolation, EnumStrainType, EnumDataSelection
from .tktl_roi_image_window import ROIImageWindow
from py3dic.tktools.tk_collapsible_pane import CollapsiblePane
from .tktp_browse_results import TLBrowseImageWindow
...
#TODO Add log window 
class View:
    def __init__(self, master:tk.Tk, model:Model):
        self.master = master
        self.model = model
    ...
    def create_widgets(self):
        self.master.title("DIC Analysis")
        ...
        self.btn_view_results = tk.Button(self.master, 
        ...
        self._create_collapsible_pane()
        
    def _create_collapsible_pane(self):
        ...
        self.cpMerged.grid(row=4, column=0, columnspan=3, padx=10, pady=10)
