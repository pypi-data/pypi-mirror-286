...
@tool_ui_callback
def list_mongodb_connections(context: CallbackContext) -> List[Dict[str, str]]:
    ...
    for connection in connections:
        if connection.properties.category == "CustomKeys" and \
                ...
                connection.properties.metadata.get("index_type") == "azurecosmosdbformongodbvcore":
...
@tool_ui_callback
def list_mongodb_databases(context: CallbackContext, mongodb_connection: str) -> List[Dict[str, str]]:
