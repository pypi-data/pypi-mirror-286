...
MenuManage.add_sub("microbusiness", None, "diacamma.microbusiness/images/microbusiness.png", _("Microbusiness"), _("Microbusiness tools"), 30, 'mdi:mdi-desktop-classic')
...
def fill_params(self):
    ...
    btn.set_action(self.request, ParamEdit.get_action(TITLE_MODIFY, 'images/edit.png', short_icon='mdi:mdi-pencil-outline'), close=CLOSE_NO, params={'params': param_lists})
...
@ActionsManage.affect_grid(_("Calcul"), "images/edit.png", short_icon='mdi:mdi-pencil-outline', close=CLOSE_NO, unique=SELECT_MULTI)
@ActionsManage.affect_show(_("Calcul"), "images/edit.png", short_icon='mdi:mdi-pencil-outline', close=CLOSE_NO)
@MenuManage.describ('microbusiness.change_socialdeclaration')
