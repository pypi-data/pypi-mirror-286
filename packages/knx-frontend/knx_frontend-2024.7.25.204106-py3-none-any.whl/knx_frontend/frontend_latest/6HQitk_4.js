export const id=3823;export const ids=[3823];export const modules={23823:(e,t,n)=>{n.r(t),n.d(t,{HaConversationAgentSelector:()=>k});var o=n(62659),i=n(98597),a=n(196),s=n(76504),r=n(80792),l=n(33167),d=n(24517),c=n(11355),u=n(81407);var p=n(31238);const h=(e,t)=>{var n;return e.callApi("POST","config/config_entries/options/flow",{handler:t,show_advanced_options:Boolean(null===(n=e.userData)||void 0===n?void 0:n.showAdvanced)})},g=(e,t)=>e.callApi("GET",`config/config_entries/options/flow/${t}`),v=(e,t,n)=>e.callApi("POST",`config/config_entries/options/flow/${t}`,n),m=(e,t)=>e.callApi("DELETE",`config/config_entries/options/flow/${t}`);var _=n(50006);n(9484),n(96334);var f=n(27761);const y="__NONE_OPTION__";(0,o.A)([(0,a.EM)("ha-conversation-agent-picker")],(function(e,t){class n extends t{constructor(...t){super(...t),e(this)}}return{F:n,d:[{kind:"field",decorators:[(0,a.MZ)()],key:"value",value:void 0},{kind:"field",decorators:[(0,a.MZ)()],key:"language",value:void 0},{kind:"field",decorators:[(0,a.MZ)()],key:"label",value:void 0},{kind:"field",decorators:[(0,a.MZ)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,a.MZ)({type:Boolean,reflect:!0})],key:"disabled",value(){return!1}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"required",value(){return!1}},{kind:"field",decorators:[(0,a.wk)()],key:"_agents",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_configEntry",value:void 0},{kind:"method",key:"render",value:function(){var e,t,n;if(!this._agents)return i.s6;const o=null!==(e=this.value)&&void 0!==e?e:this.required&&(!this.language||null!==(t=this._agents.find((e=>"homeassistant"===e.id)))&&void 0!==t&&t.supported_languages.includes(this.language))?"homeassistant":y;return i.qy`
      <ha-select
      ...
      >${null!==(n=this._configEntry)&&void 0!==n&&n.supports_options?i.qy`<ha-icon-button
          ...
          ></ha-icon-button>`:""}
    `}},{kind:"method",key:"willUpdate",value:function(e){(0,s.A)((0,r.A)(n.prototype),"willUpdate",this).call(this,e),this.hasUpdated?e.has("language")&&this._debouncedUpdateAgents():this._updateAgents(),e.has("value")&&this._maybeFetchConfigEntry()}},{kind:"method",key:"_maybeFetchConfigEntry",value:async function(){if(this.value&&this.value in this.hass.entities)try{const e=await(0,f.v)(this.hass,this.value);if(!e.config_entry_id)return void(this._configEntry=void 0);this._configEntry=(await(0,u.Vx)(this.hass,e.config_entry_id)).config_entry}catch(e){this._configEntry=void 0}else this._configEntry=void 0}},{kind:"field",key:"_debouncedUpdateAgents",value(){return(0,c.s)((()=>this._updateAgents()),500)}},{kind:"method",key:"_updateAgents",value:async function(){const{agents:e}=await(t=this.hass,n=this.language,o=this.hass.config.country||void 0,t.callWS({type:"conversation/agent/list",language:n,country:o}));var t,n,o;if(this._agents=e,!this.value)return;const i=e.find((e=>e.id===this.value));(0,l.r)(this,"supported-languages-changed",{value:null==i?void 0:i.supported_languages}),(!i||"*"!==i.supported_languages&&0===i.supported_languages.length)&&(this.value=void 0,(0,l.r)(this,"value-changed",{value:this.value}))}},{kind:"method",key:"_openOptionsFlow",value:async function(){var e,t,n;this._configEntry&&(e=this,t=this._configEntry,n={manifest:await(0,p.QC)(this.hass,this._configEntry.domain)},(0,_.g)(e,{startFlowHandler:t.entry_id,domain:t.domain,...n},{flowType:"options_flow",loadDevicesAndAreas:!1,createFlow:async(e,n)=>{const[o]=await Promise.all([h(e,n),e.loadFragmentTranslation("config"),e.loadBackendTranslation("options",t.domain),e.loadBackendTranslation("selector",t.domain)]);return o},fetchFlow:async(e,n)=>{const[o]=await Promise.all([g(e,n),e.loadFragmentTranslation("config"),e.loadBackendTranslation("options",t.domain),e.loadBackendTranslation("selector",t.domain)]);return o},handleFlowStep:v,deleteFlow:m,renderAbortDescription(e,n){const o=e.localize(`component.${n.translation_domain||t.domain}.options.abort.${n.reason}`,n.description_placeholders);return o?i.qy`
              <ha-markdown
                breaks
                allowsvg
                .content=${o}
    ...
    `}},{kind:"method",key:"_changed",value:function(e){var t;const n=e.target;!this.hass||""===n.value||n.value===this.value||void 0===this.value&&n.value===y||(this.value=n.value===y?void 0:n.value,(0,l.r)(this,"value-changed",{value:this.value}),(0,l.r)(this,"supported-languages-changed",{value:null===(t=this._agents.find((e=>e.id===this.value)))||void 0===t?void 0:t.supported_languages}))}}]}}),i.WF);let k=(0,o.A)([(0,a.EM)("ha-selector-conversation_agent")],(function(e,t){return{F:class extends t{constructor(...t){super(...t),e(this)}},d:[{kind:"field",decorators:[(0,a.MZ)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,a.MZ)({attribute:!1})],key:"selector",value:void 0},{kind:"field",decorators:[(0,a.MZ)()],key:"value",value:void 0},{kind:"field",decorators:[(0,a.MZ)()],key:"label",value:void 0},{kind:"field",decorators:[(0,a.MZ)()],key:"helper",value:void 0},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"disabled",value(){return!1}},{kind:"field",decorators:[(0,a.MZ)({type:Boolean})],key:"required",value(){return!0}},{kind:"field",decorators:[(0,a.MZ)({attribute:!1})],key:"context",value:void 0},{kind:"method",key:"render",value:function(){var e,t;return i.qy`<ha-conversation-agent-picker
      .hass=${this.hass}
      .value=${this.value}
