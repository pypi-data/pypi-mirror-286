...
export const id=2882;export const ids=[2882];export const modules={53935:(t,i,e)=>{e.d(i,{A:()=>n});const o=t=>t<10?`0${t}`:t;function n(t){const i=Math.floor(t/3600),e=Math.floor(t%3600/60),n=Math.floor(t%3600%60);return i>0?`${i}:${o(e)}:${o(n)}`:e>0?`${e}:${o(n)}`:n>0?""+n:null}},49371:(t,i,e)=>{e.d(i,{PN:()=>a,jm:()=>s,sR:()=>r,t1:()=>n,yu:()=>l});e(31238);const o={"HA-Frontend-Base":`${location.protocol}//${location.host}`},n=(t,i,e)=>{var n;return t.callApi("POST","config/config_entries/flow",{handler:i,show_advanced_options:Boolean(null===(n=t.userData)||void 0===n?void 0:n.showAdvanced),entry_id:e},o)},a=(t,i)=>t.callApi("GET",`config/config_entries/flow/${i}`,void 0,o),s=(t,i,e)=>t.callApi("POST",`config/config_entries/flow/${i}`,e,o),r=(t,i)=>t.callApi("DELETE",`config/config_entries/flow/${i}`),l=(t,i)=>t.callApi("GET","config/config_entries/flow_handlers"+(i?`?type=${i}`:""))},61399:(t,i,e)=>{e.d(i,{mx:()=>o,sF:()=>n});const o=["sunday","monday","tuesday","wednesday","thursday","friday","saturday"],n=(t,i)=>t.callWS({type:"schedule/create",...i})},25705:(t,i,e)=>{e.d(i,{PF:()=>s,CR:()=>n,ls:()=>a});var o=e(53935);const n=(t,i)=>t.callWS({type:"timer/create",...i}),a=t=>{if(!t.attributes.remaining)return;let i=function(t){const i=t.split(":").map(Number);return 3600*i[0]+60*i[1]+i[2]}(t.attributes.remaining);if("active"===t.state){const e=(new Date).getTime(),o=new Date(t.last_changed).getTime();i=Math.max(i-(e-o)/1e3,0)}return i},s=(t,i,e)=>{if(!i)return null;if("idle"===i.state||0===e)return t.formatEntityState(i);let n=(0,o.A)(e||0)||"0";return"paused"===i.state&&(n=`${n} (${t.formatEntityState(i)})`),n}},63283:(t,i,e)=>{e.d(i,{W:()=>r});var o=e(98597),n=e(49371),a=e(31238),s=e(50006);const r=(t,i)=>(0,s.g)(t,i,{flowType:"config_flow",loadDevicesAndAreas:!0,createFlow:async(t,e)=>{const[o]=await Promise.all([(0,n.t1)(t,e,i.entryId),t.loadFragmentTranslation("config"),t.loadBackendTranslation("config",e),t.loadBackendTranslation("selector",e),t.loadBackendTranslation("title",e)]);return o},fetchFlow:async(t,i)=>{const e=await(0,n.PN)(t,i);return await t.loadFragmentTranslation("config"),await t.loadBackendTranslation("config",e.handler),await t.loadBackendTranslation("selector",e.handler),e},handleFlowStep:n.jm,deleteFlow:n.sR,renderAbortDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.abort.${i.reason}`,i.description_placeholders);return e?o.qy`
      ...
      `},renderShowFormProgressHeader(t,i){return t.localize(`component.${i.handler}.config.step.${i.step_id}.title`)||t.localize(`component.${i.handler}.title`)},renderShowFormProgressDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.progress.${i.progress_action}`,i.description_placeholders);return e?o.qy`
          ...
          `:""},renderMenuHeader(t,i){return t.localize(`component.${i.handler}.config.step.${i.step_id}.title`)||t.localize(`component.${i.handler}.title`)},renderMenuDescription(t,i){const e=t.localize(`component.${i.translation_domain||i.handler}.config.step.${i.step_id}.description`,i.description_placeholders);return e?o.qy`
            <ha-markdown allowsvg breaks .content=${e}></ha-markdown>
          `:""},renderMenuOption(t,i,e){return t.localize(`component.${i.translation_domain||i.handler}.config.step.${i.step_id}.menu_options.${e}`,i.description_placeholders)},renderLoadingDescription(t,i,e,o){if("loading_flow"!==i&&"loading_step"!==i)return"";const n=(null==o?void 0:o.handler)||e;return t.localize(`ui.panel.config.integrations.config_flow.loading.${i}`,{integration:n?(0,a.p$)(t.localize,n):t.localize("ui.panel.config.integrations.config_flow.loading.fallback_title")})}})},50006:(t,i,e)=>{e.d(i,{g:()=>a});var o=e(33167);const n=()=>Promise.all([e.e(4932),e.e(2364)]).then(e.bind(e,2364)),a=(t,i,e)=>{(0,o.r)(t,"show-dialog",{dialogTag:"dialog-data-entry-flow",dialogImport:n,dialogParams:{...i,flowConfig:e,dialogParentElement:t}})}},22882:(t,i,e)=>{e.r(i),e.d(i,{DialogHelperDetail:()=>w});var o=e(62659),n=(e(58068),e(87777),e(98597)),a=e(196),s=e(69760),r=e(32872),l=e(90662);e(73279);var d=e(88762),c=(e(9484),e(49371));var h=e(31238),m=e(61399),p=e(25705),u=e(63283),g=e(43799),f=e(47424),y=e(23135);const _={input_boolean:{create:(t,i)=>t.callWS({type:"input_boolean/create",...i}),import:()=>e.e(3266).then(e.bind(e,53266))},input_button:{create:(t,i)=>t.callWS({type:"input_button/create",...i}),import:()=>e.e(9946).then(e.bind(e,99946))},input_text:{create:(t,i)=>t.callWS({type:"input_text/create",...i}),import:()=>e.e(8431).then(e.bind(e,38431))},input_number:{create:(t,i)=>t.callWS({type:"input_number/create",...i}),import:()=>e.e(6805).then(e.bind(e,6805))},input_datetime:{create:(t,i)=>t.callWS({type:"input_datetime/create",...i}),import:()=>e.e(4293).then(e.bind(e,74293))},input_select:{create:(t,i)=>t.callWS({type:"input_select/create",...i}),import:()=>e.e(1186).then(e.bind(e,1186))},counter:{create:(t,i)=>t.callWS({type:"counter/create",...i}),import:()=>e.e(3971).then(e.bind(e,3971))},timer:{create:p.CR,import:()=>e.e(1240).then(e.bind(e,71240))},schedule:{create:m.sF,import:()=>Promise.all([e.e(4674),e.e(4114)]).then(e.bind(e,44114))}};let w=(0,o.A)([(0,a.EM)("dialog-helper-detail")],(function(t,i){return{F:class extends i{constructor(...i){super(...i),t(this)}},d:[{kind:"field",decorators:[(0,a.MZ)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_item",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_opened",value(){return!1}},{kind:"field",decorators:[(0,a.wk)()],key:"_domain",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_error",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_submitting",value(){return!1}},{kind:"field",decorators:[(0,a.P)(".form")],key:"_form",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_helperFlows",value:void 0},{kind:"field",decorators:[(0,a.wk)()],key:"_loading",value(){return!1}},{kind:"field",key:"_params",value:void 0},{kind:"method",key:"showDialog",value:async function(t){this._params=t,this._domain=t.domain,this._item=void 0,this._domain&&this._domain in _&&await _[this._domain].import(),this._opened=!0,await this.updateComplete,this.hass.loadFragmentTranslation("config"),Promise.all([(0,c.yu)(this.hass,["helper"]),this.hass.loadBackendTranslation("title",void 0,!0)]).then((([t])=>{this._helperFlows=t}))}},{kind:"method",key:"closeDialog",value:function(){this._opened=!1,this._error=void 0,this._domain=void 0,this._params=void 0}},{kind:"method",key:"render",value:function(){if(!this._opened)return n.s6;let t;var i;if(this._domain)t=n.qy`
        ...
        ${null!==(i=this._params)&&void 0!==i&&i.domain?n.s6:n.qy`<mwc-button
      ...
      ></ha-circular-progress>`;else{const i=[];for(const t of Object.keys(_))i.push([t,this.hass.localize(`ui.panel.config.helpers.types.${t}`)||t]);for(const t of this._helperFlows)i.push([t,(0,h.p$)(this.hass.localize,t)]);i.sort(((t,i)=>t[1].localeCompare(i[1]))),t=n.qy`
        <mwc-list
          ...
          dialogInitialFocus
        >
          ${i.map((([t,i])=>{var e;const o=!(t in _)||(0,r.x)(this.hass,t);return n.qy`
              <ha-list-item
                .disabled=${!o}
                hasmeta
                .domain=${t}
              ...
              >
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src=${(0,f.MR)({domain:t,type:"icon",useFallback:!0,darkOptimized:null===(e=this.hass.themes)||void 0===e?void 0:e.darkMode})}
    ...
    `}},{kind:"method",key:"_valueChanged",value:function(t){this._item=t.detail.value}},{kind:"method",key:"_createItem",value:async function(){if(this._domain&&this._item){this._submitting=!0,this._error="";try{var t;const i=await _[this._domain].create(this.hass,this._item);null!==(t=this._params)&&void 0!==t&&t.dialogClosedCallback&&i.id&&this._params.dialogClosedCallback({flowFinished:!0,entityId:`${this._domain}.${i.id}`}),this.closeDialog()}catch(i){this._error=i.message||"Unknown error"}finally{this._submitting=!1}}}},{kind:"method",key:"_domainPicked",value:async function(t){if(!(t=>!(!t.detail.selected||"property"!==t.detail.source||(t.currentTarget.selected=!1,0)))(t))return;const i=t.currentTarget.domain;if(i in _){this._loading=!0;try{await _[i].import(),this._domain=i}finally{this._loading=!1}this._focusForm()}else(0,u.W)(this,{startFlowHandler:i,dialogClosedCallback:this._params.dialogClosedCallback}),this.closeDialog()}},{kind:"method",key:"_focusForm",value:async function(){var t;await this.updateComplete,(null===(t=this._form)||void 0===t?void 0:t.lastElementChild).focus()}},{kind:"method",key:"_goBack",value:function(){this._domain=void 0,this._item=void 0,this._error=void 0}},{kind:"get",static:!0,key:"styles",value:function(){return[g.nA,n.AH`
...
//# sourceMappingURL=4w8b0ozW.js.map