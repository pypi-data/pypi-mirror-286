...
class ContentModelLoader(object):
    ...
    __CM_MAP = {
        ...
        "content.vaiv.api.theme": __MODULE_CLASS(
            "finter.framework_model.content_loader.vaiv.buzz", "ThemeLoader",
        ),
        "content.handa.dataguide.ews": __MODULE_CLASS(
            "finter.framework_model.content_loader.ews.krx", "EwsLoader",
        ),
        "content.handa.unstructured.ews": __MODULE_CLASS(
            "finter.framework_model.content_loader.ews.sent_index", "RawSentLoader",
        ),
        "content.handa.unstructured.ews": __MODULE_CLASS(
            "finter.framework_model.content_loader.ews.sent_index", "SarimaSentLoader",
        ),
        "content.daumsoft.keyterm.sentiment": __MODULE_CLASS(
            "finter.framework_model.content", "LoaderTemplate",
        ),
    }
