...
from .supplier_evaluation import SupplierEvaluationStub
...
class SupplierFrameworkStub(BaseAPIModelStub):
    ...
    default_data = {
        ...
        "evaluationsStatus": "not_required"
    }
    optional_keys = [
        ...
        ('evaluationsStatus', 'evaluations_status')
    ]
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get('with_evaluations'):
            self.response_data['evaluations'] = [
                SupplierEvaluationStub(
            ...
            self.response_data['evaluationsStatus'] = kwargs.get('evaluations_status', 'in_progress')
        else:
            self.response_data['evaluations'] = []
