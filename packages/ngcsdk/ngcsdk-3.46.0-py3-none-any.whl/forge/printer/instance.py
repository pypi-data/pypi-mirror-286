...
class InstanceOutput:  # noqa: D101
    ...
    @property
    def operatingSystemId(self):  # noqa: D102
    ...
    @property
    def alwaysBootWithCustomIpxe(self):  # noqa: D102
    ...
    @property
    def serialConsoleUrl(self):  # noqa: D102
        return self.instance.get("serialConsoleUrl", "")

    @property
    def interfaces(self):  # noqa: D102
        return self.instance.get("interfaces", [])

    @property
    def infinibandInterfaces(self):  # noqa: D102
    ...
    @property
    def allocationName(self):  # noqa: D102
    ...
    @property
    def machineName(self):  # noqa: D102
        return self.instance.get("machine", {}).get("productName", "")

    @property
    def operatingSystemName(self):  # noqa: D102
        return self.instance.get("operatingSystem", {}).get("name", "")

    @property
    def sshkeygroups(self):  # noqa: D102
...
class InterfaceOutput:  # noqa: D101
    ...
    @property
    def isPhysical(self):  # noqa: D102
        return self.interface.get("isPhysical", "")

    @property
    def virtualFunctionId(self):  # noqa: D102
...
class InfinibandInterfaceOutput:  # noqa: D101
    def __init__(self, interface):
        self.interface = interface
    ...
    @property
    def fabricId(self):  # noqa: D102
        return self.interface.get("fabricId", "")

    @property
    def partitionId(self):  # noqa: D102
        return self.interface.get("partitionId", "")

    @property
    def deviceInstance(self):  # noqa: D102
