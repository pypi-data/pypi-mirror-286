...
class AccessRuleTestCase(KbashTestCase):
...
class UserCalendarViewSetTestCase(TestDataMixin, KbashAPITestCase):
...
class SharedCalendarViewSetTestCase(TestDataMixin, KbashAPITestCase):
...
class AccessRuleViewSetTestCase(TestDataMixin, KbashAPITestCase):
...
class EventViewSetTestCase(TestDataMixin, KbashAPITestCase):
    """Event viewset tests."""
...
class AttendeeViewSetTestCase(KbashAPITestCase):
...
class MailboxViewSetTestCase(KbashAPITestCase):
