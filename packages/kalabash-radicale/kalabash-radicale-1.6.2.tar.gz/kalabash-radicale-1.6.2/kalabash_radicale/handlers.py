...
PERMISSIONS = [
    ("kalabash_radicale", "usercalendar", "add_usercalendar"),
    ("kalabash_radicale", "usercalendar", "change_usercalendar"),
    ("kalabash_radicale", "usercalendar", "delete_usercalendar"),
    ("kalabash_radicale", "sharedcalendar", "add_sharedcalendar"),
    ("kalabash_radicale", "sharedcalendar", "change_sharedcalendar"),
    ("kalabash_radicale", "sharedcalendar", "delete_sharedcalendar")
]
