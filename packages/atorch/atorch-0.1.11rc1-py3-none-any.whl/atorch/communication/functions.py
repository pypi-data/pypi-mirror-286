...
class _GatherFromExpertParallelRegionToMOE(torch.autograd.Function):
    ...
    def backward(ctx, grad_output, grad_handle=None):
        ...
        return _reduce_scatter_along_first_dim_moe(grad_output, use_global_buffer), None, None
...
def reduce_scatter_to_expert_parallel_region_from_moe(input_, use_global_buffer=False):
    return _ReduceScatterToExpertParallelRegionFromMOE.apply(input_, use_global_buffer)
