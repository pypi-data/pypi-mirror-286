...
def rand_person_info_list(n, start_age=18, end_age=70):
    ...
    surnames = [
        ...
        '元', '卜', '顾', '孟', '平', '黄', '和', '穆', '萧', '尹', '欧阳', '太史', '上官', '司马', '东方', '独孤',
        '南宫', '夏侯', '诸葛', '尉迟', '皇甫', '公孙', '慕容', '长孙', '宇文', '司徒', '司空', '轩辕', '令狐'
    ]
    ...
    area_codes = {
        ...
        500154: "开州区", 500155: "梁平区", 500156: "武隆区"
    }
    ...
    def rand_phone_number():
        ...
        str: 随机手机号
        """
        prefixes = [130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 147, 148, 149, 150, 151, 152, 153, 155, 156, 157,
                    158, 159, 166, 167, 172, 173, 175, 176, 177, 178, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189,
