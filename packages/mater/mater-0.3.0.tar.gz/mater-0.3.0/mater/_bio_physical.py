...
from mater._utils import _log_normal
...
class _MaterProcessBioPhysical(_MaterPreProcess):
    ...
    def _endogenously_controlled_process_computation(self, k: int):
        ...
        .. math::
            P^{endo^{ref}}_{l,p}(k) = \sum_{e}[F^{c^T}_{l,o}(k) \, s^c_{l,o,p}(k) + \sum_{d}[F^r_{l,o,c}(k)] \, s^r_{l,o,p}(k)]
    ...
    def _control_flow_composition_computation(self, k: int):
        ...
        .. math::
            F^{c^{comp}}_{l_p,p,o_c}(k) = \sum_{e}[\sum_{l}[s^c_{l_p,o,p}(k) \odot T^{c^{-1}}_{l_p,o,l}(k) \odot E^{comp}_{l,o,o_c}(k) \odot P_{l_p,p}(k)]]
    ...
    def _secondary_production_flow_computation(self, k: int):
        ...
        .. math::
            F^{r^{comp}}_{l,p,o_d}(k) = \sum_{e_c}[\sum_{e}[s^r_{l,o,p}(k) \odot R^{comp}_{l,o,o_c}(k) \odot P_{l,p}(k)] \odot r_{l,o_c,o_d}(k)]
    ...
    def _extraneous_flow_computation(self, k: int):
        ...
        .. math::
            F^e_{l,o_s,o_e}(k) = F^{thP}_{l,o_s,o_e}(k) + \sum_{e}[E^{eff}_{l,o_s,o,o_e}(k) \odot F^{thP}_{l,o_s,o}(k)]
    ...
    def _in_use_stock_computation(self, k: int):
        ...
        .. math::
            S^u_{l,o,c}(k) = S^u_{l,o,c}(k-1) - F^d_{l,o,c}(k) + \sum_{e_s}[F^e_{l,o_s,o}(k,k)] + F^c_{l,o}(k,k)
