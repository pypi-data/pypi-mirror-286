...
def run(
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        mlflow_utils.update_mlproject_yaml_with_env_vars_for_entrypoint(
            mlproject_yaml_file=f"{temp_dir}/{data.mlflow_mlproject_file_path}",
            env_vars=get_entrypoint_env_vars(
                run_config=data,
                mantik_token=mantik_token,
...
def get_entrypoint_env_vars(
    ...
    entrypoint_env_vars[
        env_vars.DATA_REPOSITORY_VERSION_ENV_VAR
    ] = run_config.data_version
