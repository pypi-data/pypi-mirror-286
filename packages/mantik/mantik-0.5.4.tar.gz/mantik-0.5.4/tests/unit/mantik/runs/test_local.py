...
@pytest.fixture()
def mock_mlflow_utils_update_mlproject_yaml_with_env_vars_for_entrypoint():
    with unittest.mock.patch(
        "mantik.utils.mlflow.update_mlproject_yaml_with_env_vars_for_entrypoint"
    ) as patch:
        yield patch
...
def test_local_run(
    ...
    mock_mlflow_utils_update_mlproject_yaml_with_env_vars_for_entrypoint,  # noqa E501
    ...
    with context:
        ...
        mock_mlflow_utils_update_mlproject_yaml_with_env_vars_for_entrypoint.assert_called()  # noqa E501
...
def test_local_run_with_private_repo(
    ...
    mock_get_user_id_from_token,
    mock_code_git_connection_response,
    mock_mlflow_utils_update_mlproject_yaml_with_env_vars_for_entrypoint,
    sample_project_id,
    fake_token,
) -> None:
    """
...
def test_construct_git_clone_uri(
    ...
    uri = mantik.runs.local.construct_git_clone_uri(
