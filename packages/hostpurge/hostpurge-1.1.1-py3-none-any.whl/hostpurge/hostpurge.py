...
def main():
    ...
    build_db_parser.add_argument("--add-to-library", dest="REFERENCE_GENOME.fasta", help="Please update your FASTA file headers to include the prefix in the following format: >GenomeID|kraken:taxid|39947. For more details, please refer to our GitHub help document.(required for kmer database)")
    build_db_parser.add_argument("--input-fasta", dest="REFERENCE_GENOME.fasta", help="Input reference genome FASTA file(required for alignment database)")
...
--------------------------------------
    ...
    optional arguments:
      ...
      --add-to-library REFERENCE_GENOME.fasta
                                    Please update your FASTA file headers to include the prefix in the following format: >GenomeID|kraken:taxid|39947. For more details, please refer to our GitHub help document.(required for k                                    mer database)
