...
from ..decorators import expose, permission_name, priority, protect, response_model_str
from ..dependencies import current_permissions, get_query_manager
...
class ModelRestApi(BaseApi):
    ...
    @expose("/", methods=["GET"], name="Get items", description="Get a list of items.")
    @protect()
    @permission_name("get")
    ...
    async def get_list_headless(
        self,
        q: QuerySchema = SelfType("query_schema", with_depends=True),
        query: QueryManager = SelfDepends(get_query_manager),
    ):
        """
    ...
    @expose("/{id}", methods=["GET"], name="Get item", description="Get a single item.")
    @protect()
    @permission_name("get")
    @response_model_str("show_return_schema")
    @priority(4)
    ...
    @expose("/", methods=["POST"], name="Add item", description="Add a new item.")
    @protect()
    @permission_name("post")
    @response_model_str("add_return_schema")
    @priority(3)
    ...
    @expose("/{id}", methods=["PUT"], name="Update item", description="Update an item.")
    @protect()
    @permission_name("put")
    @response_model_str("edit_return_schema")
    @priority(2)
