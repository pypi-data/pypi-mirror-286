...
class FastAPIReactToolkit:
    ...
    def pre_initialize(self):
        ...
        Default implementation sets the configuration values for the FastAPI application.
        """
        self._init_config()
    ...
    def _init_config(self):
        ...
        in the `g.auth` and `self.app` objects. It also sets the default values for any missing configuration settings.
        ...
        After setting the configuration values, the method updates the attributes of `self.app` with the corresponding
