...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_btc_balance() != 29947:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_media_dir() != 42269:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_wallet_data() != 14427:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibffi_checksum_method_wallet_get_wallet_dir() != 56411:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_media_dir.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_media_dir.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_wallet_data.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_wallet_data.restype = _UniffiRustBuffer
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_wallet_dir.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_wallet_dir.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_media_dir.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_media_dir.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_wallet_data.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_wallet_data.restype = ctypes.c_uint16
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_wallet_dir.argtypes = (
)
_UniffiLib.uniffi_rgblibffi_checksum_method_wallet_get_wallet_dir.restype = ctypes.c_uint16
...
class Wallet:
    ...
    def get_media_dir(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_media_dir,self._uniffi_clone_pointer(),)
        )
    ...
    def get_wallet_data(self, ) -> "WalletData":
        return _UniffiConverterTypeWalletData.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_wallet_data,self._uniffi_clone_pointer(),)
        )
    ...
    def get_wallet_dir(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_rgblibffi_fn_method_wallet_get_wallet_dir,self._uniffi_clone_pointer(),)
        )
