...
cur_path = os.path.abspath('.') + '/device_log'
...
# log_level = logging.getLevelNamesMapping().get(conf.get("log", 'root_level'), logging.INFO)
log_level = logging.getLevelName(conf.get("log", 'root_level'))
...
# 设置此Handler的最低日志级别
file_handler.setLevel(logging.getLevelName(conf.get("log", 'file_level')))
...
stream_handler.setLevel(logging.getLevelName(conf.get("log", 'console_level')))
