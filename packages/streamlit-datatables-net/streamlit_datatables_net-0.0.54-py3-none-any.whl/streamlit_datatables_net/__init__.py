                ...
                with st.echo():
                    ...
                    with dt_container:
                        ...
                        dt_response = st_datatable(
                            big_data, column_order=column_order, props=props, key="example 1", dt_config="default", date_format="%m/%d/%Y", is_datetime=True, enable_top_navigation=False, export_file_name="Example 1", on_select=on_select)
