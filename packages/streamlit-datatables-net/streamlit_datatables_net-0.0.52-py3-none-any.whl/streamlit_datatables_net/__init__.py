...
def st_datatable(data: pd.DataFrame | list[dict], column_order: List[str] = None, props: Dict = None, dt_config: str = "default", table_id: str = None, class_name: str = None, js_scripts: List[str] = None, stylesheets: List[str] = None, disabled: bool = False, enable_top_navigation: bool = False, date_format: str = None, is_datetime: bool = False, export_file_name: str = None, height_offset: int = None, on_select: Optional[Union[Literal["ignore"], Literal["rerun"], Callable]] = "rerun", on_change: Optional[Callable] = None, on_click: Optional[Callable] = None, args: Optional[Tuple[Any, ...]] = None,
    ...
    height_offset:
        An optional integer to apply to the iframe height if the datatable is clipped using the automatically determined height.
    on_change:
    ...
    component_value = _component_func(
        props=props, test=props, table_id=table_id, class_name=class_name, js_scripts=js_scripts, stylesheets=stylesheets, key=key, on_change=on_change, disabled=disabled, date_format=luxon_date_format, export_file_name=export_file_name, height_offset=height_offset, default=None)
                ...
                with st.echo():
                    ...
                    with dt_container:
                        ...
                        dt_response = st_datatable(
                            big_data, column_order=column_order, props=props, table_id="my-table", key="example_1", dt_config="default", date_format="%m/%d/%Y", is_datetime=True, enable_top_navigation=True, export_file_name="Example 1", height_offset=None, on_select=on_select)
