...
if _RELEASE:
    ...
    build_dir = os.path.join(parent_dir, "frontend/build2")
                ...
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            big_data, column_order=column_order, props=props, table_id="my-table", key="example_1", dt_config="default", date_format="%m/%d/%Y", is_datetime=True, enable_top_navigation=True, export_file_name="Example 1", on_select=my_on_click_function)
