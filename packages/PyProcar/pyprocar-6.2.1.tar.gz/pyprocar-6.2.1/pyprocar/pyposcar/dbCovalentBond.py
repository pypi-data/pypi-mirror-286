# Number Element Single1 Single2 Double Triple covalent radii from the
# two recent original determinations by Cordero et al.[1], and Pyykkö
# and Atsumi [2]. The differences between the two single-bond values
# are often explained by the different coordination numbers in the two
# data bases used.
...
# Alvarez (2008). "Covalent radii revisited". Dalton Trans. (21):
# 2832–2838 http://dx.doi.org/10.1039/b801115j
#
# 2 Pekka Pyykkö, Michiko Atsumi (2009). "Molecular Double-Bond
# Covalent Radii for Elements Li–E112". Chemistry: A European Journal
# 15 (46): 12770–12779. dx.doi.org/10.1002/chem.200901472


covalent_radii = """1 	H 	31 	32 	- 	-
2 	He 	28 	46 	- 	-
3 	Li 	128 	133 	124 	-
4 	Be 	96 	102 	90 	85
5 	B 	84 	85 	78 	73
