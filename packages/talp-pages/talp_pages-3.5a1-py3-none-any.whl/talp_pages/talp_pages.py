    ...
    for root, dirs, files in os.walk(base_path):
        ...
        if json_files:
            ...
            if(str(relative_root) != "."):
                run_folders.append(RunFolder(relative_path=relative_root, jsons=json_files,latest_json=None))
...
def set_newest_json(run_folder):
    newest_json = None
    ...
    for json_entry in run_folder.jsons:
        with open(json_entry) as file:
            ...
            try:
                ...
                df_single = df_single.assign(metadata={})
...
def main():
    ...
    parser.add_argument('--badge',  help="Create Badge of newest run for each folder",default=True,action=argparse.BooleanOptionalAction)
    ...
    for run_folder in run_folders:
        ...
        pages.append(
            TalpPage(
                run_folder=run_folder, output_path=run_folder.relative_path, html=html, badge=badge
            )
        )
    for page in pages:
