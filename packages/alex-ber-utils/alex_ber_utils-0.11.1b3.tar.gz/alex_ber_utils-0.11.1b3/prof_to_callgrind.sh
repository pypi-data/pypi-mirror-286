...
$DEFAULT_MULTIPLER_TO_SECONDS=1

# Function to display help
function display_help() {
    echo "Usage: $0 [INPUT_FILE] [OUTPUT_FILE] [MULTIPLER_TO_SECONDS] [PROJECT_DIR] [APP_DIR]"
    echo
    echo "Arguments:"
    ...
    echo "  MULTIPLER_TO_SECONDS   The output .callgrind file (default: $DEFAULT_MULTIPLER_TO_SECONDS)"
...
docker run --rm \
    ...
    python /opt/project/$APP_DIR/alexber/utils/prof_to_callgrind.py /opt/project/$APP_DIR/$INPUT_FILE /opt/project/$APP_DIR/$OUTPUT_FILE multipler_to_seconds