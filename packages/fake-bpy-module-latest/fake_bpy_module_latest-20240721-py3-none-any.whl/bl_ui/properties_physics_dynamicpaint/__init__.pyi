...
class PHYSICS_PT_dp_cache(bpy.types.Panel, PhysicButtonsPanel, bpy_types._GenericUI):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
...
class PHYSICS_PT_dp_effects(bpy.types.Panel, PhysicButtonsPanel, bpy_types._GenericUI):
    COMPAT_ENGINES: typing.Any
    bl_context: typing.Any
    bl_label: typing.Any
    bl_options: typing.Any
