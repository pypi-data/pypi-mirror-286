...
class PlexMovieMetadata:
    ...
    source: Optional[str]
    Image: Optional[List[PlexImage]]
    Genre: Optional[List[PlexGenre]]
    Guid: Optional[List[PlexGuid]]
#    Collection: Optional[List[PlexCollection]]
    Country: Optional[List[PlexCountry]]
    Role: Optional[List[PlexRole]]
    Director: Optional[List[PlexDirector]]
    Producer: Optional[List[PlexProducer]]
    Writer: Optional[List[PlexWriter]]
    Rating: Optional[List[PlexRating]]
    Studio: Optional[List[PlexStudio]]
