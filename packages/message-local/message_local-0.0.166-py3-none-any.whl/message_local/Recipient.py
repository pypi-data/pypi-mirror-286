...
class Recipient:
    ...
    # TODO get_user_dict
    def get_user_dict(self, system_id: int) -> dict:
        ...
        user_dict = {"username": list(username), "user_external_id": list(user_external_id), "phone.full_number_normalized": list(telephone_number)}
        return user_dict
