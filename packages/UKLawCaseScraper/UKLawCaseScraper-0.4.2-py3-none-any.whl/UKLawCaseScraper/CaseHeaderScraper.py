...
class CaseHeaderScraper:
    ...
    def save_to_file(self, filename, url, data):
        """Saves the data to the JSON file."""
        with open(filename, 'a') as f:
            json.dump({url: data}, f, ensure_ascii=False, indent=4, default=str)
            f.write('\n')
    ...
    def judgment_Dlink(self, modified_list, output_file):
        ...
        for url in modified_list:
            ...
            for judgment in judgments:
                ...
                self.save_to_file(output_file, url, data)
    ...
    def scrape_header_info(self, modified_list, output_file):
        ...
        for url in modified_list:
            ...
            # Save each header info to file immediately
            self.save_to_file(output_file, url, data)
