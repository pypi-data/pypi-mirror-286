.. container:: document
   ...
   IDE) <https://github.com/robotframework/RIDE/>`__ v2.1dev56 is a new
   ...
   *Linux users are advised to install first wxPython from .whl package
   ...
   .. code:: literal-block
      ...
      pip install --upgrade robotframework-ride==v2.1dev56
   ...
   RIDE v2.1dev56 was released on 29/June/2024.
