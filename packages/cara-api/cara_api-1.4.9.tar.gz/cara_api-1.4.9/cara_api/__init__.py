    ...
    def get_user(self, user_id: str):
        try:
            ...
            if response.status_code == 404:
                response_json = {
                    "displayName": "Unknwon USER",
                    "globalName": "unknown_user",
                    "id": 0,
                    "analysisResults": {
                        "timeDistAvg": 0,
                        "timeDistStdDev": 0,
                        "partTimeDistLessThan10sec": 0,
                        "numDifferentChannels": 0,
                        "numDifferentGuilds": 0,
                        "maxRepetitiveStreak": 0,
                        "maxTypingSpeed1min": 0,
                        "msgLengthAvg": 0,
                        "msgLengthStdDev": 0
                    },
                    "isSpammer": False,
                ...
                response_json = response.json()
            logger.info("CaraAPI RESPONSE: " + str(response.text))
