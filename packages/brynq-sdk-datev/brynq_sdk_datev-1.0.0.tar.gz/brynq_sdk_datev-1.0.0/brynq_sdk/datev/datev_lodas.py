...
class DatevLodas:
    ...
    def employee_declarations(df: pd.DataFrame,
        ...
        template_description = [f"309;u_lod_bwd_nachbar;{'pnr_betriebliche#psd' if use_alternative_employee_number else 'pnr#bwd'};abrechnung_zeitraum#bwd;bs_wert_butab#bwd;bs_nr#bwd;kostenstelle#bwd;la_eigene#bwd;abw_lohnfaktor#bwd;\n"]
