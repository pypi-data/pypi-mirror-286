...
async def descartes(task):
    ...
    try:
        ...
        for item in itens:
            ...
            window_pesquisa_item = await find_element_center(ASSETS_BASE_PATH + "window_pesquisa_item.png", (488, 226, 352, 175), 15)
            ...
            warning_price = await find_element_center(ASSETS_BASE_PATH + "warning_item_price.png",  (824, 426, 255, 191), 15)
            ...
            field_saldo_disponivel = await find_element_center(ASSETS_BASE_PATH + "field_saldo_disponivel.png", (797, 545, 167, 80), 15)
