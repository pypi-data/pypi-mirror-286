...
from .customized_dataset import get_week_range
...
__all__ = ['CDataset', 'create_char_to_idx', 'max_len_report', 'get_version',
        ...
        'MonthlyAnalysis', 'GroupAnalysis', 'LSTMPredictor', 'get_week_range']
...
__analysis__= ['MonthlyAnalysis', 'GroupAnalysis', 'get_week_range']