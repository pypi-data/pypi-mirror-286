...
class ExperimentConfig:
    ...
    Args:
        ...
        name (string, optional, defaults to None) - Allows you to set the name of the experiment.
        tags (List[str], optional, defaults to None) - Allows you to set tags to be associated with the experiment.
    """
