...
def stop_all_jobs_on_cluster_instance(args):
    try:
        ...
        response_json, status_code = ClusterInstance.stop_all_jobs_on_cluster_instance(
            json_data.get('cluster_id')
        )
...
def list_instance_errors(args):
    try:
        ...
        response_json, status_code = ClusterInstance.list_cluster_errors_by_cluster_instance_id(
            json_data.get('cluster_id'),
