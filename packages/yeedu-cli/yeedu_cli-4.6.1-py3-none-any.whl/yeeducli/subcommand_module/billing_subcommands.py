...
def list_billed_tenants(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_tenants(
...
def list_billed_date_range(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_date_range(
            json_data.get('billing_type'),
...
def list_billed_clusters(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_clusters(
            json_data.get('billing_type'),
            json_data.get('tenant_ids'),
...
def list_billed_machine_types(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_machine_types(
            json_data.get('billing_type'),
            json_data.get('tenant_ids'),
            json_data.get('cloud_providers'),
...
def list_billed_labels(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_labels(
            json_data.get('billing_type'),
            json_data.get('tenant_ids'),
            json_data.get('cloud_providers'),
            json_data.get('cluster_ids')
...
def list_billed_usage(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_usage(
...
def list_billed_invoice(args):
    try:
        ...
        response_json, status_code = Billing.list_billed_invoice(
