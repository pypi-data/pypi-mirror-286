...
def download_command(API_KEY=None, model_version=None):
    ...
    if 400 <= response.status_code < 500:
        print(
            f"There was an issue downloading your weights with status code {response.status_code}"
            + response.text
        )
        return
    ...
    print(
        "There was an internal error while processing your model. If this problem persists, please contact sieve support"
    )
