...
class CloudRunServiceContainer(GCPResource[CloudRunServiceContainerOutputs]):
    ...
    ****Example usage:****
    ...
    def import_tofu_resource(
        ...
        """Import the Cloud Run service resource.
        ...
        **Returns:**
        ...
        """
        location = self.region or environment_state.gcp_config.default_region
        return {
            "google_cloud_run_v2_service.service": f"projects/{environment_state.gcp_config.project_id}/locations/{location}/services/{self.resource_id}",
        }
