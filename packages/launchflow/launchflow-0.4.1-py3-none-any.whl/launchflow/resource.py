...
def _load_outputs_from_remote_bucket(
    ...
    try:
        ...
        # TODO: Add exception handling for not found vs forbidden
...
class Resource(Node[T]):
    ...
    def inputs_depend_on(self, environment_state: EnvironmentState) -> List["Resource"]:
