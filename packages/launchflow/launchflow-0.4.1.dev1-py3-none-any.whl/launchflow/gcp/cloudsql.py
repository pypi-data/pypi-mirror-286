...
class CloudSQLPostgres(
    ...
    def import_tofu_resource(
        ...
        """Import the Cloud SQL Postgres resource.

        **Args:**
        - `environment (EnvironmentState)`: The environment state.

        **Returns:**
        - `Dict[str, str]`: A dictionary of resources to import.
        """
        imports = {
        ...
        if self.include_default_user:
            ...
            ] = f"{environment_state.gcp_config.project_id}/{self.name}/{self.name}-user"
        return imports
...
class CloudSQLUser(GCPResource[CloudSQLUserOutputs]):
    ...
    def import_tofu_resource(
        ...
        """Import the Cloud SQL User resource.
        ...
        **Returns:**
        ...
        """
        return {
            "google_sql_user.cloud_sql_user": f"{environment_state.gcp_config.project_id}/{self.cloud_sql_instance.resource_id}/{self.resource_id}",
        }

    def outputs(self) -> CloudSQLUserOutputs:
        """Get the outputs for the Cloud SQL User resource.

        **Returns:**
        - `CloudSQLUserOutputs`: The outputs for the Cloud SQL User resource.
        """
    ...
    async def outputs_async(self) -> CloudSQLUserOutputs:
        """Get the async outputs for the Cloud SQL User resource.

        **Returns:**
        - `CloudSQLUserOutputs`: The async outputs for the Cloud SQL User resource.
        """
        if self.password is None:
...
class CloudSQLDatabase(GCPResource[CloudSQLDataBaseOutputs]):
    ...
    def outputs(self) -> CloudSQLDataBaseOutputs:
        """Get the outputs for the Cloud SQL Database resource.

        **Returns:**
        - `CloudSQLDataBaseOutputs`: The outputs for the Cloud SQL Database resource.
        """
        return CloudSQLDataBaseOutputs(database_name=self.name)

    async def outputs_async(self) -> CloudSQLDataBaseOutputs:
        """Get the async outputs for the Cloud SQL Database resource.

        **Returns:**
        - `CloudSQLDataBaseOutputs`: The async outputs for the Cloud SQL Database resource.
        """
        return CloudSQLDataBaseOutputs(database_name=self.name)
    ...
    def import_tofu_resource(
        ...
        """Import the Cloud SQL Database resource.
        ...
        **Returns:**
        ...
        """
        return {
            "google_sql_database.cloud_sql_database": f"{environment_state.gcp_config.project_id}/{self.cloud_sql_instance.resource_id}/{self.resource_id}"
        }
