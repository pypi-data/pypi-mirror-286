...
Received: from demo.alphamonak.com ([127.0.0.1])
    by localhost (demo.alphamonak.com [127.0.0.1]) (amavisd-new, port 10024)
    with ESMTP id nq6ekd4wtXZg for <user@demo.local>;
    Thu,  9 Nov 2017 15:59:52 +0100 (CET)
Received: from demo.alphamonak.com (localhost [127.0.0.1])
    by demo.alphamonak.com (Postfix) with ESMTP
...
From: {sender}
To: {rcpt}
Message-ID: <151023959268.5550.5713670714483771838@demo.alphamonak.com>
