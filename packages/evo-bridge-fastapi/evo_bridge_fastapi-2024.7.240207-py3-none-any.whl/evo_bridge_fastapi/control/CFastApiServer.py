...
# ----------------------------------------------------------------------------------------------------------------------------------------  
    async def doRunServer(self):
        try:
            ...
            ssl_keyfile = CSetting.getInstance().doGet("CYBORGAI_SSL_KEY")
            ssl_certfile = CSetting.getInstance().doGet("CYBORGAI_SSL_CERT")
           
            IuLog.doInfo(__name__, f"ssl_certfile: {ssl_certfile}")
            IuLog.doInfo(__name__, f"ssl_certfile: {ssl_certfile}")
            
            if not IuText.StringEmpty(ssl_keyfile) and not IuText.StringEmpty(ssl_certfile) and not IuText.StringEmpty(ssl_keyfile_password):
