    ...
    async def doRunServer(self):
        try:
            ...
            if not IuText.StringEmpty(ssl_key_env) and not IuText.StringEmpty(ssl_cert_env):
                ...
                hashCert = IuCryptHash.toSha256(ssl_certPem)
                ...
                print(IuCryptHash.toSha256(ssl_keyPem))
                print(IuCryptHash.toSha256(ssl_certPem))
                
                IuLog.doWarning(__name__, f"ssl_keyfile_password:{ssl_key_password_env}")
                ...
                context.load_cert_chain(certfile=ssl_keyFile, keyfile=ssl_certFile, password=ssl_key_password_env)
                ...
                config = uvicorn.Config(
                    ...
                    ssl_keyfile_password=ssl_key_password_env,
