...
# ----------------------------------------------------------------------------------------------------------------------------------------  
    async def doRunServer(self):
        try:
            ...
            IuLog.doVerbose(__name__, f"SSL key password: {IuText.StringEmpty(ssl_keyfile_password)}")
            IuLog.doVerbose(__name__, f"SSL key: {IuText.StringEmpty(ssl_keyfilePem)}")
            IuLog.doVerbose(__name__, f"ssl_certfile: {ssl_certfilePem}")
            
            if IuText.StringEmpty(ssl_keyfilePem) and not IuText.StringEmpty(ssl_certfilePem):
