...
class OrderState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PARTIAL_FILLED: _ClassVar[OrderState]
    FILLED: _ClassVar[OrderState]
    CANCELED: _ClassVar[OrderState]
    REJECTED: _ClassVar[OrderState]
    EXPIRED: _ClassVar[OrderState]
UNKNOWN: OrderState
CREATED: OrderState
SUBMITTED: OrderState
PARTIAL_FILLED: OrderState
FILLED: OrderState
CANCELED: OrderState
REJECTED: OrderState
EXPIRED: OrderState
...
class Order(_message.Message):
    ...
    source: str
    tag: str
    def __init__(self, platform: _Optional[str] = ..., instrument: _Optional[str] = ..., order_id: _Optional[str] = ..., state: _Optional[_Union[OrderState, str]] = ..., price: _Optional[str] = ..., amount: _Optional[str] = ..., filled_amount: _Optional[str] = ..., avg_price: _Optional[str] = ..., type: _Optional[str] = ..., side: _Optional[str] = ..., client_order_id: _Optional[str] = ..., created_time: _Optional[int] = ..., updated_time: _Optional[int] = ..., info: _Optional[str] = ..., investor: _Optional[str] = ..., strategy: _Optional[str] = ..., source: _Optional[str] = ..., tag: _Optional[str] = ...) -> None: ...
