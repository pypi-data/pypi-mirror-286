...
compiler_options = [
    "Compile, debug and livestream (development)",
    "Debug and livestream",
    "Create aab (production)",
...
#     t1 = time.time()
#     notify_that_compilation_started()
#     os.system("buildozer -v android release")
#     t2 = time.time()
#     notify_that_compilation_finished(t2 - t1)
...
def start():
    ...
    while True:
        ...
        # left key, q, ESC
            ...
            break
            # selected_folder = folder_options[0]
            # navigate_folder_options()
