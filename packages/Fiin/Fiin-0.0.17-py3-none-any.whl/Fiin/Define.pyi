...
class FiinDataHistorical:
    ...
    def preprocess_data(self) -> None:
        ...
    def round_time(self, dt, start_time) -> str:
        ...
    def group_by_data(self) -> pd.DataFrame:
        ...
...
class SubcribeForRealTimeData:
    ...
    def data_handler(self, message) -> None:
        ...
...
class FiinSession:
    ...
    def FiinIndicator(self) -> FiinIndicator:
        ...
    def SubcribeForRealTimeData(self, ticker: str, callback: callable) -> SubcribeForRealTimeData:
        ...
