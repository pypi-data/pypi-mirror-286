...
def submit_selection():
    selected_nodes = []
    if var1.get():
        selected_nodes.append(("Node 1", "curl -I http://172.18.69.29:8080/job/COLLAB%20TEAM/job/MOBILE/job/iOS%20Mobile%20App/job/APP_INSTALL/job/NODE%201/buildWithParameters?token=116ec8a3d7f804033452db1feb428d7ddb"))
    if var2.get():
        selected_nodes.append(("Node 2", "curl -I http://172.18.69.29:8080/job/COLLAB%20TEAM/job/MOBILE/job/iOS%20Mobile%20App/job/APP_INSTALL/job/NODE%202/buildWithParameters?token=116ec8a3d7f804033452db1feb428d7ddb"))
    if var3.get():
        selected_nodes.append(("Node 3", "curl -I http://172.18.69.29:8080/job/COLLAB%20TEAM/job/MOBILE/job/iOS%20Mobile%20App/job/APP_INSTALL/job/NODE%203/buildWithParameters?token=116ec8a3d7f804033452db1feb428d7ddb"))
    if var_all.get():
        selected_nodes = [
            ("Node 1", "curl -I http://172.18.69.29:8080/job/COLLAB%20TEAM/job/MOBILE/job/iOS%20Mobile%20App/job/APP_INSTALL/job/NODE%201/buildWithParameters?token=116ec8a3d7f804033452db1feb428d7ddb"),
            ("Node 2", "curl -I http://172.18.69.29:8080/job/COLLAB%20TEAM/job/MOBILE/job/iOS%20Mobile%20App/job/APP_INSTALL/job/NODE%202/buildWithParameters?token=116ec8a3d7f804033452db1feb428d7ddb"),
            ("Node 3", "curl -I http://172.18.69.29:8080/job/COLLAB%20TEAM/job/MOBILE/job/iOS%20Mobile%20App/job/APP_INSTALL/job/NODE%203/buildWithParameters?token=116ec8a3d7f804033452db1feb428d7ddb")
        ]
