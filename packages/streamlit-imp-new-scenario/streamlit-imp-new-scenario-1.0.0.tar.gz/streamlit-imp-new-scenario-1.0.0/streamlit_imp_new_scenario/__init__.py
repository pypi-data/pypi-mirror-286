...
if not _RELEASE:
    streamlit_imp_new_scenario_component(base_url="http://127.0.0.1:9000")
else:
    streamlit_imp_new_scenario_component(base_url="https://streamlit-imp-new-scenario.herokuapp.com")
