...
setup(
    name="mocker_db",
    packages=["mocker_db"],
    install_requires=['### mocker_db.py', 'fastapi==0.109.1', 'click==8.1.3', 'httpx', 'dill==0.3.7', 'attrs>=22.2.0', 'pyyaml', 'numpy==1.26.0', 'gitpython==3.1.41', 'uvicorn==0.29.0', 'gridlooper==0.0.1', 'sentence-transformers==2.2.2', 'appdirs==1.4.3', 'hnswlib==0.8.0'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A mock handler for simulating a vector database.", version="0.2.0"
)
