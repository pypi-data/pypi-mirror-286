...
def affinity_benchmark(result_path, benchmark_name="BTK"):
    ...
    if result_path is None:
        ...
        if benchmark_name == "BTK":
            ...
            benchmark_affinity_path = "./benchmark/benchmark_affinity_wT.json"
            ...
            benchmark_affinity_path = "./benchmark/benchmark_affinity_M.json"
            with open(benchmark_affinity_path, "r") as f:
                benchmark_affinity = json.load(f)
            with open(result_path, "r") as f:
                result = json.load(f)
...
def rmsd_benchmark(your_protein_path, align_atoms='all', alignment_strategy='default'):
    ...
    current_dir = os.getcwd()
    benchmark_protein_path = os.path.join(current_dir, "benchmark/benchmark_RMSD/benchmark_protein.pdb")
