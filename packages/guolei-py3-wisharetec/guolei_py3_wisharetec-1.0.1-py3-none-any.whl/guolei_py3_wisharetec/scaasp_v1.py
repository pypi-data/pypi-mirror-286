...
class RequestsResponseCallable(guolei_py3_requests.RequestsResponseCallable):
    """
    guolei_py3_wisharetec scaasp_v2 Admin Api RequestsResponseCallable
...
class AdminApi(object):
    """
    guolei_py3_wisharetec scaasp_v2 Admin Api
    ...
    def __init__(
        ...
        """
        guolei_py3_wisharetec scaasp_v2 Admin Api constructor
    ...
    def requests_request(
        ...
        :param path: path
        :param is_need_login: if True set requests_request_kwargs.headers.Token and Companycode
