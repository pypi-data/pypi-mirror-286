...
from ..models.update_sign_up_response_200_object import UpdateSignUpResponse200Object
from ..models.update_sign_up_response_200_status import UpdateSignUpResponse200Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_sign_up_response_200_external_account import UpdateSignUpResponse200ExternalAccount
    from ..models.update_sign_up_response_200_public_metadata import UpdateSignUpResponse200PublicMetadata
    from ..models.update_sign_up_response_200_unsafe_metadata import UpdateSignUpResponse200UnsafeMetadata
    from ..models.update_sign_up_response_200_verifications import UpdateSignUpResponse200Verifications


T = TypeVar("T", bound="UpdateSignUpResponse200")


@_attrs_define
class UpdateSignUpResponse200:
    """
    Attributes:
        object_ (UpdateSignUpResponse200Object):
        id (str):
        status (UpdateSignUpResponse200Status):
        ...
        verifications (Union[Unset, UpdateSignUpResponse200Verifications]):
        ...
        unsafe_metadata (Union[Unset, UpdateSignUpResponse200UnsafeMetadata]):
        public_metadata (Union[Unset, UpdateSignUpResponse200PublicMetadata]):
        external_id (Union[None, Unset, str]):
        created_session_id (Union[None, Unset, str]):
        created_user_id (Union[None, Unset, str]):
        external_account (Union[Unset, UpdateSignUpResponse200ExternalAccount]):
    """
    ...
    verifications: Union[Unset, "UpdateSignUpResponse200Verifications"] = UNSET
    ...
    unsafe_metadata: Union[Unset, "UpdateSignUpResponse200UnsafeMetadata"] = UNSET
    public_metadata: Union[Unset, "UpdateSignUpResponse200PublicMetadata"] = UNSET
    external_id: Union[None, Unset, str] = UNSET
    created_session_id: Union[None, Unset, str] = UNSET
    created_user_id: Union[None, Unset, str] = UNSET
    external_account: Union[Unset, "UpdateSignUpResponse200ExternalAccount"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = UpdateSignUpResponse200Object(d.pop("object"))

        id = d.pop("id")

        status = UpdateSignUpResponse200Status(d.pop("status"))
        ...
        if isinstance(_verifications, Unset):
            ...
            verifications = UpdateSignUpResponse200Verifications.from_dict(_verifications)
        ...
        if isinstance(_unsafe_metadata, Unset):
            ...
            unsafe_metadata = UpdateSignUpResponse200UnsafeMetadata.from_dict(_unsafe_metadata)
        ...
        if isinstance(_public_metadata, Unset):
            ...
            public_metadata = UpdateSignUpResponse200PublicMetadata.from_dict(_public_metadata)
        ...
        if isinstance(_external_account, Unset):
            ...
            external_account = UpdateSignUpResponse200ExternalAccount.from_dict(_external_account)

        update_sign_up_response_200 = cls(
            object_=object_,
            id=id,
            status=status,
            password_enabled=password_enabled,
        ...
        return update_sign_up_response_200
