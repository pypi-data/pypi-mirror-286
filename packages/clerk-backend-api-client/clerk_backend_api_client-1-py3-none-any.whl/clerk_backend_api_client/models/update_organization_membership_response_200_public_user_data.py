...
T = TypeVar("T", bound="UpdateOrganizationMembershipResponse200PublicUserData")


@_attrs_define
class UpdateOrganizationMembershipResponse200PublicUserData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_organization_membership_response_200_public_user_data = cls(
            user_id=user_id,
        ...
        return update_organization_membership_response_200_public_user_data
