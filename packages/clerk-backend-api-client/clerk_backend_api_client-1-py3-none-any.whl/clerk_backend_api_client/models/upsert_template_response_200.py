...
from ..models.upsert_template_response_200_object import UpsertTemplateResponse200Object
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpsertTemplateResponse200")


@_attrs_define
class UpsertTemplateResponse200:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, UpsertTemplateResponse200Object]): String representing the object's type. Objects of the
    ...
    object_: Union[Unset, UpsertTemplateResponse200Object] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, UpsertTemplateResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = UpsertTemplateResponse200Object(_object_)
        ...
        upsert_template_response_200 = cls(
            id=id,
            object_=object_,
        ...
        return upsert_template_response_200
