...
from ..models.organizations_data_item_object import OrganizationsDataItemObject
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.organizations_data_item_private_metadata import OrganizationsDataItemPrivateMetadata
    from ..models.organizations_data_item_public_metadata import OrganizationsDataItemPublicMetadata


T = TypeVar("T", bound="OrganizationsDataItem")


@_attrs_define
class OrganizationsDataItem:
    """
    Attributes:
        object_ (OrganizationsDataItemObject):
        id (str):
        name (str):
        slug (str):
        max_allowed_memberships (int):
        public_metadata (OrganizationsDataItemPublicMetadata):
        private_metadata (OrganizationsDataItemPrivateMetadata):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = OrganizationsDataItemObject(d.pop("object"))
        ...
        public_metadata = OrganizationsDataItemPublicMetadata.from_dict(d.pop("public_metadata"))

        private_metadata = OrganizationsDataItemPrivateMetadata.from_dict(d.pop("private_metadata"))
        ...
        organizations_data_item.additional_properties = d
        return organizations_data_item
