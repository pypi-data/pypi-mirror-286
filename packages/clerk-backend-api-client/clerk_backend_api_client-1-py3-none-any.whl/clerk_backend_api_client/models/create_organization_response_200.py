...
from ..models.create_organization_response_200_object import CreateOrganizationResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_organization_response_200_private_metadata import CreateOrganizationResponse200PrivateMetadata
    from ..models.create_organization_response_200_public_metadata import CreateOrganizationResponse200PublicMetadata
...
class CreateOrganizationResponse200:
    """
    Attributes:
        object_ (CreateOrganizationResponse200Object):
        id (str):
        name (str):
        slug (str):
        max_allowed_memberships (int):
        public_metadata (CreateOrganizationResponse200PublicMetadata):
        private_metadata (CreateOrganizationResponse200PrivateMetadata):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.create_organization_response_200_private_metadata import (
            CreateOrganizationResponse200PrivateMetadata,
        )
        from ..models.create_organization_response_200_public_metadata import (
            CreateOrganizationResponse200PublicMetadata,
        )

        d = src_dict.copy()
        object_ = CreateOrganizationResponse200Object(d.pop("object"))
        ...
        public_metadata = CreateOrganizationResponse200PublicMetadata.from_dict(d.pop("public_metadata"))

        private_metadata = CreateOrganizationResponse200PrivateMetadata.from_dict(d.pop("private_metadata"))
