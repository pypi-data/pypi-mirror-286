...
T = TypeVar("T", bound="UpdateOrganizationMembershipMetadataResponse200PublicUserData")


@_attrs_define
class UpdateOrganizationMembershipMetadataResponse200PublicUserData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_organization_membership_metadata_response_200_public_user_data = cls(
            user_id=user_id,
        ...
        return update_organization_membership_metadata_response_200_public_user_data
