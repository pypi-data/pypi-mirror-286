...
if TYPE_CHECKING:
    from ..models.clerk_errors_errors_item import ClerkErrorsErrorsItem
...
class ClerkErrors:
    """
    Attributes:
        errors (List['ClerkErrorsErrorsItem']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for errors_item_data in _errors:
            errors_item = ClerkErrorsErrorsItem.from_dict(errors_item_data)
