...
from ..models.delete_user_profile_image_response_200_object import DeleteUserProfileImageResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.delete_user_profile_image_response_200_email_addresses_item import (
        DeleteUserProfileImageResponse200EmailAddressesItem,
    )
    from ..models.delete_user_profile_image_response_200_external_accounts_item import (
        DeleteUserProfileImageResponse200ExternalAccountsItem,
    )
    from ..models.delete_user_profile_image_response_200_passkeys_item import (
        DeleteUserProfileImageResponse200PasskeysItem,
    )
    from ..models.delete_user_profile_image_response_200_phone_numbers_item import (
        DeleteUserProfileImageResponse200PhoneNumbersItem,
    )
    from ..models.delete_user_profile_image_response_200_private_metadata_type_0 import (
        DeleteUserProfileImageResponse200PrivateMetadataType0,
    )
    from ..models.delete_user_profile_image_response_200_public_metadata import (
        DeleteUserProfileImageResponse200PublicMetadata,
    )
    from ..models.delete_user_profile_image_response_200_saml_accounts_item import (
        DeleteUserProfileImageResponse200SamlAccountsItem,
    )
    from ..models.delete_user_profile_image_response_200_unsafe_metadata import (
        DeleteUserProfileImageResponse200UnsafeMetadata,
    )
    from ..models.delete_user_profile_image_response_200_web_3_wallets_item import (
        DeleteUserProfileImageResponse200Web3WalletsItem,
    )


T = TypeVar("T", bound="DeleteUserProfileImageResponse200")


@_attrs_define
class DeleteUserProfileImageResponse200:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, DeleteUserProfileImageResponse200Object]): String representing the object's type. Objects
        ...
        public_metadata (Union[Unset, DeleteUserProfileImageResponse200PublicMetadata]):
        private_metadata (Union['DeleteUserProfileImageResponse200PrivateMetadataType0', None, Unset]):
        unsafe_metadata (Union[Unset, DeleteUserProfileImageResponse200UnsafeMetadata]):
        email_addresses (Union[Unset, List['DeleteUserProfileImageResponse200EmailAddressesItem']]):
        phone_numbers (Union[Unset, List['DeleteUserProfileImageResponse200PhoneNumbersItem']]):
        web3_wallets (Union[Unset, List['DeleteUserProfileImageResponse200Web3WalletsItem']]):
        passkeys (Union[Unset, List['DeleteUserProfileImageResponse200PasskeysItem']]):
        ...
        external_accounts (Union[Unset, List['DeleteUserProfileImageResponse200ExternalAccountsItem']]):
        saml_accounts (Union[Unset, List['DeleteUserProfileImageResponse200SamlAccountsItem']]):
    ...
    object_: Union[Unset, DeleteUserProfileImageResponse200Object] = UNSET
    ...
    public_metadata: Union[Unset, "DeleteUserProfileImageResponse200PublicMetadata"] = UNSET
    private_metadata: Union["DeleteUserProfileImageResponse200PrivateMetadataType0", None, Unset] = UNSET
    unsafe_metadata: Union[Unset, "DeleteUserProfileImageResponse200UnsafeMetadata"] = UNSET
    email_addresses: Union[Unset, List["DeleteUserProfileImageResponse200EmailAddressesItem"]] = UNSET
    phone_numbers: Union[Unset, List["DeleteUserProfileImageResponse200PhoneNumbersItem"]] = UNSET
    web3_wallets: Union[Unset, List["DeleteUserProfileImageResponse200Web3WalletsItem"]] = UNSET
    passkeys: Union[Unset, List["DeleteUserProfileImageResponse200PasskeysItem"]] = UNSET
    ...
    external_accounts: Union[Unset, List["DeleteUserProfileImageResponse200ExternalAccountsItem"]] = UNSET
    saml_accounts: Union[Unset, List["DeleteUserProfileImageResponse200SamlAccountsItem"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.private_metadata, DeleteUserProfileImageResponse200PrivateMetadataType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, DeleteUserProfileImageResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = DeleteUserProfileImageResponse200Object(_object_)
        ...
        if isinstance(_public_metadata, Unset):
            ...
            public_metadata = DeleteUserProfileImageResponse200PublicMetadata.from_dict(_public_metadata)

        def _parse_private_metadata(
            data: object,
        ) -> Union["DeleteUserProfileImageResponse200PrivateMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                private_metadata_type_0 = DeleteUserProfileImageResponse200PrivateMetadataType0.from_dict(data)

                return private_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DeleteUserProfileImageResponse200PrivateMetadataType0", None, Unset], data)
        ...
        if isinstance(_unsafe_metadata, Unset):
            ...
            unsafe_metadata = DeleteUserProfileImageResponse200UnsafeMetadata.from_dict(_unsafe_metadata)

        email_addresses = []
        _email_addresses = d.pop("email_addresses", UNSET)
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = DeleteUserProfileImageResponse200EmailAddressesItem.from_dict(
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = DeleteUserProfileImageResponse200PhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        for web3_wallets_item_data in _web3_wallets or []:
            web3_wallets_item = DeleteUserProfileImageResponse200Web3WalletsItem.from_dict(web3_wallets_item_data)
        ...
        for passkeys_item_data in _passkeys or []:
            passkeys_item = DeleteUserProfileImageResponse200PasskeysItem.from_dict(passkeys_item_data)
        ...
        for external_accounts_item_data in _external_accounts or []:
            external_accounts_item = DeleteUserProfileImageResponse200ExternalAccountsItem.from_dict(
        ...
        for saml_accounts_item_data in _saml_accounts or []:
            saml_accounts_item = DeleteUserProfileImageResponse200SamlAccountsItem.from_dict(saml_accounts_item_data)
        ...
        delete_user_profile_image_response_200 = cls(
            id=id,
            object_=object_,
        ...
        return delete_user_profile_image_response_200
