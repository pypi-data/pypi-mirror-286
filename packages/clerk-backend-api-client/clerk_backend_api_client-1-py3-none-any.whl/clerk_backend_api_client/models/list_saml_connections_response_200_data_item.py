...
from ..models.list_saml_connections_response_200_data_item_object import ListSAMLConnectionsResponse200DataItemObject
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_saml_connections_response_200_data_item_attribute_mapping import (
        ListSAMLConnectionsResponse200DataItemAttributeMapping,
    )


T = TypeVar("T", bound="ListSAMLConnectionsResponse200DataItem")


@_attrs_define
class ListSAMLConnectionsResponse200DataItem:
    """
    Attributes:
        object_ (ListSAMLConnectionsResponse200DataItemObject):
        id (str):
        name (str):
        domain (str):
        ...
        attribute_mapping (Union[Unset, ListSAMLConnectionsResponse200DataItemAttributeMapping]):
    ...
    attribute_mapping: Union[Unset, "ListSAMLConnectionsResponse200DataItemAttributeMapping"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = ListSAMLConnectionsResponse200DataItemObject(d.pop("object"))
        ...
        if isinstance(_attribute_mapping, Unset):
            ...
            attribute_mapping = ListSAMLConnectionsResponse200DataItemAttributeMapping.from_dict(_attribute_mapping)

        allow_subdomains = d.pop("allow_subdomains", UNSET)

        allow_idp_initiated = d.pop("allow_idp_initiated", UNSET)

        list_saml_connections_response_200_data_item = cls(
            object_=object_,
            id=id,
            name=name,
            domain=domain,
        ...
        list_saml_connections_response_200_data_item.additional_properties = d
        return list_saml_connections_response_200_data_item
