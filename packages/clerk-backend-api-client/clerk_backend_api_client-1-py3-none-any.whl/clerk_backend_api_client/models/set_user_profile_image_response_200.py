...
from ..models.set_user_profile_image_response_200_object import SetUserProfileImageResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.set_user_profile_image_response_200_email_addresses_item import (
        SetUserProfileImageResponse200EmailAddressesItem,
    )
    from ..models.set_user_profile_image_response_200_external_accounts_item import (
        SetUserProfileImageResponse200ExternalAccountsItem,
    )
    from ..models.set_user_profile_image_response_200_passkeys_item import SetUserProfileImageResponse200PasskeysItem
    from ..models.set_user_profile_image_response_200_phone_numbers_item import (
        SetUserProfileImageResponse200PhoneNumbersItem,
    )
    from ..models.set_user_profile_image_response_200_private_metadata_type_0 import (
        SetUserProfileImageResponse200PrivateMetadataType0,
    )
    from ..models.set_user_profile_image_response_200_public_metadata import (
        SetUserProfileImageResponse200PublicMetadata,
    )
    from ..models.set_user_profile_image_response_200_saml_accounts_item import (
        SetUserProfileImageResponse200SamlAccountsItem,
    )
    from ..models.set_user_profile_image_response_200_unsafe_metadata import (
        SetUserProfileImageResponse200UnsafeMetadata,
    )
    from ..models.set_user_profile_image_response_200_web_3_wallets_item import (
        SetUserProfileImageResponse200Web3WalletsItem,
    )


T = TypeVar("T", bound="SetUserProfileImageResponse200")


@_attrs_define
class SetUserProfileImageResponse200:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, SetUserProfileImageResponse200Object]): String representing the object's type. Objects of
        ...
        public_metadata (Union[Unset, SetUserProfileImageResponse200PublicMetadata]):
        private_metadata (Union['SetUserProfileImageResponse200PrivateMetadataType0', None, Unset]):
        unsafe_metadata (Union[Unset, SetUserProfileImageResponse200UnsafeMetadata]):
        email_addresses (Union[Unset, List['SetUserProfileImageResponse200EmailAddressesItem']]):
        phone_numbers (Union[Unset, List['SetUserProfileImageResponse200PhoneNumbersItem']]):
        web3_wallets (Union[Unset, List['SetUserProfileImageResponse200Web3WalletsItem']]):
        passkeys (Union[Unset, List['SetUserProfileImageResponse200PasskeysItem']]):
        ...
        external_accounts (Union[Unset, List['SetUserProfileImageResponse200ExternalAccountsItem']]):
        saml_accounts (Union[Unset, List['SetUserProfileImageResponse200SamlAccountsItem']]):
    ...
    object_: Union[Unset, SetUserProfileImageResponse200Object] = UNSET
    ...
    public_metadata: Union[Unset, "SetUserProfileImageResponse200PublicMetadata"] = UNSET
    private_metadata: Union["SetUserProfileImageResponse200PrivateMetadataType0", None, Unset] = UNSET
    unsafe_metadata: Union[Unset, "SetUserProfileImageResponse200UnsafeMetadata"] = UNSET
    email_addresses: Union[Unset, List["SetUserProfileImageResponse200EmailAddressesItem"]] = UNSET
    phone_numbers: Union[Unset, List["SetUserProfileImageResponse200PhoneNumbersItem"]] = UNSET
    web3_wallets: Union[Unset, List["SetUserProfileImageResponse200Web3WalletsItem"]] = UNSET
    passkeys: Union[Unset, List["SetUserProfileImageResponse200PasskeysItem"]] = UNSET
    ...
    external_accounts: Union[Unset, List["SetUserProfileImageResponse200ExternalAccountsItem"]] = UNSET
    saml_accounts: Union[Unset, List["SetUserProfileImageResponse200SamlAccountsItem"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.private_metadata, SetUserProfileImageResponse200PrivateMetadataType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.set_user_profile_image_response_200_passkeys_item import (
        ...
        object_: Union[Unset, SetUserProfileImageResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = SetUserProfileImageResponse200Object(_object_)
        ...
        if isinstance(_public_metadata, Unset):
            ...
            public_metadata = SetUserProfileImageResponse200PublicMetadata.from_dict(_public_metadata)

        def _parse_private_metadata(
            data: object,
        ) -> Union["SetUserProfileImageResponse200PrivateMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                private_metadata_type_0 = SetUserProfileImageResponse200PrivateMetadataType0.from_dict(data)

                return private_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["SetUserProfileImageResponse200PrivateMetadataType0", None, Unset], data)
        ...
        if isinstance(_unsafe_metadata, Unset):
            ...
            unsafe_metadata = SetUserProfileImageResponse200UnsafeMetadata.from_dict(_unsafe_metadata)

        email_addresses = []
        _email_addresses = d.pop("email_addresses", UNSET)
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = SetUserProfileImageResponse200EmailAddressesItem.from_dict(email_addresses_item_data)
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = SetUserProfileImageResponse200PhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        for web3_wallets_item_data in _web3_wallets or []:
            web3_wallets_item = SetUserProfileImageResponse200Web3WalletsItem.from_dict(web3_wallets_item_data)
        ...
        for passkeys_item_data in _passkeys or []:
            passkeys_item = SetUserProfileImageResponse200PasskeysItem.from_dict(passkeys_item_data)
        ...
        for external_accounts_item_data in _external_accounts or []:
            external_accounts_item = SetUserProfileImageResponse200ExternalAccountsItem.from_dict(
        ...
        for saml_accounts_item_data in _saml_accounts or []:
            saml_accounts_item = SetUserProfileImageResponse200SamlAccountsItem.from_dict(saml_accounts_item_data)
        ...
        set_user_profile_image_response_200 = cls(
            id=id,
            object_=object_,
        ...
        return set_user_profile_image_response_200
