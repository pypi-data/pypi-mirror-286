...
from ..models.toggle_template_delivery_response_200_object import ToggleTemplateDeliveryResponse200Object
from ..types import UNSET, Unset

T = TypeVar("T", bound="ToggleTemplateDeliveryResponse200")


@_attrs_define
class ToggleTemplateDeliveryResponse200:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, ToggleTemplateDeliveryResponse200Object]): String representing the object's type. Objects
    ...
    object_: Union[Unset, ToggleTemplateDeliveryResponse200Object] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, ToggleTemplateDeliveryResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = ToggleTemplateDeliveryResponse200Object(_object_)
        ...
        toggle_template_delivery_response_200 = cls(
            id=id,
            object_=object_,
        ...
        return toggle_template_delivery_response_200
