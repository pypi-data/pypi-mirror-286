...
from ..models.get_client_response_200_object import GetClientResponse200Object

if TYPE_CHECKING:
    from ..models.get_client_response_200_sessions_item import GetClientResponse200SessionsItem
...
class GetClientResponse200:
    """
    Attributes:
        object_ (GetClientResponse200Object): String representing the object's type. Objects of the same type share the
            same value.
        id (str): String representing the identifier of the session.
        session_ids (List[str]):
        sessions (List['GetClientResponse200SessionsItem']):
    ...
    object_: GetClientResponse200Object
    id: str
    session_ids: List[str]
    sessions: List["GetClientResponse200SessionsItem"]
    sign_in_id: Union[None, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = GetClientResponse200Object(d.pop("object"))
        ...
        for sessions_item_data in _sessions:
            sessions_item = GetClientResponse200SessionsItem.from_dict(sessions_item_data)
