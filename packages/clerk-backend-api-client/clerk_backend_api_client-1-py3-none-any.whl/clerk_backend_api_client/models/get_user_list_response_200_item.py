...
from ..models.get_user_list_response_200_item_object import GetUserListResponse200ItemObject
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_user_list_response_200_item_email_addresses_item import (
        GetUserListResponse200ItemEmailAddressesItem,
    )
    from ..models.get_user_list_response_200_item_external_accounts_item import (
        GetUserListResponse200ItemExternalAccountsItem,
    )
    from ..models.get_user_list_response_200_item_passkeys_item import GetUserListResponse200ItemPasskeysItem
    from ..models.get_user_list_response_200_item_phone_numbers_item import GetUserListResponse200ItemPhoneNumbersItem
    from ..models.get_user_list_response_200_item_private_metadata_type_0 import (
        GetUserListResponse200ItemPrivateMetadataType0,
    )
    from ..models.get_user_list_response_200_item_public_metadata import GetUserListResponse200ItemPublicMetadata
    from ..models.get_user_list_response_200_item_saml_accounts_item import GetUserListResponse200ItemSamlAccountsItem
    from ..models.get_user_list_response_200_item_unsafe_metadata import GetUserListResponse200ItemUnsafeMetadata
    from ..models.get_user_list_response_200_item_web_3_wallets_item import GetUserListResponse200ItemWeb3WalletsItem


T = TypeVar("T", bound="GetUserListResponse200Item")


@_attrs_define
class GetUserListResponse200Item:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, GetUserListResponse200ItemObject]): String representing the object's type. Objects of the
        ...
        public_metadata (Union[Unset, GetUserListResponse200ItemPublicMetadata]):
        private_metadata (Union['GetUserListResponse200ItemPrivateMetadataType0', None, Unset]):
        unsafe_metadata (Union[Unset, GetUserListResponse200ItemUnsafeMetadata]):
        email_addresses (Union[Unset, List['GetUserListResponse200ItemEmailAddressesItem']]):
        phone_numbers (Union[Unset, List['GetUserListResponse200ItemPhoneNumbersItem']]):
        web3_wallets (Union[Unset, List['GetUserListResponse200ItemWeb3WalletsItem']]):
        passkeys (Union[Unset, List['GetUserListResponse200ItemPasskeysItem']]):
        ...
        external_accounts (Union[Unset, List['GetUserListResponse200ItemExternalAccountsItem']]):
        saml_accounts (Union[Unset, List['GetUserListResponse200ItemSamlAccountsItem']]):
    ...
    object_: Union[Unset, GetUserListResponse200ItemObject] = UNSET
    ...
    public_metadata: Union[Unset, "GetUserListResponse200ItemPublicMetadata"] = UNSET
    private_metadata: Union["GetUserListResponse200ItemPrivateMetadataType0", None, Unset] = UNSET
    unsafe_metadata: Union[Unset, "GetUserListResponse200ItemUnsafeMetadata"] = UNSET
    email_addresses: Union[Unset, List["GetUserListResponse200ItemEmailAddressesItem"]] = UNSET
    phone_numbers: Union[Unset, List["GetUserListResponse200ItemPhoneNumbersItem"]] = UNSET
    web3_wallets: Union[Unset, List["GetUserListResponse200ItemWeb3WalletsItem"]] = UNSET
    passkeys: Union[Unset, List["GetUserListResponse200ItemPasskeysItem"]] = UNSET
    ...
    external_accounts: Union[Unset, List["GetUserListResponse200ItemExternalAccountsItem"]] = UNSET
    saml_accounts: Union[Unset, List["GetUserListResponse200ItemSamlAccountsItem"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.private_metadata, GetUserListResponse200ItemPrivateMetadataType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.get_user_list_response_200_item_passkeys_item import GetUserListResponse200ItemPasskeysItem
        from ..models.get_user_list_response_200_item_phone_numbers_item import (
        ...
        from ..models.get_user_list_response_200_item_public_metadata import GetUserListResponse200ItemPublicMetadata
        from ..models.get_user_list_response_200_item_saml_accounts_item import (
            GetUserListResponse200ItemSamlAccountsItem,
        )
        from ..models.get_user_list_response_200_item_unsafe_metadata import GetUserListResponse200ItemUnsafeMetadata
        from ..models.get_user_list_response_200_item_web_3_wallets_item import (
        ...
        object_: Union[Unset, GetUserListResponse200ItemObject]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = GetUserListResponse200ItemObject(_object_)
        ...
        if isinstance(_public_metadata, Unset):
            ...
            public_metadata = GetUserListResponse200ItemPublicMetadata.from_dict(_public_metadata)

        def _parse_private_metadata(
            data: object,
        ) -> Union["GetUserListResponse200ItemPrivateMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                private_metadata_type_0 = GetUserListResponse200ItemPrivateMetadataType0.from_dict(data)

                return private_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetUserListResponse200ItemPrivateMetadataType0", None, Unset], data)
        ...
        if isinstance(_unsafe_metadata, Unset):
            ...
            unsafe_metadata = GetUserListResponse200ItemUnsafeMetadata.from_dict(_unsafe_metadata)

        email_addresses = []
        _email_addresses = d.pop("email_addresses", UNSET)
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = GetUserListResponse200ItemEmailAddressesItem.from_dict(email_addresses_item_data)
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = GetUserListResponse200ItemPhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        for web3_wallets_item_data in _web3_wallets or []:
            web3_wallets_item = GetUserListResponse200ItemWeb3WalletsItem.from_dict(web3_wallets_item_data)
        ...
        for passkeys_item_data in _passkeys or []:
            passkeys_item = GetUserListResponse200ItemPasskeysItem.from_dict(passkeys_item_data)
        ...
        for external_accounts_item_data in _external_accounts or []:
            external_accounts_item = GetUserListResponse200ItemExternalAccountsItem.from_dict(
        ...
        for saml_accounts_item_data in _saml_accounts or []:
            saml_accounts_item = GetUserListResponse200ItemSamlAccountsItem.from_dict(saml_accounts_item_data)
        ...
        get_user_list_response_200_item = cls(
            id=id,
            object_=object_,
        ...
        return get_user_list_response_200_item
