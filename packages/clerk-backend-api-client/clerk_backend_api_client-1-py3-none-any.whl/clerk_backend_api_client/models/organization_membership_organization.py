...
from ..models.organization_membership_organization_object import OrganizationMembershipOrganizationObject
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.organization_membership_organization_private_metadata import (
        OrganizationMembershipOrganizationPrivateMetadata,
    )
    from ..models.organization_membership_organization_public_metadata import (
        OrganizationMembershipOrganizationPublicMetadata,
    )


T = TypeVar("T", bound="OrganizationMembershipOrganization")
...
class OrganizationMembershipOrganization:
    """
    Attributes:
        object_ (OrganizationMembershipOrganizationObject):
        id (str):
        name (str):
        slug (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = OrganizationMembershipOrganizationObject(d.pop("object"))
        ...
        public_metadata = OrganizationMembershipOrganizationPublicMetadata.from_dict(d.pop("public_metadata"))

        private_metadata = OrganizationMembershipOrganizationPrivateMetadata.from_dict(d.pop("private_metadata"))
        ...
        organization_membership_organization = cls(
            object_=object_,
            id=id,
            name=name,
            slug=slug,
        ...
        organization_membership_organization.additional_properties = d
        return organization_membership_organization
