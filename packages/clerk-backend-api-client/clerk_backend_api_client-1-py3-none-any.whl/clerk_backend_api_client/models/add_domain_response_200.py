...
from ..models.add_domain_response_200_object import AddDomainResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.add_domain_response_200_cname_targets_type_0_item import AddDomainResponse200CnameTargetsType0Item


T = TypeVar("T", bound="AddDomainResponse200")


@_attrs_define
class AddDomainResponse200:
    """
    Attributes:
        object_ (AddDomainResponse200Object):
        id (str):
        name (str):
        is_satellite (bool):
        ...
        cname_targets (Union[List['AddDomainResponse200CnameTargetsType0Item'], None, Unset]):
    """
    ...
    cname_targets: Union[List["AddDomainResponse200CnameTargetsType0Item"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = AddDomainResponse200Object(d.pop("object"))
        ...
        def _parse_cname_targets(data: object) -> Union[List["AddDomainResponse200CnameTargetsType0Item"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for cname_targets_type_0_item_data in _cname_targets_type_0:
                    cname_targets_type_0_item = AddDomainResponse200CnameTargetsType0Item.from_dict(
                        cname_targets_type_0_item_data
                    )
                ...
                pass
            return cast(Union[List["AddDomainResponse200CnameTargetsType0Item"], None, Unset], data)

        cname_targets = _parse_cname_targets(d.pop("cname_targets", UNSET))

        add_domain_response_200 = cls(
            object_=object_,
            id=id,
            name=name,
            is_satellite=is_satellite,
        ...
        add_domain_response_200.additional_properties = d
        return add_domain_response_200
