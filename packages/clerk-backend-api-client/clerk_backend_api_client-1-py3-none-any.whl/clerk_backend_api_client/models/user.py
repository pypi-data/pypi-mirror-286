...
if TYPE_CHECKING:
    from ..models.user_email_addresses_item import UserEmailAddressesItem
    from ..models.user_external_accounts_item import UserExternalAccountsItem
    from ..models.user_passkeys_item import UserPasskeysItem
    from ..models.user_phone_numbers_item import UserPhoneNumbersItem
    ...
    from ..models.user_saml_accounts_item import UserSamlAccountsItem
    from ..models.user_unsafe_metadata import UserUnsafeMetadata
    from ..models.user_web_3_wallets_item import UserWeb3WalletsItem
...
class User:
    ...
    Attributes:
        ...
        email_addresses (Union[Unset, List['UserEmailAddressesItem']]):
        phone_numbers (Union[Unset, List['UserPhoneNumbersItem']]):
        web3_wallets (Union[Unset, List['UserWeb3WalletsItem']]):
        passkeys (Union[Unset, List['UserPasskeysItem']]):
        ...
        saml_accounts (Union[Unset, List['UserSamlAccountsItem']]):
    ...
    email_addresses: Union[Unset, List["UserEmailAddressesItem"]] = UNSET
    phone_numbers: Union[Unset, List["UserPhoneNumbersItem"]] = UNSET
    web3_wallets: Union[Unset, List["UserWeb3WalletsItem"]] = UNSET
    passkeys: Union[Unset, List["UserPasskeysItem"]] = UNSET
    ...
    saml_accounts: Union[Unset, List["UserSamlAccountsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = UserEmailAddressesItem.from_dict(email_addresses_item_data)
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = UserPhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        for web3_wallets_item_data in _web3_wallets or []:
            web3_wallets_item = UserWeb3WalletsItem.from_dict(web3_wallets_item_data)
        ...
        for passkeys_item_data in _passkeys or []:
            passkeys_item = UserPasskeysItem.from_dict(passkeys_item_data)
        ...
        for saml_accounts_item_data in _saml_accounts or []:
            saml_accounts_item = UserSamlAccountsItem.from_dict(saml_accounts_item_data)
