...
from ..models.update_domain_response_200_object import UpdateDomainResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_domain_response_200_cname_targets_type_0_item import (
...
class UpdateDomainResponse200:
    """
    Attributes:
        object_ (UpdateDomainResponse200Object):
        id (str):
        name (str):
        is_satellite (bool):
        ...
        cname_targets (Union[List['UpdateDomainResponse200CnameTargetsType0Item'], None, Unset]):
    """
    ...
    cname_targets: Union[List["UpdateDomainResponse200CnameTargetsType0Item"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = UpdateDomainResponse200Object(d.pop("object"))
        ...
        def _parse_cname_targets(
            data: object,
        ) -> Union[List["UpdateDomainResponse200CnameTargetsType0Item"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for cname_targets_type_0_item_data in _cname_targets_type_0:
                    cname_targets_type_0_item = UpdateDomainResponse200CnameTargetsType0Item.from_dict(
                ...
                pass
            return cast(Union[List["UpdateDomainResponse200CnameTargetsType0Item"], None, Unset], data)
