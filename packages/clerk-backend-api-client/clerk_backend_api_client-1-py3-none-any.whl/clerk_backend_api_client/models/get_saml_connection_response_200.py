...
from ..models.get_saml_connection_response_200_object import GetSAMLConnectionResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_saml_connection_response_200_attribute_mapping import GetSAMLConnectionResponse200AttributeMapping


T = TypeVar("T", bound="GetSAMLConnectionResponse200")


@_attrs_define
class GetSAMLConnectionResponse200:
    """
    Attributes:
        object_ (GetSAMLConnectionResponse200Object):
        id (str):
        name (str):
        domain (str):
        ...
        attribute_mapping (Union[Unset, GetSAMLConnectionResponse200AttributeMapping]):
    ...
    attribute_mapping: Union[Unset, "GetSAMLConnectionResponse200AttributeMapping"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_saml_connection_response_200_attribute_mapping import (
            GetSAMLConnectionResponse200AttributeMapping,
        )

        d = src_dict.copy()
        object_ = GetSAMLConnectionResponse200Object(d.pop("object"))
        ...
        if isinstance(_attribute_mapping, Unset):
            ...
            attribute_mapping = GetSAMLConnectionResponse200AttributeMapping.from_dict(_attribute_mapping)

        allow_subdomains = d.pop("allow_subdomains", UNSET)

        allow_idp_initiated = d.pop("allow_idp_initiated", UNSET)

        get_saml_connection_response_200 = cls(
            object_=object_,
            id=id,
            name=name,
            domain=domain,
        ...
        get_saml_connection_response_200.additional_properties = d
        return get_saml_connection_response_200
