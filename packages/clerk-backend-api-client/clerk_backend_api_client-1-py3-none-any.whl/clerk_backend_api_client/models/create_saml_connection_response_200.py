...
from ..models.create_saml_connection_response_200_object import CreateSAMLConnectionResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_saml_connection_response_200_attribute_mapping import (
        CreateSAMLConnectionResponse200AttributeMapping,
    )


T = TypeVar("T", bound="CreateSAMLConnectionResponse200")


@_attrs_define
class CreateSAMLConnectionResponse200:
    """
    Attributes:
        object_ (CreateSAMLConnectionResponse200Object):
        id (str):
        name (str):
        domain (str):
        ...
        attribute_mapping (Union[Unset, CreateSAMLConnectionResponse200AttributeMapping]):
    ...
    attribute_mapping: Union[Unset, "CreateSAMLConnectionResponse200AttributeMapping"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = CreateSAMLConnectionResponse200Object(d.pop("object"))
        ...
        if isinstance(_attribute_mapping, Unset):
            ...
            attribute_mapping = CreateSAMLConnectionResponse200AttributeMapping.from_dict(_attribute_mapping)

        allow_subdomains = d.pop("allow_subdomains", UNSET)

        allow_idp_initiated = d.pop("allow_idp_initiated", UNSET)

        create_saml_connection_response_200 = cls(
            object_=object_,
            id=id,
            name=name,
            domain=domain,
        ...
        create_saml_connection_response_200.additional_properties = d
        return create_saml_connection_response_200
