...
T = TypeVar("T", bound="UsersGetOrganizationMembershipsResponse200DataItemPublicUserData")


@_attrs_define
class UsersGetOrganizationMembershipsResponse200DataItemPublicUserData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_get_organization_memberships_response_200_data_item_public_user_data = cls(
            user_id=user_id,
        ...
        return users_get_organization_memberships_response_200_data_item_public_user_data
