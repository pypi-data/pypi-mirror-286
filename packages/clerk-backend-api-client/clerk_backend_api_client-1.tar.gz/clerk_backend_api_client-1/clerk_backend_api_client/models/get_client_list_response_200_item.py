...
from ..models.get_client_list_response_200_item_object import GetClientListResponse200ItemObject

if TYPE_CHECKING:
    from ..models.get_client_list_response_200_item_sessions_item import GetClientListResponse200ItemSessionsItem


T = TypeVar("T", bound="GetClientListResponse200Item")


@_attrs_define
class GetClientListResponse200Item:
    """
    Attributes:
        object_ (GetClientListResponse200ItemObject): String representing the object's type. Objects of the same type
            share the same value.
        id (str): String representing the identifier of the session.
        session_ids (List[str]):
        sessions (List['GetClientListResponse200ItemSessionsItem']):
    ...
    object_: GetClientListResponse200ItemObject
    id: str
    session_ids: List[str]
    sessions: List["GetClientListResponse200ItemSessionsItem"]
    sign_in_id: Union[None, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = GetClientListResponse200ItemObject(d.pop("object"))
        ...
        for sessions_item_data in _sessions:
            sessions_item = GetClientListResponse200ItemSessionsItem.from_dict(sessions_item_data)
        ...
        get_client_list_response_200_item = cls(
            object_=object_,
            id=id,
            session_ids=session_ids,
            sessions=sessions,
        ...
        return get_client_list_response_200_item
