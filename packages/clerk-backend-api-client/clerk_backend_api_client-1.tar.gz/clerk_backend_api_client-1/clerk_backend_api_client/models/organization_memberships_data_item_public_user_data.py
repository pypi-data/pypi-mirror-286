...
T = TypeVar("T", bound="OrganizationMembershipsDataItemPublicUserData")


@_attrs_define
class OrganizationMembershipsDataItemPublicUserData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        organization_memberships_data_item_public_user_data = cls(
            user_id=user_id,
        ...
        return organization_memberships_data_item_public_user_data
