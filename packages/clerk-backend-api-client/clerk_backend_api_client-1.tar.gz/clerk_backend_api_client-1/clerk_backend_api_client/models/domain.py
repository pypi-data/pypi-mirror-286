...
if TYPE_CHECKING:
    from ..models.domain_cname_targets_type_0_item import DomainCnameTargetsType0Item
...
class Domain:
    ...
    Attributes:
        ...
        cname_targets (Union[List['DomainCnameTargetsType0Item'], None, Unset]):
    """
    ...
    cname_targets: Union[List["DomainCnameTargetsType0Item"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_cname_targets(data: object) -> Union[List["DomainCnameTargetsType0Item"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for cname_targets_type_0_item_data in _cname_targets_type_0:
                    cname_targets_type_0_item = DomainCnameTargetsType0Item.from_dict(cname_targets_type_0_item_data)
                ...
                pass
            return cast(Union[List["DomainCnameTargetsType0Item"], None, Unset], data)
