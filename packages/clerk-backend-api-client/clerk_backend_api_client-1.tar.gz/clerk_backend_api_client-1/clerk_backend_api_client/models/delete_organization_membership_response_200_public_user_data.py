...
T = TypeVar("T", bound="DeleteOrganizationMembershipResponse200PublicUserData")


@_attrs_define
class DeleteOrganizationMembershipResponse200PublicUserData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_organization_membership_response_200_public_user_data = cls(
            user_id=user_id,
        ...
        return delete_organization_membership_response_200_public_user_data
