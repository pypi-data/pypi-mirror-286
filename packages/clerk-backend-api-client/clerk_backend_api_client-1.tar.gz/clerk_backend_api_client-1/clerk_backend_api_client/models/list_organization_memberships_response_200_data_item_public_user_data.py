...
T = TypeVar("T", bound="ListOrganizationMembershipsResponse200DataItemPublicUserData")


@_attrs_define
class ListOrganizationMembershipsResponse200DataItemPublicUserData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_organization_memberships_response_200_data_item_public_user_data = cls(
            user_id=user_id,
        ...
        return list_organization_memberships_response_200_data_item_public_user_data
