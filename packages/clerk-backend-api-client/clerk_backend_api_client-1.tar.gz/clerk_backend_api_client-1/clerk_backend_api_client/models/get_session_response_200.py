...
from ..models.get_session_response_200_object import GetSessionResponse200Object
from ..models.get_session_response_200_status import GetSessionResponse200Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_session_response_200_actor_type_0 import GetSessionResponse200ActorType0
...
class GetSessionResponse200:
    """
    Attributes:
        object_ (GetSessionResponse200Object): String representing the object's type. Objects of the same type share the
            same value.
        id (str):
        user_id (str):
        client_id (str):
        status (GetSessionResponse200Status):
        last_active_at (int):
        expire_at (int):
        abandon_at (int):
        updated_at (int): Unix timestamp of last update.
        created_at (int): Unix timestamp of creation.
        actor (Union['GetSessionResponse200ActorType0', None, Unset]):
        last_active_organization_id (Union[None, Unset, str]):
    """

    object_: GetSessionResponse200Object
    id: str
    user_id: str
    client_id: str
    status: GetSessionResponse200Status
    ...
    updated_at: int
    created_at: int
    actor: Union["GetSessionResponse200ActorType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.actor, Unset):
            actor = UNSET
        elif isinstance(self.actor, GetSessionResponse200ActorType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = GetSessionResponse200Object(d.pop("object"))
        ...
        status = GetSessionResponse200Status(d.pop("status"))
        ...
        def _parse_actor(data: object) -> Union["GetSessionResponse200ActorType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                actor_type_0 = GetSessionResponse200ActorType0.from_dict(data)

                return actor_type_0
            except:  # noqa: E722
                pass
            return cast(Union["GetSessionResponse200ActorType0", None, Unset], data)
