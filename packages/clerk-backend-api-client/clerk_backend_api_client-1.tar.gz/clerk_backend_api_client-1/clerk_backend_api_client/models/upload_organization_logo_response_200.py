...
from ..models.upload_organization_logo_response_200_object import UploadOrganizationLogoResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.upload_organization_logo_response_200_private_metadata import (
        UploadOrganizationLogoResponse200PrivateMetadata,
    )
    from ..models.upload_organization_logo_response_200_public_metadata import (
        UploadOrganizationLogoResponse200PublicMetadata,
    )


T = TypeVar("T", bound="UploadOrganizationLogoResponse200")


@_attrs_define
class UploadOrganizationLogoResponse200:
    """
    Attributes:
        object_ (UploadOrganizationLogoResponse200Object):
        id (str):
        name (str):
        slug (str):
        max_allowed_memberships (int):
        public_metadata (UploadOrganizationLogoResponse200PublicMetadata):
        private_metadata (UploadOrganizationLogoResponse200PrivateMetadata):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = UploadOrganizationLogoResponse200Object(d.pop("object"))
        ...
        public_metadata = UploadOrganizationLogoResponse200PublicMetadata.from_dict(d.pop("public_metadata"))

        private_metadata = UploadOrganizationLogoResponse200PrivateMetadata.from_dict(d.pop("private_metadata"))
        ...
        upload_organization_logo_response_200 = cls(
            object_=object_,
            id=id,
            name=name,
            slug=slug,
        ...
        upload_organization_logo_response_200.additional_properties = d
        return upload_organization_logo_response_200
