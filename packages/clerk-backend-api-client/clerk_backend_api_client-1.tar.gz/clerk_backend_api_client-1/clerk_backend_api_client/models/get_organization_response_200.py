...
from ..models.get_organization_response_200_object import GetOrganizationResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_organization_response_200_private_metadata import GetOrganizationResponse200PrivateMetadata
    from ..models.get_organization_response_200_public_metadata import GetOrganizationResponse200PublicMetadata
...
class GetOrganizationResponse200:
    """
    Attributes:
        object_ (GetOrganizationResponse200Object):
        id (str):
        name (str):
        slug (str):
        max_allowed_memberships (int):
        public_metadata (GetOrganizationResponse200PublicMetadata):
        private_metadata (GetOrganizationResponse200PrivateMetadata):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = GetOrganizationResponse200Object(d.pop("object"))
        ...
        public_metadata = GetOrganizationResponse200PublicMetadata.from_dict(d.pop("public_metadata"))

        private_metadata = GetOrganizationResponse200PrivateMetadata.from_dict(d.pop("private_metadata"))
