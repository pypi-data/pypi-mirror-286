...
if TYPE_CHECKING:
    from ..models.organization_membership_organization import OrganizationMembershipOrganization
...
class OrganizationMembership:
    ...
    Attributes:
        ...
        organization (Union[Unset, OrganizationMembershipOrganization]):
    ...
    organization: Union[Unset, "OrganizationMembershipOrganization"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_organization, Unset):
            ...
            organization = OrganizationMembershipOrganization.from_dict(_organization)
