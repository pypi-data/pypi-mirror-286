...
from ..models.update_user_response_200_object import UpdateUserResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_user_response_200_email_addresses_item import UpdateUserResponse200EmailAddressesItem
    from ..models.update_user_response_200_external_accounts_item import UpdateUserResponse200ExternalAccountsItem
    from ..models.update_user_response_200_passkeys_item import UpdateUserResponse200PasskeysItem
    from ..models.update_user_response_200_phone_numbers_item import UpdateUserResponse200PhoneNumbersItem
    from ..models.update_user_response_200_private_metadata_type_0 import UpdateUserResponse200PrivateMetadataType0
    from ..models.update_user_response_200_public_metadata import UpdateUserResponse200PublicMetadata
    from ..models.update_user_response_200_saml_accounts_item import UpdateUserResponse200SamlAccountsItem
    from ..models.update_user_response_200_unsafe_metadata import UpdateUserResponse200UnsafeMetadata
    from ..models.update_user_response_200_web_3_wallets_item import UpdateUserResponse200Web3WalletsItem
...
class UpdateUserResponse200:
    ...
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, UpdateUserResponse200Object]): String representing the object's type. Objects of the same
        ...
        public_metadata (Union[Unset, UpdateUserResponse200PublicMetadata]):
        private_metadata (Union['UpdateUserResponse200PrivateMetadataType0', None, Unset]):
        unsafe_metadata (Union[Unset, UpdateUserResponse200UnsafeMetadata]):
        email_addresses (Union[Unset, List['UpdateUserResponse200EmailAddressesItem']]):
        phone_numbers (Union[Unset, List['UpdateUserResponse200PhoneNumbersItem']]):
        web3_wallets (Union[Unset, List['UpdateUserResponse200Web3WalletsItem']]):
        passkeys (Union[Unset, List['UpdateUserResponse200PasskeysItem']]):
        ...
        external_accounts (Union[Unset, List['UpdateUserResponse200ExternalAccountsItem']]):
        saml_accounts (Union[Unset, List['UpdateUserResponse200SamlAccountsItem']]):
    ...
    object_: Union[Unset, UpdateUserResponse200Object] = UNSET
    ...
    public_metadata: Union[Unset, "UpdateUserResponse200PublicMetadata"] = UNSET
    private_metadata: Union["UpdateUserResponse200PrivateMetadataType0", None, Unset] = UNSET
    unsafe_metadata: Union[Unset, "UpdateUserResponse200UnsafeMetadata"] = UNSET
    email_addresses: Union[Unset, List["UpdateUserResponse200EmailAddressesItem"]] = UNSET
    phone_numbers: Union[Unset, List["UpdateUserResponse200PhoneNumbersItem"]] = UNSET
    web3_wallets: Union[Unset, List["UpdateUserResponse200Web3WalletsItem"]] = UNSET
    passkeys: Union[Unset, List["UpdateUserResponse200PasskeysItem"]] = UNSET
    ...
    external_accounts: Union[Unset, List["UpdateUserResponse200ExternalAccountsItem"]] = UNSET
    saml_accounts: Union[Unset, List["UpdateUserResponse200SamlAccountsItem"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.private_metadata, UpdateUserResponse200PrivateMetadataType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, UpdateUserResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = UpdateUserResponse200Object(_object_)
        ...
        if isinstance(_public_metadata, Unset):
            ...
            public_metadata = UpdateUserResponse200PublicMetadata.from_dict(_public_metadata)

        def _parse_private_metadata(data: object) -> Union["UpdateUserResponse200PrivateMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                private_metadata_type_0 = UpdateUserResponse200PrivateMetadataType0.from_dict(data)

                return private_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UpdateUserResponse200PrivateMetadataType0", None, Unset], data)
        ...
        if isinstance(_unsafe_metadata, Unset):
            ...
            unsafe_metadata = UpdateUserResponse200UnsafeMetadata.from_dict(_unsafe_metadata)

        email_addresses = []
        _email_addresses = d.pop("email_addresses", UNSET)
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = UpdateUserResponse200EmailAddressesItem.from_dict(email_addresses_item_data)
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = UpdateUserResponse200PhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        for web3_wallets_item_data in _web3_wallets or []:
            web3_wallets_item = UpdateUserResponse200Web3WalletsItem.from_dict(web3_wallets_item_data)
        ...
        for passkeys_item_data in _passkeys or []:
            passkeys_item = UpdateUserResponse200PasskeysItem.from_dict(passkeys_item_data)
        ...
        for external_accounts_item_data in _external_accounts or []:
            external_accounts_item = UpdateUserResponse200ExternalAccountsItem.from_dict(external_accounts_item_data)
        ...
        for saml_accounts_item_data in _saml_accounts or []:
            saml_accounts_item = UpdateUserResponse200SamlAccountsItem.from_dict(saml_accounts_item_data)
