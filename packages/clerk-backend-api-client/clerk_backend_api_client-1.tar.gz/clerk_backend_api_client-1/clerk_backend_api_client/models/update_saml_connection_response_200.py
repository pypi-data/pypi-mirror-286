...
from ..models.update_saml_connection_response_200_object import UpdateSAMLConnectionResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_saml_connection_response_200_attribute_mapping import (
        UpdateSAMLConnectionResponse200AttributeMapping,
    )


T = TypeVar("T", bound="UpdateSAMLConnectionResponse200")


@_attrs_define
class UpdateSAMLConnectionResponse200:
    """
    Attributes:
        object_ (UpdateSAMLConnectionResponse200Object):
        id (str):
        name (str):
        domain (str):
        ...
        attribute_mapping (Union[Unset, UpdateSAMLConnectionResponse200AttributeMapping]):
    ...
    attribute_mapping: Union[Unset, "UpdateSAMLConnectionResponse200AttributeMapping"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = UpdateSAMLConnectionResponse200Object(d.pop("object"))
        ...
        if isinstance(_attribute_mapping, Unset):
            ...
            attribute_mapping = UpdateSAMLConnectionResponse200AttributeMapping.from_dict(_attribute_mapping)

        allow_subdomains = d.pop("allow_subdomains", UNSET)

        allow_idp_initiated = d.pop("allow_idp_initiated", UNSET)

        update_saml_connection_response_200 = cls(
            object_=object_,
            id=id,
            name=name,
            domain=domain,
        ...
        update_saml_connection_response_200.additional_properties = d
        return update_saml_connection_response_200
