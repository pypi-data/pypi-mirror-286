...
from ..models.update_organization_response_200_object import UpdateOrganizationResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_organization_response_200_private_metadata import UpdateOrganizationResponse200PrivateMetadata
    from ..models.update_organization_response_200_public_metadata import UpdateOrganizationResponse200PublicMetadata
...
class UpdateOrganizationResponse200:
    """
    Attributes:
        object_ (UpdateOrganizationResponse200Object):
        id (str):
        name (str):
        slug (str):
        max_allowed_memberships (int):
        public_metadata (UpdateOrganizationResponse200PublicMetadata):
        private_metadata (UpdateOrganizationResponse200PrivateMetadata):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.update_organization_response_200_private_metadata import (
            UpdateOrganizationResponse200PrivateMetadata,
        )
        from ..models.update_organization_response_200_public_metadata import (
            UpdateOrganizationResponse200PublicMetadata,
        )

        d = src_dict.copy()
        object_ = UpdateOrganizationResponse200Object(d.pop("object"))
        ...
        public_metadata = UpdateOrganizationResponse200PublicMetadata.from_dict(d.pop("public_metadata"))

        private_metadata = UpdateOrganizationResponse200PrivateMetadata.from_dict(d.pop("private_metadata"))
