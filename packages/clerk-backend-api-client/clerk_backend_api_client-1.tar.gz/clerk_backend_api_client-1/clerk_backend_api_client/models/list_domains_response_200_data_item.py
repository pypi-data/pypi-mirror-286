...
from ..models.list_domains_response_200_data_item_object import ListDomainsResponse200DataItemObject
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_domains_response_200_data_item_cname_targets_type_0_item import (
...
class ListDomainsResponse200DataItem:
    """
    Attributes:
        object_ (ListDomainsResponse200DataItemObject):
        id (str):
        name (str):
        is_satellite (bool):
        ...
        cname_targets (Union[List['ListDomainsResponse200DataItemCnameTargetsType0Item'], None, Unset]):
    """
    ...
    cname_targets: Union[List["ListDomainsResponse200DataItemCnameTargetsType0Item"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_ = ListDomainsResponse200DataItemObject(d.pop("object"))
        ...
        def _parse_cname_targets(
            data: object,
        ) -> Union[List["ListDomainsResponse200DataItemCnameTargetsType0Item"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for cname_targets_type_0_item_data in _cname_targets_type_0:
                    cname_targets_type_0_item = ListDomainsResponse200DataItemCnameTargetsType0Item.from_dict(
                ...
                pass
            return cast(Union[List["ListDomainsResponse200DataItemCnameTargetsType0Item"], None, Unset], data)
