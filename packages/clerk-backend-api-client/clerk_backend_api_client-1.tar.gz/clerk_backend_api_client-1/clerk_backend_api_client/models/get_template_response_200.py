...
from ..models.get_template_response_200_object import GetTemplateResponse200Object
...
class GetTemplateResponse200:
    ...
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, GetTemplateResponse200Object]): String representing the object's type. Objects of the same
    ...
    object_: Union[Unset, GetTemplateResponse200Object] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, GetTemplateResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = GetTemplateResponse200Object(_object_)
