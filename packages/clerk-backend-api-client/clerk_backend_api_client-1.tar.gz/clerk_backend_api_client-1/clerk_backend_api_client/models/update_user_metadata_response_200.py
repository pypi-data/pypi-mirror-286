...
from ..models.update_user_metadata_response_200_object import UpdateUserMetadataResponse200Object
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_user_metadata_response_200_email_addresses_item import (
        UpdateUserMetadataResponse200EmailAddressesItem,
    )
    from ..models.update_user_metadata_response_200_external_accounts_item import (
        UpdateUserMetadataResponse200ExternalAccountsItem,
    )
    from ..models.update_user_metadata_response_200_passkeys_item import UpdateUserMetadataResponse200PasskeysItem
    from ..models.update_user_metadata_response_200_phone_numbers_item import (
        UpdateUserMetadataResponse200PhoneNumbersItem,
    )
    from ..models.update_user_metadata_response_200_private_metadata_type_0 import (
        UpdateUserMetadataResponse200PrivateMetadataType0,
    )
    from ..models.update_user_metadata_response_200_public_metadata import UpdateUserMetadataResponse200PublicMetadata
    from ..models.update_user_metadata_response_200_saml_accounts_item import (
        UpdateUserMetadataResponse200SamlAccountsItem,
    )
    from ..models.update_user_metadata_response_200_unsafe_metadata import UpdateUserMetadataResponse200UnsafeMetadata
    from ..models.update_user_metadata_response_200_web_3_wallets_item import (
        UpdateUserMetadataResponse200Web3WalletsItem,
    )


T = TypeVar("T", bound="UpdateUserMetadataResponse200")


@_attrs_define
class UpdateUserMetadataResponse200:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, UpdateUserMetadataResponse200Object]): String representing the object's type. Objects of
        ...
        public_metadata (Union[Unset, UpdateUserMetadataResponse200PublicMetadata]):
        private_metadata (Union['UpdateUserMetadataResponse200PrivateMetadataType0', None, Unset]):
        unsafe_metadata (Union[Unset, UpdateUserMetadataResponse200UnsafeMetadata]):
        email_addresses (Union[Unset, List['UpdateUserMetadataResponse200EmailAddressesItem']]):
        phone_numbers (Union[Unset, List['UpdateUserMetadataResponse200PhoneNumbersItem']]):
        web3_wallets (Union[Unset, List['UpdateUserMetadataResponse200Web3WalletsItem']]):
        passkeys (Union[Unset, List['UpdateUserMetadataResponse200PasskeysItem']]):
        ...
        external_accounts (Union[Unset, List['UpdateUserMetadataResponse200ExternalAccountsItem']]):
        saml_accounts (Union[Unset, List['UpdateUserMetadataResponse200SamlAccountsItem']]):
    ...
    object_: Union[Unset, UpdateUserMetadataResponse200Object] = UNSET
    ...
    public_metadata: Union[Unset, "UpdateUserMetadataResponse200PublicMetadata"] = UNSET
    private_metadata: Union["UpdateUserMetadataResponse200PrivateMetadataType0", None, Unset] = UNSET
    unsafe_metadata: Union[Unset, "UpdateUserMetadataResponse200UnsafeMetadata"] = UNSET
    email_addresses: Union[Unset, List["UpdateUserMetadataResponse200EmailAddressesItem"]] = UNSET
    phone_numbers: Union[Unset, List["UpdateUserMetadataResponse200PhoneNumbersItem"]] = UNSET
    web3_wallets: Union[Unset, List["UpdateUserMetadataResponse200Web3WalletsItem"]] = UNSET
    passkeys: Union[Unset, List["UpdateUserMetadataResponse200PasskeysItem"]] = UNSET
    ...
    external_accounts: Union[Unset, List["UpdateUserMetadataResponse200ExternalAccountsItem"]] = UNSET
    saml_accounts: Union[Unset, List["UpdateUserMetadataResponse200SamlAccountsItem"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.private_metadata, UpdateUserMetadataResponse200PrivateMetadataType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.update_user_metadata_response_200_public_metadata import (
            UpdateUserMetadataResponse200PublicMetadata,
        )
        from ..models.update_user_metadata_response_200_saml_accounts_item import (
            UpdateUserMetadataResponse200SamlAccountsItem,
        )
        from ..models.update_user_metadata_response_200_unsafe_metadata import (
        ...
        object_: Union[Unset, UpdateUserMetadataResponse200Object]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = UpdateUserMetadataResponse200Object(_object_)
        ...
        if isinstance(_public_metadata, Unset):
            ...
            public_metadata = UpdateUserMetadataResponse200PublicMetadata.from_dict(_public_metadata)

        def _parse_private_metadata(
            data: object,
        ) -> Union["UpdateUserMetadataResponse200PrivateMetadataType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                private_metadata_type_0 = UpdateUserMetadataResponse200PrivateMetadataType0.from_dict(data)

                return private_metadata_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UpdateUserMetadataResponse200PrivateMetadataType0", None, Unset], data)
        ...
        if isinstance(_unsafe_metadata, Unset):
            ...
            unsafe_metadata = UpdateUserMetadataResponse200UnsafeMetadata.from_dict(_unsafe_metadata)

        email_addresses = []
        _email_addresses = d.pop("email_addresses", UNSET)
        for email_addresses_item_data in _email_addresses or []:
            email_addresses_item = UpdateUserMetadataResponse200EmailAddressesItem.from_dict(email_addresses_item_data)
        ...
        for phone_numbers_item_data in _phone_numbers or []:
            phone_numbers_item = UpdateUserMetadataResponse200PhoneNumbersItem.from_dict(phone_numbers_item_data)
        ...
        for web3_wallets_item_data in _web3_wallets or []:
            web3_wallets_item = UpdateUserMetadataResponse200Web3WalletsItem.from_dict(web3_wallets_item_data)
        ...
        for passkeys_item_data in _passkeys or []:
            passkeys_item = UpdateUserMetadataResponse200PasskeysItem.from_dict(passkeys_item_data)
        ...
        for external_accounts_item_data in _external_accounts or []:
            external_accounts_item = UpdateUserMetadataResponse200ExternalAccountsItem.from_dict(
                external_accounts_item_data
            )
        ...
        for saml_accounts_item_data in _saml_accounts or []:
            saml_accounts_item = UpdateUserMetadataResponse200SamlAccountsItem.from_dict(saml_accounts_item_data)
        ...
        update_user_metadata_response_200 = cls(
            id=id,
            object_=object_,
        ...
        return update_user_metadata_response_200
