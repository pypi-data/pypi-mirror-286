...
if TYPE_CHECKING:
    from ..models.oauth_error_type_0 import OauthErrorType0
    from ..models.oauth_error_type_1_type_0 import OauthErrorType1Type0
    from ..models.oauth_error_type_2_type_0 import OauthErrorType2Type0
...
class Oauth:
    ...
    Attributes:
        ...
        error (Union['OauthErrorType0', 'OauthErrorType1Type0', 'OauthErrorType2Type0', Unset]):
    ...
    error: Union["OauthErrorType0", "OauthErrorType1Type0", "OauthErrorType2Type0", Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.error, Unset):
            error = UNSET
        elif isinstance(self.error, OauthErrorType0):
            error = self.error.to_dict()
        elif isinstance(self.error, OauthErrorType1Type0):
            error = self.error.to_dict()
        else:
            error = self.error.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_error(
            data: object,
        ) -> Union["OauthErrorType0", "OauthErrorType1Type0", "OauthErrorType2Type0", Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                error_type_0 = OauthErrorType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                error_type_1_type_0 = OauthErrorType1Type0.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            error_type_2_type_0 = OauthErrorType2Type0.from_dict(data)
