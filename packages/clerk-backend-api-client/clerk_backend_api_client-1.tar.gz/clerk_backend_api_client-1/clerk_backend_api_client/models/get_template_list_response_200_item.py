...
from ..models.get_template_list_response_200_item_object import GetTemplateListResponse200ItemObject
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetTemplateListResponse200Item")


@_attrs_define
class GetTemplateListResponse200Item:
    """
    Attributes:
        id (Union[Unset, str]):
        object_ (Union[Unset, GetTemplateListResponse200ItemObject]): String representing the object's type. Objects of
    ...
    object_: Union[Unset, GetTemplateListResponse200ItemObject] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_: Union[Unset, GetTemplateListResponse200ItemObject]
        if isinstance(_object_, Unset):
            object_ = UNSET
        else:
            object_ = GetTemplateListResponse200ItemObject(_object_)
        ...
        get_template_list_response_200_item = cls(
            id=id,
            object_=object_,
        ...
        return get_template_list_response_200_item
