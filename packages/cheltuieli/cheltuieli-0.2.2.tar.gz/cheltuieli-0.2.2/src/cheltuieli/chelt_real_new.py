...
from cheltuieli.chelt_plan import CheltuieliReale
...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.app = CheltuieliReale(ini_file)
        ...
        self.myAccountsTable = self.app.myAccountsTable
        self.myContos = self.app.myContos
        self.expensesTableReal = self.app.expensesTableReal
