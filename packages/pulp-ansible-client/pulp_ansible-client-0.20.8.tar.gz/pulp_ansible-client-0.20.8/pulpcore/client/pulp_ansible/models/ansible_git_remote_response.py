...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, headers=None, rate_limit=None, max_retries=None, url=None, connect_timeout=None, ca_cert=None, tls_validation=None, pulp_labels=None, pulp_last_updated=None, hidden_fields=None, proxy_url=None, sock_read_timeout=None, name=None, pulp_href=None, total_timeout=None, sock_connect_timeout=None, pulp_created=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
