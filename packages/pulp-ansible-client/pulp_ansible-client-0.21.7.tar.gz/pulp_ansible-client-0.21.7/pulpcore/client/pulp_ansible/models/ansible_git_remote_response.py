...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, name=None, pulp_created=None, url=None, pulp_labels=None, sock_connect_timeout=None, pulp_href=None, tls_validation=None, download_concurrency=None, sock_read_timeout=None, client_cert=None, max_retries=None, connect_timeout=None, pulp_last_updated=None, ca_cert=None, rate_limit=None, hidden_fields=None, total_timeout=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
