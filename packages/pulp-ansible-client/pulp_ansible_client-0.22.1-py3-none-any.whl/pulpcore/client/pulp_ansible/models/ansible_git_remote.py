...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, connect_timeout=None, sock_connect_timeout=None, password=None, tls_validation=None, proxy_url=None, sock_read_timeout=None, proxy_username=None, name=None, url=None, rate_limit=None, client_cert=None, username=None, ca_cert=None, total_timeout=None, download_concurrency=None, proxy_password=None, pulp_labels=None, headers=None, client_key=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
