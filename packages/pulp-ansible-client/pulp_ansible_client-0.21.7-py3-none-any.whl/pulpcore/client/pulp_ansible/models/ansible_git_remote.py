...
class AnsibleGitRemote(object):
    ...
    def __init__(self, password=None, proxy_url=None, client_key=None, name=None, proxy_username=None, url=None, pulp_labels=None, sock_connect_timeout=None, tls_validation=None, download_concurrency=None, sock_read_timeout=None, client_cert=None, max_retries=None, connect_timeout=None, ca_cert=None, rate_limit=None, username=None, proxy_password=None, total_timeout=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
