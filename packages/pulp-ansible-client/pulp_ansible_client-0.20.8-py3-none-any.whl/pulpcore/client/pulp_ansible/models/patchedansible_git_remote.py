...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, headers=None, rate_limit=None, proxy_username=None, max_retries=None, url=None, connect_timeout=None, ca_cert=None, tls_validation=None, client_key=None, proxy_password=None, pulp_labels=None, username=None, proxy_url=None, password=None, sock_read_timeout=None, name=None, total_timeout=None, sock_connect_timeout=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
