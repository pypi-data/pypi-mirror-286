...
class AnsibleRoleResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, pulp_last_updated=None, artifact=None, version=None, name=None, namespace=None, local_vars_configuration=None):  # noqa: E501
