...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, connect_timeout=None, sock_connect_timeout=None, pulp_href=None, tls_validation=None, proxy_url=None, sock_read_timeout=None, name=None, url=None, rate_limit=None, client_cert=None, ca_cert=None, total_timeout=None, pulp_created=None, download_concurrency=None, pulp_labels=None, headers=None, hidden_fields=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
