...
EXTRACTION_PROMPT = """Output the entire extracted contents from the document in detailed markdown format.
...
DEFAULT_VLM = "anthropic/claude-3-haiku"
...
def process_pdf_page(page_text: str, image: Image.Image, file_path: str) -> Dict[str, List]:
    ...
    messages = [
        {
            ...
            "content": [
                ...
                {"type": "text", "text": f"<Doc>{page_text}</Doc>"},
    ...
    return {"texts": [llm_response], "figures": [image]}
        ...
        with open(file_path, "rb") as f:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                for text, image in zip(texts, images):
                    future = executor.submit(process_pdf_page, text, image, file_path)
