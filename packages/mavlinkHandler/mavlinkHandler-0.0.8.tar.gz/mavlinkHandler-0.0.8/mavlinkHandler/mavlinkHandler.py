...
class MAVLinkHandlerDronekit:
    ...
    def simple_go_to(self, lat, lon, alt, block=False, distance_radius=self.DISTANCE_RADIUS):
...
class MAVLinkHandlerPymavlink:
    ...
    def simple_goto(self, lat , lon, alt, block=False, distance_radius=self.DISTANCE_RADIUS):
