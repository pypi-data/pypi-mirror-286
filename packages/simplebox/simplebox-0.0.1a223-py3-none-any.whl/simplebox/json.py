...
"""
This module just wraps the orjson module and set params by JsonConfig(global config). 
For all usages, please refer to the orjson module.
...
def dump(obj, fp: IO[bytes or str], encoding="UTF-8", *, default=None, newline: bool = None, indent2: bool = None,
         naive_utc: bool = None,
         omit_microseconds: bool = None, passthrough_dataclass: bool = None, passthrough_datetime: bool = None,
         passthrough_subclass: bool = None, serialize_dataclass: bool = None, serialize_numpy: bool = None,
         serialize_uuid: bool = None, sort_keys: bool = None, strict_integer: bool = None, utc_z: bool = None) -> None:
    ...
    data = _inner_dumps(obj, default=default, newline=newline, indent2=indent2, naive_utc=naive_utc,
                        omit_microseconds=omit_microseconds,
...
def dumps(obj, *, default=None, encoding="UTF-8", newline: bool = None, indent2: bool = None, naive_utc: bool = None,
          omit_microseconds: bool = None, passthrough_dataclass: bool = None, passthrough_datetime: bool = None,
          passthrough_subclass: bool = None, serialize_dataclass: bool = None, serialize_numpy: bool = None,
          serialize_uuid: bool = None, sort_keys: bool = None, strict_integer: bool = None, utc_z: bool = None) -> str:
    """
    Serialize ``obj`` to a JSON formatted ``str``.
    :params ensure_ascii: If ``ensure_ascii`` is false, then the strings written to ``fp`` can
    contain non-ASCII characters if they appear in strings contained in
