...
from ._collections_serialization import _serializer
...
def _inner_dumps(obj, *, default: Optional[Callable[[Any], Any]] = None, newline: bool = None, indent2: bool = None,
    ...
    tmp_obj = _serializer(obj, SerializeConfig.camel)
    return orjson.dumps(tmp_obj, default=default or JsonConfig.default, option=option)
