    ...
    def __init__(self, action: _SubParsersAction):
        self.__parser = action.add_parser("jsonconfig", usage="jsonconfig --[ensure_ascii|indent|...]",
                                          description="simplebox.json module used configuration. this module is the"
                                                      "ujson's wrapper. usage see ujson help information."
                                                      "")

    def parser(self):
        self.__parser.add_argument("--ensure-ascii", action="store_true", default=False,
                                   help="set json serialize ensure_ascii params, default False.")
        self.__parser.add_argument("--escape-forward-slashes", action="store_false", default=True,
                                   help="set json serialize escape_forward_slashes params, default False.")
        self.__parser.add_argument("--encode-html-chars", action="store_true", default=False,
                                   help="set json serialize encode_html_chars params, default True.")
        self.__parser.add_argument("--indent", type=int, default=0,
                                   help="set json serialize indent params, default None.")
        self.__parser.add_argument("--sort-keys", action="store_true", default=False,
                                   help="set json serialize sort_keys params, default False.")
        self.__parser.set_defaults(func=self.__to_config)
