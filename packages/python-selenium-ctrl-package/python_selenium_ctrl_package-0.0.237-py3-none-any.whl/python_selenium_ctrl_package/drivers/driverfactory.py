...
localhost_url = 'http://localhost:%s' % ports_conf.port    # Set the url of localhost, removed /wd/host after Appium2
        ...
        # Get the driver when test is run on local setup
            ...
            try:
                ...
                if device_flag.lower() == 'y':
                    ...
                    mobile_driver = mobile_webdriver.Remote(localhost_url, options=UiAutomator2Options().load_capabilities(desired_capabilities))
                else:
