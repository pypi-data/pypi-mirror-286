...
# %% auto 0
__all__ = ['GET_Dataflow_Error', 'CRUD_Dataflow_Error', 'get_dataflow_by_id', 'get_dataflow_versions',
...
class GET_Dataflow_Error(de.DomoError):
    def __init__(
        self,
...
class CRUD_Dataflow_Error(de.DomoError):
    def __init__(
        self,
        res : rgd.ResponseGetData
