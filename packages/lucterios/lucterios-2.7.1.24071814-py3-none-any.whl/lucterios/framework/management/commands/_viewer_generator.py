...
LIST_AFFECT = {'list': '',
               'search': '',
               'edit': '@ActionsManage.affect_grid(TITLE_MODIFY, "images/edit.png", short_icon="mdi:mdi-pencil-outline", unique=SELECT_SINGLE)',
               'modify': '@ActionsManage.affect_show(TITLE_MODIFY, "images/edit.png", short_icon="mdi:mdi-pencil-outline", close=CLOSE_YES)',
               'add': '@ActionsManage.affect_grid(TITLE_ADD, "images/add.png", short_icon="mdi:mdi-pencil-plus-outline")',
               'show': '@ActionsManage.affect_grid(TITLE_EDIT, "images/show.png", short_icon="mdi:mdi-text-box-outline", unique=SELECT_SINGLE)',
               'delete': '@ActionsManage.affect_grid(TITLE_DELETE, "images/delete.png", short_icon="mdi:mdi-delete-outline", unique=SELECT_MULTI)',
               'print': '@ActionsManage.affect_show(TITLE_PRINT, "images/print.png", short_icon="mdi:mdi-printer-outline")',
               'label': '@ActionsManage.affect_list(TITLE_LABEL, "images/print.png", short_icon="mdi:mdi-printer-pos-star-outline")',
               'listing': '@ActionsManage.affect_list(TITLE_LISTING, "images/print.png", short_icon="mdi:mdi-printer-pos-edit-outline")',
