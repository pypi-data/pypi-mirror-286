...
class UrlPatterns(list):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.append(re_path(r'^old/$', oldview))
        self.append(re_path(r'^old/STUB/(.*)$', defaultblank))
        self.append(re_path(r'^old/(?P<path>.*)$', serve, {'document_root': old_path}))
