...
class XferCompImage(XferComponent):
    ...
    def set_short_icon(self, short_icon):
    ...
    def get_json(self):
        ...
        compjson['short_icon'] = self.short_icon
        return compjson
...
class XferCompSelect(XferCompButton):
    ...
    def _check_case(self):
        ...
        value_is_int = len(list_of_select) > 0
        try:
            for item_id, _item_val in list_of_select:
                if (item_id is not None) and not isinstance(item_id, int):
                    value_is_int = False
                    break
        except ValueError:
            value_is_int = False
        if value_is_int and self.value is not None:
            try:
...
DEFAULT_ACTION_LIST = [('show', _("Edit"), "images/show.png", SELECT_SINGLE),
                       ('edit', _("Modify"), "images/edit.png", SELECT_SINGLE),
                       ('delete', _("Delete"), "images/delete.png", SELECT_MULTI),
                       ('add', _("Add"), "images/add.png", SELECT_NONE)]
...
class XferCompGrid(XferComponent):
    ...
    def set_model(self, query_set, fieldnames, xfer_custom=None):
        ...
        self.nb_lines = query_set.count() if hasattr(query_set, 'count') else len(query_set)
