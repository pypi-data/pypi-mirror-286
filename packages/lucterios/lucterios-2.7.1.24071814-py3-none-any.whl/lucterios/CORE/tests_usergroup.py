...
class UserTest(LucteriosTest):
    ...
    def test_userlist(self):
        ...
        self.assert_action_equal('POST', self.json_actions[0], ('doublon', 'images/clone.png', 'CORE', 'usersFindDouble', 1, 1, 1))
        self.assert_action_equal('GET', self.json_actions[1], ('Rechercher', 'images/user.png', 'CORE', 'usersSearch', 0, 0, 1))
