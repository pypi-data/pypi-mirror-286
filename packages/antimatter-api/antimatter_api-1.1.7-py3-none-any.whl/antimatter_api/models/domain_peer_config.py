...
class DomainPeerConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["exportIdentityProviders", "exportAllIdentityProviders", "exportFacts", "exportAllFacts", "exportReadContexts", "exportAllReadContexts", "exportAllDataPolicies", "exportWriteContexts", "exportAllWriteContexts", "exportCapabilities", "exportAllCapabilities", "exportDomainPolicy", "exportRootEncryptionKeys", "exportCapsuleAccessLog", "exportControlLog", "exportCapsuleManifest", "exportBilling", "exportAdminContact", "nicknames", "importAlias", "forwardBilling", "forwardAdminCommunications", "importIdentityProviders", "importAllIdentityProviders", "importFacts", "importAllFacts", "importReadContexts", "importAllReadContexts", "importAllDataPolicies", "importWriteContexts", "importAllWriteContexts", "importCapabilities", "importAllCapabilities", "importDomainPolicy", "importRootEncryptionKeys", "importPrecedence", "importCapsuleAccessLog", "importControlLog", "importCapsuleManifest", "displayName"]
