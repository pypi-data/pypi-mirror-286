...
async def upsert_domoaccount(
    ...
    **kwargs,
    ...
    if modify_config_fn:
        ...
        domo_account = config.domo_account or domo_account
        account_name = config.account_name or account_name
        domo_account_config = config.domo_account_config or domo_account_config
        auth = config.auth or auth
