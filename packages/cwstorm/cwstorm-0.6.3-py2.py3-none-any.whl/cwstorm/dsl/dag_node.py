...
See the [README](https://github.com/ConductorTechnologies/cwstorm/blob/master/README.md) for more information.
    ...
    BASE_ATTRS = {
        ...
        "step": {
            "type": "int",
            "description": "A hint for the graph layout algorithm to place the node in a specific column.",
        },
        "order": {
            "type": "int",
            "description": "A hint for the graph layout algorithm to place the node in a specific row.",
        },
    }
    ATTRS = {}
    ORDER = 10
