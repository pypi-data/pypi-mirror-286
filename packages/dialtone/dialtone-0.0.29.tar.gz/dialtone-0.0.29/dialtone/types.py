...
Llama3_70B_ToolsProviders = [Provider.Groq, Provider.DeepInfra]

Llama3_1_8B_ToolsProviders = [Provider.Groq]

Llama3_1_70B_ToolsProviders = [Provider.Groq]

Llama3_1_405B_ToolsProviders = [Provider.Groq]
...
class LlamaModelConfig(BaseModel):
    tools_providers: list[Provider] = [Provider.Groq]
    no_tools_providers: list[Provider] = LlamaNoToolsProviders
...
class RouterModelConfig(BaseModel):
    ...
    llama_3_70b: LlamaModelConfig = LlamaModelConfig(
        tools_providers=Llama3_70B_ToolsProviders,
        no_tools_providers=LlamaNoToolsProviders,
    )
    llama_3_1_8b: LlamaModelConfig = LlamaModelConfig(
        tools_providers=Llama3_1_8B_ToolsProviders,
        no_tools_providers=LlamaNoToolsProviders,
    )
    llama_3_1_70b: LlamaModelConfig = LlamaModelConfig(
        tools_providers=Llama3_1_70B_ToolsProviders,
        no_tools_providers=LlamaNoToolsProviders,
    )
    llama_3_1_405b: LlamaModelConfig = LlamaModelConfig(
        tools_providers=Llama3_1_405B_ToolsProviders,
        no_tools_providers=LlamaNoToolsProviders,
    )
    ...
    def Llama3_70B(
        cls,
        tools_providers: list[Provider] = Llama3_70B_ToolsProviders,
        no_tools_providers: list[Provider] = LlamaNoToolsProviders,
    ) -> LlamaModelConfig:
    ...
    def Llama3_1_8B(
        cls,
        tools_providers: list[Provider] = Llama3_1_8B_ToolsProviders,
        no_tools_providers: list[Provider] = LlamaNoToolsProviders,
    ) -> LlamaModelConfig:
        return LlamaModelConfig(
            tools_providers=tools_providers, no_tools_providers=no_tools_providers
    ...
    def Llama3_1_70B(
        cls,
        tools_providers: list[Provider] = Llama3_1_70B_ToolsProviders,
        no_tools_providers: list[Provider] = LlamaNoToolsProviders,
    ) -> LlamaModelConfig:
        return LlamaModelConfig(
            tools_providers=tools_providers, no_tools_providers=no_tools_providers
    ...
    def Llama3_1_405B(
        cls,
        tools_providers: list[Provider] = Llama3_1_405B_ToolsProviders,
        no_tools_providers: list[Provider] = LlamaNoToolsProviders,
    ) -> LlamaModelConfig:
        return LlamaModelConfig(
            tools_providers=tools_providers, no_tools_providers=no_tools_providers
