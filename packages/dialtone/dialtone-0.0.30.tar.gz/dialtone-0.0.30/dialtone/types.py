...
Llama3_ToolsProviders = [Provider.Groq, Provider.DeepInfra]

Llama3_1_NoToolsProviders = [
    Provider.Groq,
    Provider.DeepInfra,
    Provider.Fireworks,
    Provider.Together,
...
Llama3_1_ToolsProviders = [Provider.Groq]
...
class Llama_3_70B_ModelConfig(BaseModel):
    tools_providers: list[Provider] = Llama3_ToolsProviders
    no_tools_providers: list[Provider] = Llama3_NoToolsProviders


class Llama_3_1_8B_ModelConfig(BaseModel):
    tools_providers: list[Provider] = Llama3_1_ToolsProviders
    no_tools_providers: list[Provider] = Llama3_1_NoToolsProviders
...
class RouterModelConfig(BaseModel):
    ...
    llama_3_70b: Llama_3_70B_ModelConfig = Llama_3_70B_ModelConfig(
        tools_providers=Llama3_ToolsProviders,
        no_tools_providers=Llama3_NoToolsProviders,
    )
    llama_3_1_8b: Llama_3_1_8B_ModelConfig = Llama_3_1_8B_ModelConfig(
        tools_providers=Llama3_1_ToolsProviders,
        no_tools_providers=Llama3_1_NoToolsProviders,
    )
