...
Llama370bToolsProviders = [Provider.Groq, Provider.DeepInfra]
...
class LlamaModelConfig(BaseModel):
    tools_providers: list[Provider] = Llama370bToolsProviders
...
class RouterModelConfig(BaseModel):
    ...
    llama_3_70b: LlamaModelConfig = LlamaModelConfig(
        tools_providers=Llama370bToolsProviders,
    ...
    def Llama3_1_8B(
        ...
        return LlamaModelConfig(
            tools_providers=[], no_tools_providers=no_tools_providers
        )
