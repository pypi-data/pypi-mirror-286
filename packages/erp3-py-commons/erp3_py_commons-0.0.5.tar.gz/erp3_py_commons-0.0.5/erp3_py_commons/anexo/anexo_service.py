...
class AnexoService(ServiceBase):
    ...
    def get(
        ...
        return AnexoDTO(**model, conteudo=conteudo, kwargs_as_entity=True, url=url)

    def _get_url_download_anexo(self, id: uuid.UUID):
        ...
        # Making final URL
        return f"{base_url}{download_attach}/{id}"
