...
class AnexoDTO(DTOBase):
    id: uuid.UUID = DTOField(
        pk=True, default_value=uuid.uuid4, entity_field="documentoged"
    )  # description="Conteúdo do anexo em base64"
    conteudo: str = DTOField(not_null=True)  # description="Conteúdo do anexo em base64"
    nome: str = DTOField(
    ...
    tipo: TipoAnexo = DTOField(
        not_null=True, resume=True, default_value=TipoAnexo.GENERICO
