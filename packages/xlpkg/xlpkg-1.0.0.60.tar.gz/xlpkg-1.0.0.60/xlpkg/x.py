...
import subprocess,importlib,pandas as pd
...
def f_subprocessrun(cmd,arg):
    cmd1=f'cmd {arg}'.split(' ')
    return(subprocess.run(cmd1,shell=True,text=True,stdout=subprocess.PIPE,stderr=subprocess.PIPE))
    pass
