...
class CTR(Histogram):
    ...
    def fit_plot(self):
        ...
        fit_info = [
            ...
            f'$\Delta t$ \t\t${self.dt:.2E} \pm {self.dt_error:.1E}$',
            f'Rise Time \t${self.risetime:.2E} \pm {self.risetime_error:.1E}$',
            f'Decay Time \t${self.decaytime:.2E} \pm {self.decaytime_error:.1E}$',
            f'Light Yield \t${self.lightyield:.2E} \pm {self.lightyield_error:.1E}$\n',
            f'FWHM \t\t${self.FWHM(10E-12):.2E}$',
