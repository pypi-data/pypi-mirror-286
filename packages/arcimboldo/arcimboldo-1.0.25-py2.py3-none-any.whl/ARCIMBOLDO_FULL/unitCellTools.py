...
def check_failed_space_group(short_string):
    space_group_compatibility_lists = [
        ['P 1 2 1', 'P 1 21 1'],
        ['P 2 2 2', 'P 21 2 2', 'P 2 21 2', 'P 2 2 21', 'P 21 21 2', 'P 21 2 21', 'P 2 21 21', 'P 21 21 21'],
        ['C 2 2 21', 'C 2 2 2'],
        ['I 2 2 2', 'I 21 21 21'],
        ['P 4', 'P 41', 'P 42', 'P 43'],
        ['I 4', 'I 41'],
        ['P 4 2 2', 'P 4 21 2', 'P 41 2 2', 'P 41 21 2', 'P 42 2 2', 'P 42 21 2', 'P 43 21 2'],
        ['I 4 2 2', 'I 41 2 2'],
        ['P 3', 'P 31', 'P 32'],
        ['P 31 2', 'P 32 1', 'P 31 1 2', 'P 31 2 1', 'P 32 1 2', 'P 32 2 1'],
    ...
    for group_list in space_group_compatibility_lists:
        if short_string in group_list:
            return [sg for sg in group_list if sg != short_string]
    return None
