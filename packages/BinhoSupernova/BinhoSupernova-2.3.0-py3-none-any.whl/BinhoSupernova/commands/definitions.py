...
class I3cInitBusError(Enum):
    I3C_INIT_BUS_SUCCESS                          = 0    
    INVALID_ADDR                                  = 1
    NOT_ENOUGH_SPACE_IN_TABLE                     = 2
    DAA_FAILED_TABLE_OVERFLOW                     = 3
    RSTDAA_FAILED                                 = 4
    SETDASA_FAILED                                = 5
    SETAASA_FAILED                                = 6
    ENTDAA_FAILED                                 = 7
    I3C_BUS_INIT_DRIVER_TIMEOUT                   = 8
    I3C_BUS_INIT_SOFTWARE_TIMEOUT                 = 9
...
class I3cTransferResult(Enum):
    ...
    INVALID_ADDRESS                 = 4
    NOT_ENOUGH_SPACE_IN_TABLE       = 5
    DAA_FAILED_TABLE_OVERFLOW       = 6
...
class I3cInitBusHighLevelResponse_t:
    ...
    def toDictionary(self) -> dict:
        ...
        return {
            ...
            'result' : I3cInitBusError(self.result).name,
            'errorStatus' : errors,
            'invalid_targets_info' : self.addressToDictionary(self.invalidTargetsCounter * 2, self.invalidAddressesInfo)
        }
...
class I3cDaaHighLevelResponse_t:
    ...
    def toDictionary(self) -> dict:
        return {
            ...
            'invalid_addresses' : self.addressToDictionary(self.descriptor.dataLength, self.invalidAddresses)
        }
