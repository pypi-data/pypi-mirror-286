...
def main():
    ...
    # Call the model
    if args.macos:
        r = multi_llm.run_macos(p, action_chain, rank, args.taskid, convid, detail=args.detail)
    else:
        r = multi_llm.run(p, action_chain, rank, args.taskid, convid, detail=args.detail)
