...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_200 = (200, _('Request successful'))
    HTTP_201 = (201, _('New request successful'))
    HTTP_202 = (202, _('The request was accepted, but processing has not yet completed'))
    HTTP_204 = (204, _('The request was successful but no content was returned'))
    HTTP_400 = (400, _('Request error'))
    HTTP_401 = (401, _('Unauthorized'))
    HTTP_403 = (403, _('No Access'))
    HTTP_404 = (404, _('The requested resource does not exist'))
    HTTP_410 = (410, _('The requested resource has been permanently deleted'))
    HTTP_422 = (422, _('The request parameter is illegal'))
    HTTP_425 = (425, _('The request cannot be performed because the server cannot satisfy the request'))
    HTTP_429 = (429, _('Too many requests, server limit'))
    HTTP_500 = (500, _('Server internal error'))
    HTTP_502 = (502, _('Gateway error'))
    HTTP_503 = (503, _('The server is temporarily unable to process the request'))
    HTTP_504 = (504, _('Gateway timeout'))


class CustomErrorCode(CustomCodeBase):
    """Custom error status code"""

    CAPTCHA_ERROR = (40001, _('Verification code error'))

    VERIFY_OTP_ERROR = (50001, _('Verify otp error'))
    GENERATION_VERIFICATION_OTP_ERROR = (50002, _('Generation verification otp error'))


@dataclasses.dataclass
class CustomResponse:
    """
    Provide open response status codes instead of enumerations, which may be useful
    if you want to customize the response information
    """
