...
from ..sso.errors import SSOExceptionError
from ...oauth.web_application import WebApplicationClient
from ..sso.pkce import get_pkce_challenge_pair
from ..sso.state import generate_random_state
...
class SSOBase:
    ...
    async def get_login_redirect(
        ...
        *,
        ...
        Returns:
            RedirectResponse: A URL response directing to the login page of the OAuth SSO provider.
        """
        if self.requires_state and not state:
            state = self._generated_state
    ...
    async def verify_and_process(
        ...
        *,
        ...
        try:
            ...
            raise SSOExceptionError(msg=str(e))
