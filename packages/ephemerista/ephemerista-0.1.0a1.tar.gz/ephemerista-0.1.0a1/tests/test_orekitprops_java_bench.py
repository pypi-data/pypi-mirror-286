...
from ephemerista.bodies import Satellite, Sun
...
@pytest.mark.parametrize("third_bodies", [[Sun(), Satellite(name="luna")]])
def test_orekitprop_bench(py_prop_class, enable_srp, enable_drag, grav_degree_order, third_bodies):
    ...
    _traj_python = py_prop.propagate(state_init=state_init, time=time_list)
