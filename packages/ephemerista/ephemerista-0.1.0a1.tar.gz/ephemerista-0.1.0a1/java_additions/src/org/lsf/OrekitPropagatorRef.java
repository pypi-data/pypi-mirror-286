...
public abstract class OrekitPropagatorRef {
    ...
    public OrekitPropagatorRef(double prop_min_step, double prop_max_step, double prop_init_step,
    ...
    public void setup_orekit_objs() {
        ...
        KeplerianOrbit orbit_sample_kepl = new KeplerianOrbit(
                7e6,
                1e-4,
                0.5,
                0.0,
        ...
        EquinoctialOrbit orbit_sample = new EquinoctialOrbit(orbit_sample_kepl);
        this.setup_propagator(orbit_sample);
    }
    ...
    public TimeStampedPVCoordinates propagate(
            TimeStampedPVCoordinates tpv_icrf_init,
            AbsoluteDate time,
            Event[] stop_conds) {
        this.set_initial_state(tpv_icrf_init);
