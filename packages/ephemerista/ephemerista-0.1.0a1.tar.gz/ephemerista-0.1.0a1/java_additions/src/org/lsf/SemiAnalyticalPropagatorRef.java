...
public class SemiAnalyticalPropagatorRef extends OrekitPropagatorRef {
    ...
    public SemiAnalyticalPropagatorRef(double prop_min_step, double prop_max_step, double prop_init_step,
        ...
        super(prop_min_step, prop_max_step, prop_init_step, prop_position_error, mass, cross_section, grav_degree_order,
