...
from knext.command.sub_command.akg import akg_index
from knext.command.sub_command.akg import akg_query
...
kag.command("index")(akg_index)
kag.command("query")(akg_query)
