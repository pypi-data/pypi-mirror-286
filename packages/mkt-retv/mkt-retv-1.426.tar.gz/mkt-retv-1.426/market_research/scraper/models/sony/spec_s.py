...
class ModelScraper_s(Scraper):
    ...
    def get_models_info(self, format_df:bool=True, fastmode:bool=False, temporary_year_marking=False, show_visit:bool=False):
        ...
        url_series_dict = {"x95k":'https://electronics.sony.com/tv-video/televisions/all-tvs/p/xr65x95k',
                           "xr70":"https://electronics.sony.com/tv-video/televisions/all-tvs/p/k85xr70"}
    ...
    def _get_models(self, url: str, prefix="https://electronics.sony.com/", static_mode=False) -> dict:
        """
                ...
                for _ in range(3):
                    if static_mode:
                        ...
                        try:
                            ...
                            elements = items.find_elements(By.TAG_NAME, 'a')
