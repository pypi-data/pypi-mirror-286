...
// RESGEN_4066_1 Sequential residual generator for model 'VEP4'
// Causality: int
//
// Structurally sensitive to faults: fp_af, fw_af, fw_c, fc_vol, fw_t, fx_th, fyw_af, fyp_im
//
...
// r = ResGen_4066_1( z, state, params, Ts )
//
...
void ResGen_4066_1_core( double* r, PyArrayObject *pyZ, npy_intp k, ResState *state, const Parameters *params, double Ts );

static PyObject*
ResGen_4066_1(PyObject *self, PyObject * args)
{
  PyArrayObject *pyZ;
  PyObject *pyState;
  PyObject *pyParams;
  ...
  for( npy_intp k=0; k < N; k++ ) {
    ResGen_4066_1_core( &(r[k]), pyZ, k, &state, &params, Ts );
}
...
void
ResGen_4066_1_core(double* r, PyArrayObject *pyZ, npy_intp k, ResState* state, const Parameters *params, double Ts)
{
  // Parameters
...
static PyMethodDef ResGen_4066_1_methods[] = {
    {"ResGen_4066_1",  ResGen_4066_1, METH_VARARGS, "Residual generator ResGen_4066_1"},
    {NULL, NULL}
};

#if PY_MAJOR_VERSION >= 3

static int ResGen_4066_1_traverse(PyObject *m, visitproc visit, void *arg) {
    Py_VISIT(GETSTATE(m)->error);
    return 0;
}

static int ResGen_4066_1_clear(PyObject *m) {
...
static struct PyModuleDef moduledef = {
        ...
        ResGen_4066_1_methods,
        NULL,
        ResGen_4066_1_traverse,
        ResGen_4066_1_clear,
        NULL
};
...
PyMODINIT_FUNC
PyInit_ResGen_4066_1(void)

#else
#define INITERROR return

PyMODINIT_FUNC
initResGen_4066_1(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
    PyObject *module = PyModule_Create(&moduledef);
#else
    PyObject *module = Py_InitModule("ResGen_4066_1", ResGen_4066_1_methods);
#endif
    ...
    char errName[] = "ResGen_4066_1.Error";
