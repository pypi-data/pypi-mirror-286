...
// RESGEN_4074_84 Sequential residual generator for model 'VEP4'
// Causality: int
//
...
// r = ResGen_4074_84( z, state, params, Ts )
//
...
void ResGen_4074_84_core( double* r, PyArrayObject *pyZ, npy_intp k, ResState *state, const Parameters *params, double Ts );

static PyObject*
ResGen_4074_84(PyObject *self, PyObject * args)
{
  PyArrayObject *pyZ;
  PyObject *pyState;
  PyObject *pyParams;
  ...
  for( npy_intp k=0; k < N; k++ ) {
    ResGen_4074_84_core( &(r[k]), pyZ, k, &state, &params, Ts );
}
...
void
ResGen_4074_84_core(double* r, PyArrayObject *pyZ, npy_intp k, ResState* state, const Parameters *params, double Ts)
{
  // Parameters
...
static PyMethodDef ResGen_4074_84_methods[] = {
    {"ResGen_4074_84",  ResGen_4074_84, METH_VARARGS, "Residual generator ResGen_4074_84"},
    {NULL, NULL}
};

#if PY_MAJOR_VERSION >= 3

static int ResGen_4074_84_traverse(PyObject *m, visitproc visit, void *arg) {
    Py_VISIT(GETSTATE(m)->error);
    return 0;
}

static int ResGen_4074_84_clear(PyObject *m) {
...
static struct PyModuleDef moduledef = {
        ...
        ResGen_4074_84_methods,
        NULL,
        ResGen_4074_84_traverse,
        ResGen_4074_84_clear,
        NULL
};
...
PyMODINIT_FUNC
PyInit_ResGen_4074_84(void)

#else
#define INITERROR return

PyMODINIT_FUNC
initResGen_4074_84(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
    PyObject *module = PyModule_Create(&moduledef);
#else
    PyObject *module = Py_InitModule("ResGen_4074_84", ResGen_4074_84_methods);
#endif
    ...
    char errName[] = "ResGen_4074_84.Error";
