...
class SqlTextArea(TextArea):
    ...
    BINDINGS = [
        ...
        Binding("ctrl+full_stop", "execute", "Execute"),
        Binding("ctrl+space", "autocomplete", "Autocomplete"),
        Binding("alt+f", "format", "Format"),
        Binding("alt+shift+f", "format_all", "Format all"),
        Binding("alt+e", "select", "Select query"),
        Binding("alt+c", "copy", "Copy selection"),
        Binding("escape", "close", "Close Autocomplete", show=False),
    ]
