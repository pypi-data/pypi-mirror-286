...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_iroh_ffi_checksum_method_blobs_read_to_bytes() != 13624:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_blobs_share() != 55307:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_docs_drop_doc() != 5864:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_docs_join() != 29064:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_docs_join_and_subscribe() != 30619:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_message_type() != 75:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_add_node_addr() != 48772:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_connection_info() != 19420:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_connections() != 60971:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_home_relay() != 39435:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_my_rpc_addr() != 34751:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_node_addr() != 55077:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_node_id() != 50937:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_iroh_ffi_fn_method_node_add_node_addr.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_add_node_addr.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_node_connection_info.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_connection_info.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_node_connections.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_connections.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_node_home_relay.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_home_relay.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_method_node_node_addr.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_node_addr.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_node_node_id.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_node_id.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_add_node_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_add_node_addr.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_connection_info.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_connection_info.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_connections.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_connections.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_home_relay.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_home_relay.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_node_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_node_addr.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_node_id.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_node_id.restype = ctypes.c_uint16
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def share(self, hash: "Hash",blob_format: "BlobFormat",ticket_options: "AddrInfoOptions") -> "str":
        """
        Create a ticket for sharing a blob from this node.
        """
...
class DocsProtocol(typing.Protocol):
    ...
    def drop_doc(self, doc_id: "str"):
        ...
        raise NotImplementedError
    def join(self, ticket: "str"):
        """
        Join and sync with an already existing document.
        """

        raise NotImplementedError
    def join_and_subscribe(self, ticket: "str",cb: "SubscribeCallback"):
        """
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def join(self, ticket: "str") -> "Doc":
        """
        Join and sync with an already existing document.
        """
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def join_and_subscribe(self, ticket: "str",cb: "SubscribeCallback") -> "Doc":
        """
        Join and sync with an already existing document and subscribe to events on that document.
        """
...
class Node:
    ...
    async def add_node_addr(self, addr: "NodeAddr") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_add_node_addr(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def connection_info(self, node_id: "PublicKey") -> "typing.Optional[ConnectionInfo]":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_connection_info(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def connections(self, ) -> "typing.List[ConnectionInfo]":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_connections(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def home_relay(self, ) -> "typing.Optional[str]":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_home_relay(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def node_addr(self, ) -> "NodeAddr":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_node_addr(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_pointer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def node_id(self, ) -> "str":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_node_id(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
