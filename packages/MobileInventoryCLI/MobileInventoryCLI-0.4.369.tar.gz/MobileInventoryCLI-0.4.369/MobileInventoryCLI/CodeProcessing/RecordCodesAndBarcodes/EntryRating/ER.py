...
#assign  
'''
1 - assign number to a person from 0-max individuals sequentially
2 - assign a number to reward
##possibly use user ratings as a way to tailor the reward to/from the general consensus
3 - generate a random int for the person
4 - generate a random int for the assigned reward
5 - spit out the id pair as (PersonId,RewardId)
'''