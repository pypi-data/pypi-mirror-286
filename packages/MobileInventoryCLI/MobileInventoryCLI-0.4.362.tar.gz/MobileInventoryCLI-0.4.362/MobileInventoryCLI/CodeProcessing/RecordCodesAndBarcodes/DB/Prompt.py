...
Note: optional [{Fore.light_red}e{Fore.light_green}] executes after copy{Style.reset} | {Fore.light_magenta}#RPLC#={Fore.tan}Cp from CB dflt and replace #RPLC# from CB{Style.reset}
...
in {Fore.light_yellow}'{cmd.replace('#RPLC#',dflt.cbValue)}'{Style.reset}""")
                        return func(cmd.replace('#RPLC#',dflt.cbValue),data)
                    else:
