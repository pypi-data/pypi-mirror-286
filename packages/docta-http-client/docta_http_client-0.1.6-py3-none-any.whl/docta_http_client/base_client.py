...
class APIClient:
    ...
    def preference_data_cleaning(self, file_type:str, instruction_keys:str|list, response_a:str|list, response_b:str|list, user_email:str, file_path:str, return_score:bool, return_category:bool):
        '''
