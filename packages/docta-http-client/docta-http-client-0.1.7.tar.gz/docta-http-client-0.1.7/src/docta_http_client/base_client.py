...
class APIClient:
    ...
    def preference_data_cleaning(self, file_type: str, instruction_keys: Union[str, List[str]], 
                             response_a: Union[str, List[str]], response_b: Union[str, List[str]], 
                             user_email: str, file_path: str, return_score: bool, return_category: bool) -> None:
        '''
