...
class Base(Object):
    """An automation object with MQTT networking, time series database and
    logging features.

    This class is typically not instantiated directly, but used as a base class for
    automation object implementations. The object includes MQTT networking, logging, time series database recording,
    and event processing capabilities. It can be instantiated and run either via cron,
    a thread, or by any other means.
    ...
    To allow any MQTT or time series implementation to be used all objects of this
    kind support factory method pattern. All classes has unique class identifier class attribute
    through which they can be instantiated.
    ...
    database_class_id: str | None = None
    ...
    def __init__(self, name: str = "") -> None:
        ...
        """
        super().__init__(name)
        self.database_client: object | None = None
    ...
    def subscribe(self, topic: str) -> None:
        ...
        self.debug(self.name + " subscribed to " + topic)
    ...
    def on_message(self, client: object, userdata: Any, msg: object) -> None:
        ...
        if msg.topic == "f{self.mqtt_root_topic}/control":
    ...
    def on_connect(self, client: object, userdata: Any, flags: int, rc: int) -> None:
        ...
        """
        self.mqtt_client.subscribe("f{self.mqtt_root_topic}/control")
    ...
    def log_message(self, type, msg, details=""):
        ...
        try:
            ...
            self.mqtt_client.publish(f"{Base.mqtt_root_topic}/log", json.dumps(msg), 1)
        except Exception as e:
