...
class SpotHintaFiThread(RCloudThread):
    ...
    _class_id: str = "SpotHintaFiThread"
    _spot_topic: str = ""
    _url: str = ""
    ...
    def process_data(self, data):
        ...
        for e in data:
            ...
            spot.append(h)
        self.mqtt_client.publish(self._spot_topic, json.dumps(spot), 1, True)
...
class RSpotHintaFi(RCloud):
    ...
    _class_id = ""
    worker_thread_id = SpotHintaFiThread._class_id
    ...
    def on_spot(self, m):
        ...
        for h in m:
            point = (
                ...
                .time(self.epoc2utc(h["Timestamp"]))
            )
            self.write(point)
