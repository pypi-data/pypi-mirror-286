...
"""
The below code is copied from https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/utils/hub.py
Please note that `cached_path` is removed in latest version so we keep a copy here.
"""

# Default cache
DEFAULT_CACHE_PATH = os.path.expanduser(os.path.join("~/.cache", "db_copilot"))
