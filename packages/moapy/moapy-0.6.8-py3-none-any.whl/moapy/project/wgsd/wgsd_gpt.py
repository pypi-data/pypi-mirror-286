...
def generate_python_function(inp: PythonFuncInput) -> str:
    openai.api_key = midas_util.get_MAPI_Key()
    refData = inp.refData
    do_what = inp.do_what
    try:
    # Define the prompt
...
# Example usage
# refData = {"moapy.project.wgsd.wgsd_flow.MaterialConcrete":{"grade":{"design_code":"ACI318M-19","grade":"C12"},"curve_uls":[{"stress":0,"strain":0},{"stress":0,"strain":0.0004500000000000001},{"stress":10.2,"strain":0.0004500000000000001},{"stress":10.2,"strain":0.003}],"curve_sls":[{"stress":0,"strain":0},{"stress":12,"strain":0.003}]}}
# doWhat = "2D 그래프로 그려줘"
# response = generate_python_function(refData, doWhat)
# print(response)