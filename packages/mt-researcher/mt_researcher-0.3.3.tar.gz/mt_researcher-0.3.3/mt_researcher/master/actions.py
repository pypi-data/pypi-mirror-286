...
from mt_researcher.master.prompts import *
from mt_researcher.scraper.scraper import Scraper
from mt_researcher.utils.enum import Tone
from mt_researcher.utils.llm import *
...
def get_retriever(retriever):
    ...
    match retriever:
        case "google":
            from mt_researcher.retrievers import GoogleSearch

            retriever = GoogleSearch
        case "searx":
            from mt_researcher.retrievers import SearxSearch

            retriever = SearxSearch
        case "serpapi":
            from mt_researcher.retrievers import SerpApiSearch

            retriever = SerpApiSearch
        case "googleSerp":
            from mt_researcher.retrievers import SerperSearch

            retriever = SerperSearch
        case "duckduckgo":
            from mt_researcher.retrievers import Duckduckgo

            retriever = Duckduckgo
        case "bing":
            from mt_researcher.retrievers import BingSearch

            retriever = BingSearch
        case "arxiv":
            from mt_researcher.retrievers import ArxivSearch

            retriever = ArxivSearch
        case "tavily":
            from mt_researcher.retrievers import TavilySearch

            retriever = TavilySearch
        case "exa":
            from mt_researcher.retrievers import ExaSearch

            retriever = ExaSearch
        case "custom":
            from mt_researcher.retrievers import CustomRetriever
