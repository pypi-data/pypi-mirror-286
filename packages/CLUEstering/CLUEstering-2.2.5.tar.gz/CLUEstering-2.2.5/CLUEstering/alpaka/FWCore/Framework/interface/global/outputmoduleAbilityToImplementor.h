...
namespace edm {
  ...
  namespace global {
    namespace outputmodule {
      ...
      public:
        explicit StreamCacheHolder(edm::ParameterSet const& iPSet)
      ...
      private:
        ...
        virtual std::shared_ptr<C> globalBeginLuminosityBlock(
            LuminosityBlockForOutput const&) const = 0;
      ...
      struct AbilityToImplementor<edm::RunCache<C>> {
        typedef edm::global::outputmodule::RunCacheHolder<edm::global::OutputModuleBase, C>
            Type;
      };

      template <typename C>
      struct AbilityToImplementor<edm::LuminosityBlockCache<C>> {
        typedef edm::global::outputmodule::
            LuminosityBlockCacheHolder<edm::global::OutputModuleBase, C>
                Type;
      };

      template <typename C>
      struct AbilityToImplementor<edm::StreamCache<C>> {
        typedef edm::global::outputmodule::StreamCacheHolder<edm::global::OutputModuleBase,
                                                             C>
            Type;
      };
      ...
      struct AbilityToImplementor<edm::ExternalWork> {
        typedef edm::global::outputmodule::ExternalWork<edm::global::OutputModuleBase>
            Type;
      };
