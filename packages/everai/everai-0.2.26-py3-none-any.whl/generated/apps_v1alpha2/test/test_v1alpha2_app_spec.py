...
class TestV1alpha2AppSpec(unittest.TestCase):
    """V1alpha2AppSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alpha2AppSpec:
        """Test V1alpha2AppSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alpha2AppSpec`
        """
        model = V1alpha2AppSpec()
        if include_optional:
            return V1alpha2AppSpec(
