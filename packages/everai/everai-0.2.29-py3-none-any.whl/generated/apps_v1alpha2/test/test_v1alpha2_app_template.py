...
class TestV1alpha2AppTemplate(unittest.TestCase):
    """V1alpha2AppTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1alpha2AppTemplate:
        """Test V1alpha2AppTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1alpha2AppTemplate`
        """
        model = V1alpha2AppTemplate()
        if include_optional:
            return V1alpha2AppTemplate(
    ...
    def testV1alpha2AppTemplate(self):
        """Test V1alpha2AppTemplate"""
