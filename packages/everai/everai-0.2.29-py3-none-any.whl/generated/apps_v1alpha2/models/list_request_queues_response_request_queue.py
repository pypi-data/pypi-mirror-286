...
class ListRequestQueuesResponseRequestQueue(BaseModel):
    ...
    reason: Optional[ListRequestQueuesResponseQueueReason] = ListRequestQueuesResponseQueueReason.QUEUEREASONUNSPECIFIED
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "reason": obj.get("reason") if obj.get("reason") is not None else ListRequestQueuesResponseQueueReason.QUEUEREASONUNSPECIFIED,
