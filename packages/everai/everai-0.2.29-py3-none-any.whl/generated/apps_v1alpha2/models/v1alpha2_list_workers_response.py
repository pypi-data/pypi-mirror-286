...
class V1alpha2ListWorkersResponse(BaseModel):
    """
    V1alpha2ListWorkersResponse
    """ # noqa: E501
    workers: Optional[List[V1alpha2Worker]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1alpha2ListWorkersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1alpha2ListWorkersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "workers": [V1alpha2Worker.from_dict(_item) for _item in obj["workers"]] if obj.get("workers") is not None else None,
