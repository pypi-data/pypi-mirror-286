...
class IndexingTable(Table):
    ...
    running: bool
    def __init__(self, url: Url | None = None, created: str | None = None, row_cache_url: Url | None = None, row_cache_populated: bool | None = None, project_scan_urls: list[Url] | None = None, extra_scan_urls: list[Url] | None = None, scan_urls: list[_ScanUrl] | None = None, constrain_to_type: str | None = None, scan_wait: float | None = None, file_extensions: list[str] | None = None, create_default_dirs: bool | None = None, init_parameters: Any = None) -> None: ...
    ...
    def wait_for_complete_index(self, timeout: float | None = None) -> bool:
        ...
        If timeout is None or 0.0 waits forever
