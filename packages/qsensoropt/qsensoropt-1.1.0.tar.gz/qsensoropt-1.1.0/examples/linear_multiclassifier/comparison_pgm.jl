...
function roots_of_unity(n::Int)
    roots = [exp(2im * k * π / n) for k in 0:n-1]
    return roots
end
...
function main(args)
    ...
    for i in 1:12
        println(1.0-PGM_performance(sqrt(i)*roots_of_unity(3)))
    end
    
    for i in 1:12
        println(1.0-PGM_performance(sqrt(i)*roots_of_unity(5)))
    end
    
    for i in 1:12
        println(1.0-PGM_performance(sqrt(i)*roots_of_unity(7)))
    end
    
    for i in 1:12
        println(1.0-PGM_performance(sqrt(i)*roots_of_unity(9)))
    end
