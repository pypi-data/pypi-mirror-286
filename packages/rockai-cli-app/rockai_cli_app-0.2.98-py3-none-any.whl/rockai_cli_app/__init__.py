...
class Client:
    ...
    def create(self,version: str, input: Optional[Dict[str, Any]] = None,webhook: Optional[str] = None,
    ...
    async def create_async(self,version: str, input: Optional[Dict[str, Any]] = None,webhook: Optional[str] = None,
        webhook_events_filter: Optional[List[str]] = None):
        url = self.predict_url
