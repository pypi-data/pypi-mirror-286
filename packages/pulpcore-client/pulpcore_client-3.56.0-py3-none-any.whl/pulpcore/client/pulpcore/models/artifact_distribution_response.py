...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, pulp_href=None, pulp_last_updated=None, content_guard=None, base_url=None, name=None, hidden=False, base_path=None, local_vars_configuration=None):  # noqa: E501
