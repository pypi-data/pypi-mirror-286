...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, pulp_created=None, name=None, pulp_labels=None, content_guard=None, hidden=False, base_url=None, local_vars_configuration=None):  # noqa: E501
