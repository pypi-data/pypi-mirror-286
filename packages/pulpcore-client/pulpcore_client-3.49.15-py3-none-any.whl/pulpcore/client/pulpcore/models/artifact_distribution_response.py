...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, pulp_last_updated=None, pulp_labels=None, base_url=None, hidden=False, pulp_created=None, content_guard=None, base_path=None, local_vars_configuration=None):  # noqa: E501
