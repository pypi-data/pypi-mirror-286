...
def sweep_params(access_token, job_name, application_name,
                 ...
                 input_file_mapping = {}, queue_name = None, node_count = None, cpu_count = None, walltime = None):
...
def get_all_experiments(access_token, job_name, working_dir, config_file_location):
    ...
    for exp_id in exp_ids:
        experiments.append(airavata_operator.get_experiment(access_token, exp_id))
