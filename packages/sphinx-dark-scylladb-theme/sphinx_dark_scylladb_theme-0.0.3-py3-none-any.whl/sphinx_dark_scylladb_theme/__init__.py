...
from sphinx_dark_scylladb_theme._version import version
from sphinx_dark_scylladb_theme.extensions import (
    hero_box,
    labels,
    multiversion,
    navigation,
...
from sphinx_dark_scylladb_theme.lexers import cql, ditaa
