...
class Markdown(_coconut.collections.namedtuple("Markdown", ('code',))):  #50 (line in Coconut source)
...
class SeparatedBy(_coconut.collections.namedtuple("SeparatedBy", ('sep', 'objs'))):  #51 (line in Coconut source)
