...
from .mylogging import logger, get_time, time_log_decorator
    ...
    async def send_file_general(
        ...
        with open(file_path, "rb") as file:
            if not update:
                ...
                logger.error("Error sending file: no valid context to send document.")
                message = None

        return message.id if message else 1
