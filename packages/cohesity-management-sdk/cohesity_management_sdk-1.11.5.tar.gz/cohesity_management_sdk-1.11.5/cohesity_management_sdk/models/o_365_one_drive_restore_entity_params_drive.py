...
class O365OneDriveRestoreEntityParams_Drive(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('restoreItemVec') != None:
            restore_drive_id = list()
            for structure in dictionary.get('restoreItemVec'):
                restore_drive_id.append(cohesity_management_sdk.models.o_365_one_drive_restore_entity_params_drive_item.O365OneDriveRestoreEntityParams_DriveItem.from_dictionary(structure))
