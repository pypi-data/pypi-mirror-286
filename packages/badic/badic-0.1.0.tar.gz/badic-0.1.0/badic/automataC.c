...
*/
	...
	//int b = 
	addH(&l, l.e[0], NULL); //add the initial state to the hash table
	if (verb)
		printListStates(l);
...
//change alphabet of the NAutomaton ON PLACE
void Relabel (NAutomaton a, Dict d)
{
	int i,j;
	for (i=0;i<a.n;i++)
	{
...
int CheckL (Automaton *a, int *l, int n, int verb)
{
	...
	//int nc = 
	StronglyConnectedComponents(a2, cc);
	int i, j, f, c;
	int *indL = (int *)malloc(sizeof(int)*a->na);
